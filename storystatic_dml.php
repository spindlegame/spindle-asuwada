...
function storystatic_delete($selected_id, $AllowDeleteOfParents=false, $skipChecks=false){
	...
	$id = db_fetch_row($res);
	$rires = sql("select count(1) from `chr_dev` where `mcs_problem`='".addslashes($id[0])."'", $eo);
