			...
			<table data-tablename="<?php echo $current_table; ?>" class="table table-striped table-hover table-condensed table-bordered">
				...
				<tbody>
					...
					<tr data-id="<?php echo html_attr($pkValue); ?>">
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][3]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][3]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><a href="<?php echo getUploadDir('') . urlencode($record[3]); ?>" data-lightbox="game_agent-img"><img src="thumbnail.php?i=<?php echo urlencode($record[3]); ?>&t=game_agent&f=img&v=tv" class="img-thumbnail"></a></td>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][17]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][17]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><img src="<?php echo thisOr(get_embed('googlemap', $record[17], '', '', 'thumbnail_url'), 'blank.gif'); ?>" style="max-width: 50px; max-height: 50px; "></td>
						...
						<td class="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][24]}"; ?>" id="<?php echo "{$parameters['ChildTable']}-{$config['display-field-names'][24]}-" . html_attr($record[$config['child-primary-key-index']]); ?>"><?php if($record[24]) { ?><a href="link.php?t=<?php echo $parameters['ChildTable']; ?>&f=img_gallery&i=<?php echo urlencode($record[$config['child-primary-key-index']]); ?>" target="_blank" class="btn btn-default" title="<?php echo html_attr($record[24]); ?>"><i class="glyphicon glyphicon-lg glyphicon-globe text-info"></i></a><?php } ?></td>
