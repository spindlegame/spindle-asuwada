<?php
	...
	$dbUsername = 'spindle';
	$dbPassword = 'spindle';
	$dbDatabase = 'spindle_3_1_0';
	$appURI = 'www/spindle_3_1_0_alpha/app';
	$host = 'localhost';

	$adminConfig = [
		'adminUsername' => "admin",
		'adminPassword' => "\$2y\$10\$8D05kw5Z6FiGiIioS53cKeiO3atAxEhcGbxfS4I.71K57JlMlEo6S",
