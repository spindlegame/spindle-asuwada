...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	@include_once("{$currDir}/hooks/class_dramatica_domain.php");
	include_once("{$currDir}/class_dramatica_domain_dml.php");
	...
	$x->RedirectAfterInsert = 'class_dramatica_domain_view.php';
	$x->TableTitle = 'Domains';
	$x->TableIcon = 'resources/table_icons/flood_it.png';
	$x->PrimaryKey = '`class_dramatica_domain`.`id`';

	$x->ColWidth = [150, 150, 150, ];
	$x->ColCaption = ['Id', 'Domain', 'Description', ];
	$x->ColFieldName = ['id', 'domain', 'description', ];
	$x->ColNumber  = [1, 2, 3, ];
	...
	$x->TemplateDV = 'templates/class_dramatica_domain_templateDV.html';
	$x->TemplateDVP = 'templates/class_dramatica_domain_templateDVP.html';
