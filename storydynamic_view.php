...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"IF(    CHAR_LENGTH(`bio_drama_chr_dev1`.`cw_name`), CONCAT_WS('',   `bio_drama_chr_dev1`.`cw_name`), '') /* Story dev chr */" => "story_dev_chr",
		...
		"IF(    CHAR_LENGTH(`bio_drama_chr_dev3`.`mc_growth`), CONCAT_WS('',   `bio_drama_chr_dev3`.`mc_growth`), '') /* MC growth */" => "mc_growth",
		"IF(    CHAR_LENGTH(`bio_drama_chr_dev4`.`mc_approach`), CONCAT_WS('',   `bio_drama_chr_dev4`.`mc_approach`), '') /* MC approach */" => "mc_approach",
		"IF(    CHAR_LENGTH(`bio_drama_chr_dev5`.`mc_ps_style`), CONCAT_WS('',   `bio_drama_chr_dev5`.`mc_ps_style`), '') /* MC PS style */" => "mc_ps_style",
	...
	$x->SortFields = array(   
		...
		5 => 5,
		6 => 6,
		7 => '`class_dramatica_storypoints31`.`id`',
		8 => '`bio_drama_chr_dev3`.`mc_growth`',
		9 => '`bio_drama_chr_dev4`.`mc_approach`',
		10 => '`bio_drama_chr_dev5`.`mc_ps_style`',
		11 => 11,
		12 => 12,
		13 => 13,
		14 => 14,
		...
		16 => 16,
		17 => 17,
		18 => '`class_dramatica_domain2`.`domain`',
		19 => '`class_dramatica_concern1`.`concern`',
		20 => '`class_dramatica_domain3`.`domain`',
		21 => '`class_dramatica_concern2`.`concern`',
		22 => '`class_dramatica_domain4`.`domain`',
		23 => '`class_dramatica_concern3`.`concern`',
		24 => '`class_dramatica_domain5`.`domain`',
		25 => '`class_dramatica_concern4`.`concern`',
		26 => '`class_dramatica_domain6`.`domain`',
		27 => '`class_dramatica_concern5`.`concern`',
		28 => '`class_dramatica_domain7`.`domain`',
		29 => '`class_dramatica_concern6`.`concern`',
		30 => '`class_dramatica_domain8`.`domain`',
		31 => '`class_dramatica_concern7`.`concern`'
	);
	...
	$x->QueryFieldsFilters = array(   
		"`storydynamic`.`id`" => "ID",
		"IF(    CHAR_LENGTH(`hist_story1`.`id`) || CHAR_LENGTH(`hist_story1`.`story_title`), CONCAT_WS('',   `hist_story1`.`id`, `hist_story1`.`story_title`), '') /* Story */" => "Story",
		"IF(    CHAR_LENGTH(`bio_drama_chr_dev1`.`cw_name`), CONCAT_WS('',   `bio_drama_chr_dev1`.`cw_name`), '') /* Story dev chr */" => "Story dev chr",
		...
		"IF(    CHAR_LENGTH(`bio_drama_chr_dev3`.`mc_growth`), CONCAT_WS('',   `bio_drama_chr_dev3`.`mc_growth`), '') /* MC growth */" => "MC growth",
		"IF(    CHAR_LENGTH(`bio_drama_chr_dev4`.`mc_approach`), CONCAT_WS('',   `bio_drama_chr_dev4`.`mc_approach`), '') /* MC approach */" => "MC approach",
		"IF(    CHAR_LENGTH(`bio_drama_chr_dev5`.`mc_ps_style`), CONCAT_WS('',   `bio_drama_chr_dev5`.`mc_ps_style`), '') /* MC PS style */" => "MC PS style",
	...
	$x->ColWidth   = array(  150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150, 150);
