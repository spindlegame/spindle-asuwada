...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = [
		...
		"IF(    CHAR_LENGTH(`bio_story1`.`id`) || CHAR_LENGTH(`bio_story1`.`agent_name`), CONCAT_WS('',   `bio_story1`.`id`, ' - ', `bio_story1`.`agent_name`), '') /* Biography */" => "bio_story_mc",
		"IF(    CHAR_LENGTH(`class_dramatica_character1`.`character`) || CHAR_LENGTH(`hist_chr1`.`agent_name`), CONCAT_WS('',   `class_dramatica_character1`.`character`, ' - ', `hist_chr1`.`agent_name`), '') /* Mc character */" => "hist_chr_mc",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_character2`.`character`) || CHAR_LENGTH(`bio_chr1`.`agent_name`), CONCAT_WS('',   `class_dramatica_character2`.`character`, ' agent:', `bio_chr1`.`agent_name`), '') /* MC from Chr. Dev. */" => "story_chr_mc",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern1`.`concern`), CONCAT_WS('',   `class_dramatica_concern1`.`concern`), '') /* OS goal concern */" => "os_goal_concern",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern2`.`concern`), CONCAT_WS('',   `class_dramatica_concern2`.`concern`), '') /* OS consequence concern */" => "os_consequence_concern",
		"IF(    CHAR_LENGTH(`class_dramatica_domain3`.`domain`), CONCAT_WS('',   `class_dramatica_domain3`.`domain`), '') /* OS cost domain */" => "os_cost_domain",
		"IF(    CHAR_LENGTH(`class_dramatica_concern3`.`concern`), CONCAT_WS('',   `class_dramatica_concern3`.`concern`), '') /* OS cost concern */" => "os_cost_concern",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern4`.`concern`), CONCAT_WS('',   `class_dramatica_concern4`.`concern`), '') /* OS dividend concern */" => "os_dividend_concern",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern5`.`concern`), CONCAT_WS('',   `class_dramatica_concern5`.`concern`), '') /* OS requirements concern */" => "os_requirements_concern",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern6`.`concern`), CONCAT_WS('',   `class_dramatica_concern6`.`concern`), '') /* OS prerequisites concern */" => "os_prerequesites_concern",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern7`.`concern`), CONCAT_WS('',   `class_dramatica_concern7`.`concern`), '') /* OS preconditions concern */" => "os_preconditions_concern",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern8`.`concern`), CONCAT_WS('',   `class_dramatica_concern8`.`concern`), '') /* OS forewarnings concern */" => "os_forewarnings_concern",
	];
	...
	$x->SortFields = [
		...
		12 => 12,
		13 => 13,
		14 => '`class_dramatica_storypoints11`.`term`',
		15 => '`class_dramatica_storypoints21`.`term`',
		16 => '`class_dramatica_storypoints31`.`term`',
		17 => '`class_dynamicstorypoints46`.`term`',
		18 => '`class_dramatica_storypoints32`.`term`',
		19 => '`class_dynamicstorypoints47`.`term`',
		20 => '`class_dramatica_storypoints33`.`term`',
		21 => '`class_dynamicstorypoints48`.`term`',
		22 => '`class_dramatica_storypoints34`.`term`',
	...
	$x->QueryFieldsFilters = [
		...
		"IF(    CHAR_LENGTH(`bio_story1`.`id`) || CHAR_LENGTH(`bio_story1`.`agent_name`), CONCAT_WS('',   `bio_story1`.`id`, ' - ', `bio_story1`.`agent_name`), '') /* Biography */" => "Biography",
		"IF(    CHAR_LENGTH(`class_dramatica_character1`.`character`) || CHAR_LENGTH(`hist_chr1`.`agent_name`), CONCAT_WS('',   `class_dramatica_character1`.`character`, ' - ', `hist_chr1`.`agent_name`), '') /* Mc character */" => "Mc character",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_character2`.`character`) || CHAR_LENGTH(`bio_chr1`.`agent_name`), CONCAT_WS('',   `class_dramatica_character2`.`character`, ' agent:', `bio_chr1`.`agent_name`), '') /* MC from Chr. Dev. */" => "MC from Chr. Dev.",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern1`.`concern`), CONCAT_WS('',   `class_dramatica_concern1`.`concern`), '') /* OS goal concern */" => "OS goal concern",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern2`.`concern`), CONCAT_WS('',   `class_dramatica_concern2`.`concern`), '') /* OS consequence concern */" => "OS consequence concern",
		"IF(    CHAR_LENGTH(`class_dramatica_domain3`.`domain`), CONCAT_WS('',   `class_dramatica_domain3`.`domain`), '') /* OS cost domain */" => "OS cost domain",
		"IF(    CHAR_LENGTH(`class_dramatica_concern3`.`concern`), CONCAT_WS('',   `class_dramatica_concern3`.`concern`), '') /* OS cost concern */" => "OS cost concern",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern4`.`concern`), CONCAT_WS('',   `class_dramatica_concern4`.`concern`), '') /* OS dividend concern */" => "OS dividend concern",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern5`.`concern`), CONCAT_WS('',   `class_dramatica_concern5`.`concern`), '') /* OS requirements concern */" => "OS requirements concern",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern6`.`concern`), CONCAT_WS('',   `class_dramatica_concern6`.`concern`), '') /* OS prerequisites concern */" => "OS prerequisites concern",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern7`.`concern`), CONCAT_WS('',   `class_dramatica_concern7`.`concern`), '') /* OS preconditions concern */" => "OS preconditions concern",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern8`.`concern`), CONCAT_WS('',   `class_dramatica_concern8`.`concern`), '') /* OS forewarnings concern */" => "OS forewarnings concern",
	];
	...
	$x->TableTitle = 'Hist. dynamic storypoints';
