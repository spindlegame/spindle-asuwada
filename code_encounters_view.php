...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = array(   
		...
		"IF(    CHAR_LENGTH(`biblio_author1`.`id`) || CHAR_LENGTH(`biblio_author1`.`memberID`), CONCAT_WS('',   `biblio_author1`.`id`, '   ', `biblio_author1`.`memberID`), '') /* Author A */" => "authorA",
		...
		"IF(    CHAR_LENGTH(`chr_scenes1`.`id`) || CHAR_LENGTH(`chr_scenes1`.`scene`), CONCAT_WS('',   `chr_scenes1`.`id`, '   ', `chr_scenes1`.`scene`), '') /* Scene A */" => "sceneA",
		"IF(    CHAR_LENGTH(`biblio_author3`.`id`) || CHAR_LENGTH(`biblio_author3`.`memberID`), CONCAT_WS('',   `biblio_author3`.`id`, '   ', `biblio_author3`.`memberID`), '') /* Author B */" => "authorB",
		...
		"IF(    CHAR_LENGTH(`chr_scenes2`.`id`) || CHAR_LENGTH(`chr_scenes2`.`scene`), CONCAT_WS('',   `chr_scenes2`.`id`, '   ', `chr_scenes2`.`scene`), '') /* Scene B */" => "sceneB",
	...
	$x->QueryFieldsFilters = array(   
		"`code_encounters`.`id`" => "Id",
		"IF(    CHAR_LENGTH(`biblio_author1`.`id`) || CHAR_LENGTH(`biblio_author1`.`memberID`), CONCAT_WS('',   `biblio_author1`.`id`, '   ', `biblio_author1`.`memberID`), '') /* Author A */" => "Author A",
		...
		"IF(    CHAR_LENGTH(`chr_scenes1`.`id`) || CHAR_LENGTH(`chr_scenes1`.`scene`), CONCAT_WS('',   `chr_scenes1`.`id`, '   ', `chr_scenes1`.`scene`), '') /* Scene A */" => "Scene A",
		"IF(    CHAR_LENGTH(`biblio_author3`.`id`) || CHAR_LENGTH(`biblio_author3`.`memberID`), CONCAT_WS('',   `biblio_author3`.`id`, '   ', `biblio_author3`.`memberID`), '') /* Author B */" => "Author B",
		...
		"IF(    CHAR_LENGTH(`chr_scenes2`.`id`) || CHAR_LENGTH(`chr_scenes2`.`scene`), CONCAT_WS('',   `chr_scenes2`.`id`, '   ', `chr_scenes2`.`scene`), '') /* Scene B */" => "Scene B",
		"`code_encounters`.`type`" => "Type",
		"`code_encounters`.`conflicttype`" => "Conflicttype",
		"`code_encounters`.`story_scene`" => "Story_scene",
		"`code_encounters`.`nd_color`" => "Nd_color",
