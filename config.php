<?php
	...
	$dbUsername = 'spindle';
	$dbPassword = 'spindle';
	$dbDatabase = 'spindle_2_2_2_cdl';
	$appURI = 'www/spindle_2_2_2_cdl';
	$host = 'localhost';

	$adminConfig = [
		'adminUsername' => "admin",
		'adminPassword' => "\$2y\$10\$0kuHP7sydkVmcRXPVgvhxeIilw9dugAJEfsrNNMwb6covY2ht.tqO",
