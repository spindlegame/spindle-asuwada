...
function bio_code_herme_insert(&$error_message = '') {
	...
	$data = [
		...
		'bio_sdg' => Request::val('bio_sdg', ''),
		'bio_dilemma' => Request::val('bio_dilemma', ''),
		'bio_goals' => Request::val('bio_goals', ''),
...
function bio_code_herme_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = '') {
	...
	$filterer_bio_sdg = thisOr($_REQUEST['filterer_bio_sdg'], '');
	$filterer_bio_dilemma = thisOr($_REQUEST['filterer_bio_dilemma'], '');
	$filterer_bio_goals = thisOr($_REQUEST['filterer_bio_goals'], '');
	...
	// combobox: counterfactual
	$combo_counterfactual = new DataCombo;
	// combobox: bio_sdg
	$combo_bio_sdg = new DataCombo;
	// combobox: bio_dilemma
	$combo_bio_dilemma = new DataCombo;
	// combobox: bio_goals
	$combo_bio_goals = new DataCombo;
	...
	if($selected_id) {
		...
		$combo_bio_sdg->SelectedData = $row['bio_sdg'];
		$combo_bio_dilemma->SelectedData = $row['bio_dilemma'];
		$combo_bio_goals->SelectedData = $row['bio_goals'];
		...
		$combo_bio_sdg->SelectedData = $filterer_bio_sdg;
		$combo_bio_dilemma->SelectedData = $filterer_bio_dilemma;
		$combo_bio_goals->SelectedData = $filterer_bio_goals;
	}
	...
	$combo_bio_sdg->HTML = '<span id="bio_sdg-container' . $rnd1 . '"></span><input type="hidden" name="bio_sdg" id="bio_sdg' . $rnd1 . '" value="' . html_attr($combo_bio_sdg->SelectedData) . '">';
	$combo_bio_sdg->MatchText = '<span id="bio_sdg-container-readonly' . $rnd1 . '"></span><input type="hidden" name="bio_sdg" id="bio_sdg' . $rnd1 . '" value="' . html_attr($combo_bio_sdg->SelectedData) . '">';
	$combo_bio_dilemma->HTML = '<span id="bio_dilemma-container' . $rnd1 . '"></span><input type="hidden" name="bio_dilemma" id="bio_dilemma' . $rnd1 . '" value="' . html_attr($combo_bio_dilemma->SelectedData) . '">';
	$combo_bio_dilemma->MatchText = '<span id="bio_dilemma-container-readonly' . $rnd1 . '"></span><input type="hidden" name="bio_dilemma" id="bio_dilemma' . $rnd1 . '" value="' . html_attr($combo_bio_dilemma->SelectedData) . '">';
	$combo_bio_goals->HTML = '<span id="bio_goals-container' . $rnd1 . '"></span><input type="hidden" name="bio_goals" id="bio_goals' . $rnd1 . '" value="' . html_attr($combo_bio_goals->SelectedData) . '">';
	$combo_bio_goals->MatchText = '<span id="bio_goals-container-readonly' . $rnd1 . '"></span><input type="hidden" name="bio_goals" id="bio_goals' . $rnd1 . '" value="' . html_attr($combo_bio_goals->SelectedData) . '">';
	...
	<script>
		...
		AppGini.current_bio_sdg__RAND__ = { text: "", value: "<?php echo addslashes($selected_id ? $urow['bio_sdg'] : $filterer_bio_sdg); ?>"};
		AppGini.current_bio_dilemma__RAND__ = { text: "", value: "<?php echo addslashes($selected_id ? $urow['bio_dilemma'] : $filterer_bio_dilemma); ?>"};
		AppGini.current_bio_goals__RAND__ = { text: "", value: "<?php echo addslashes($selected_id ? $urow['bio_goals'] : $filterer_bio_goals); ?>"};
		...
		jQuery(function() {
			setTimeout(function() {
				...
				if(typeof(counterfactual_reload__RAND__) == 'function') counterfactual_reload__RAND__();
				if(typeof(bio_sdg_reload__RAND__) == 'function') bio_sdg_reload__RAND__();
				if(typeof(bio_dilemma_reload__RAND__) == 'function') bio_dilemma_reload__RAND__();
				if(typeof(bio_goals_reload__RAND__) == 'function') bio_goals_reload__RAND__();
		...
		function counterfactual_reload__RAND__() {
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint) { ?>
			...
			$j("#counterfactual-container__RAND__").select2({
				...
				initSelection: function(e, c) {
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppGini.current_counterfactual__RAND__.value, t: 'bio_code_herme', f: 'counterfactual' },
						success: function(resp) {
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
							...
							if(resp.results[0].id == '<?php echo empty_lookup_value; ?>') { $j('.btn[id=class_counterfactual_view_parent]').hide(); } else { $j('.btn[id=class_counterfactual_view_parent]').show(); }
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page) { return { s: term, p: page, t: 'bio_code_herme', f: 'counterfactual' }; },
					results: function(resp, page) { return resp; }
				},
				escapeMarkup: function(str) { return str; }
			}).on('change', function(e) {
				...
				if(e.added.id == '<?php echo empty_lookup_value; ?>') { $j('.btn[id=class_counterfactual_view_parent]').hide(); } else { $j('.btn[id=class_counterfactual_view_parent]').show(); }
		...
		function bio_sdg_reload__RAND__() {
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint) { ?>

			$j("#bio_sdg-container__RAND__").select2({
				/* initial default value */
				initSelection: function(e, c) {
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppGini.current_bio_sdg__RAND__.value, t: 'bio_code_herme', f: 'bio_sdg' },
						success: function(resp) {
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
							});
							$j('[name="bio_sdg"]').val(resp.results[0].id);
							$j('[id=bio_sdg-container-readonly__RAND__]').html('<span id="bio_sdg-match-text">' + resp.results[0].text + '</span>');
							...
							if(typeof(bio_sdg_update_autofills__RAND__) == 'function') bio_sdg_update_autofills__RAND__();
						}
					});
				},
				width: '100%',
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page) { return { s: term, p: page, t: 'bio_code_herme', f: 'bio_sdg' }; },
					results: function(resp, page) { return resp; }
				},
				escapeMarkup: function(str) { return str; }
			}).on('change', function(e) {
				AppGini.current_bio_sdg__RAND__.value = e.added.id;
				AppGini.current_bio_sdg__RAND__.text = e.added.text;
				$j('[name="bio_sdg"]').val(e.added.id);
			...
			if(!$j("#bio_sdg-container__RAND__").length) {
				$j.ajax({
					url: 'ajax_combo.php',
					dataType: 'json',
					data: { id: AppGini.current_bio_sdg__RAND__.value, t: 'bio_code_herme', f: 'bio_sdg' },
		...
		<?php } else { ?>
			...
			$j.ajax({
				...
				data: { id: AppGini.current_bio_sdg__RAND__.value, t: 'bio_code_herme', f: 'bio_sdg' },
				success: function(resp) {
					$j('[id=bio_sdg-container__RAND__], [id=bio_sdg-container-readonly__RAND__]').html('<span id="bio_sdg-match-text">' + resp.results[0].text + '</span>');
					if(resp.results[0].id == '<?php echo empty_lookup_value; ?>') { $j('.btn[id=class_sdg_view_parent]').hide(); } else { $j('.btn[id=class_sdg_view_parent]').show(); }
		...
		function bio_dilemma_reload__RAND__() {
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint) { ?>

			$j("#bio_dilemma-container__RAND__").select2({
				/* initial default value */
				initSelection: function(e, c) {
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppGini.current_bio_dilemma__RAND__.value, t: 'bio_code_herme', f: 'bio_dilemma' },
						success: function(resp) {
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
							});
							$j('[name="bio_dilemma"]').val(resp.results[0].id);
							$j('[id=bio_dilemma-container-readonly__RAND__]').html('<span id="bio_dilemma-match-text">' + resp.results[0].text + '</span>');
							if(resp.results[0].id == '<?php echo empty_lookup_value; ?>') { $j('.btn[id=class_dilemma_view_parent]').hide(); } else { $j('.btn[id=class_dilemma_view_parent]').show(); }


							if(typeof(bio_dilemma_update_autofills__RAND__) == 'function') bio_dilemma_update_autofills__RAND__();
						}
					});
				},
				width: '100%',
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page) { return { s: term, p: page, t: 'bio_code_herme', f: 'bio_dilemma' }; },
					results: function(resp, page) { return resp; }
				},
				escapeMarkup: function(str) { return str; }
			}).on('change', function(e) {
				AppGini.current_bio_dilemma__RAND__.value = e.added.id;
				AppGini.current_bio_dilemma__RAND__.text = e.added.text;
				$j('[name="bio_dilemma"]').val(e.added.id);
				if(e.added.id == '<?php echo empty_lookup_value; ?>') { $j('.btn[id=class_dilemma_view_parent]').hide(); } else { $j('.btn[id=class_dilemma_view_parent]').show(); }


				if(typeof(bio_dilemma_update_autofills__RAND__) == 'function') bio_dilemma_update_autofills__RAND__();
			});

			if(!$j("#bio_dilemma-container__RAND__").length) {
				$j.ajax({
					url: 'ajax_combo.php',
					dataType: 'json',
					data: { id: AppGini.current_bio_dilemma__RAND__.value, t: 'bio_code_herme', f: 'bio_dilemma' },
		...
		<?php } else { ?>
			...
			$j.ajax({
				...
				data: { id: AppGini.current_bio_dilemma__RAND__.value, t: 'bio_code_herme', f: 'bio_dilemma' },
				success: function(resp) {
					$j('[id=bio_dilemma-container__RAND__], [id=bio_dilemma-container-readonly__RAND__]').html('<span id="bio_dilemma-match-text">' + resp.results[0].text + '</span>');
					if(resp.results[0].id == '<?php echo empty_lookup_value; ?>') { $j('.btn[id=class_dilemma_view_parent]').hide(); } else { $j('.btn[id=class_dilemma_view_parent]').show(); }
		...
		function bio_goals_reload__RAND__() {
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint) { ?>

			$j("#bio_goals-container__RAND__").select2({
				/* initial default value */
				initSelection: function(e, c) {
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppGini.current_bio_goals__RAND__.value, t: 'bio_code_herme', f: 'bio_goals' },
						success: function(resp) {
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
							});
							$j('[name="bio_goals"]').val(resp.results[0].id);
							$j('[id=bio_goals-container-readonly__RAND__]').html('<span id="bio_goals-match-text">' + resp.results[0].text + '</span>');
							if(resp.results[0].id == '<?php echo empty_lookup_value; ?>') { $j('.btn[id=class_goals_view_parent]').hide(); } else { $j('.btn[id=class_goals_view_parent]').show(); }


							if(typeof(bio_goals_update_autofills__RAND__) == 'function') bio_goals_update_autofills__RAND__();
						}
					});
				},
				width: '100%',
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page) { return { s: term, p: page, t: 'bio_code_herme', f: 'bio_goals' }; },
					results: function(resp, page) { return resp; }
				},
				escapeMarkup: function(str) { return str; }
			}).on('change', function(e) {
				AppGini.current_bio_goals__RAND__.value = e.added.id;
				AppGini.current_bio_goals__RAND__.text = e.added.text;
				$j('[name="bio_goals"]').val(e.added.id);
				if(e.added.id == '<?php echo empty_lookup_value; ?>') { $j('.btn[id=class_goals_view_parent]').hide(); } else { $j('.btn[id=class_goals_view_parent]').show(); }


				if(typeof(bio_goals_update_autofills__RAND__) == 'function') bio_goals_update_autofills__RAND__();
			});

			if(!$j("#bio_goals-container__RAND__").length) {
				$j.ajax({
					url: 'ajax_combo.php',
					dataType: 'json',
					data: { id: AppGini.current_bio_goals__RAND__.value, t: 'bio_code_herme', f: 'bio_goals' },
		...
		<?php } else { ?>
			...
			$j.ajax({
				...
				data: { id: AppGini.current_bio_goals__RAND__.value, t: 'bio_code_herme', f: 'bio_goals' },
				success: function(resp) {
					$j('[id=bio_goals-container__RAND__], [id=bio_goals-container-readonly__RAND__]').html('<span id="bio_goals-match-text">' + resp.results[0].text + '</span>');
					if(resp.results[0].id == '<?php echo empty_lookup_value; ?>') { $j('.btn[id=class_goals_view_parent]').hide(); } else { $j('.btn[id=class_goals_view_parent]').show(); }
	...
	if(($selected_id && !$AllowUpdate && !$AllowInsert) || (!$selected_id && !$AllowInsert)) {
		...
		$jsReadOnly .= "\tjQuery('#bio_sdg').prop('disabled', true).css({ color: '#555', backgroundColor: '#fff' });\n";
		$jsReadOnly .= "\tjQuery('#bio_sdg_caption').prop('disabled', true).css({ color: '#555', backgroundColor: 'white' });\n";
		$jsReadOnly .= "\tjQuery('#bio_dilemma').prop('disabled', true).css({ color: '#555', backgroundColor: '#fff' });\n";
		$jsReadOnly .= "\tjQuery('#bio_dilemma_caption').prop('disabled', true).css({ color: '#555', backgroundColor: 'white' });\n";
		$jsReadOnly .= "\tjQuery('#bio_goals').prop('disabled', true).css({ color: '#555', backgroundColor: '#fff' });\n";
		$jsReadOnly .= "\tjQuery('#bio_goals_caption').prop('disabled', true).css({ color: '#555', backgroundColor: 'white' });\n";
	...
	$templateCode = str_replace('<%%COMBO(bio_sdg)%%>', $combo_bio_sdg->HTML, $templateCode);
	$templateCode = str_replace('<%%COMBOTEXT(bio_sdg)%%>', $combo_bio_sdg->MatchText, $templateCode);
	$templateCode = str_replace('<%%URLCOMBOTEXT(bio_sdg)%%>', urlencode($combo_bio_sdg->MatchText), $templateCode);
	$templateCode = str_replace('<%%COMBO(bio_dilemma)%%>', $combo_bio_dilemma->HTML, $templateCode);
	$templateCode = str_replace('<%%COMBOTEXT(bio_dilemma)%%>', $combo_bio_dilemma->MatchText, $templateCode);
	$templateCode = str_replace('<%%URLCOMBOTEXT(bio_dilemma)%%>', urlencode($combo_bio_dilemma->MatchText), $templateCode);
	$templateCode = str_replace('<%%COMBO(bio_goals)%%>', $combo_bio_goals->HTML, $templateCode);
	$templateCode = str_replace('<%%COMBOTEXT(bio_goals)%%>', $combo_bio_goals->MatchText, $templateCode);
	$templateCode = str_replace('<%%URLCOMBOTEXT(bio_goals)%%>', urlencode($combo_bio_goals->MatchText), $templateCode);

	/* lookup fields array: 'lookup field name' => array('parent table name', 'lookup field caption') */
	$lookup_fields = array('biography' => array('bio_story', 'Biograf&#237;a'), 'agent_id' => array('game_agent', 'ID agente'), 'author_id' => array('biblio_author', 'ID autor'), 'bibliography' => array('biblio_doc', 'Bibliograf&#237;a'), 'transcript' => array('biblio_transcript', 'Transcripci&#243;n'), 'token_sequence' => array('biblio_token', 'Secuencia de token'), 'impression' => array('class_im', 'Impresi&#243;n'), 'noetictension' => array('class_nt', 'Tensi&#243;n no&#233;tica'), 'pc' => array('class_pc', 'Contradicci&#243;n performativa'), 'counterfactual' => array('class_counterfactual', 'Contrafactuales'), 'bio_sdg' => array('class_sdg', 'Objetivo de Desarollo Sostenible'), 'bio_dilemma' => array('class_dilemma', 'Dilemma'), 'bio_goals' => array('class_goals', 'Objetivos positivos'), );
	...
	$templateCode = str_replace('<%%UPLOADFILE(bio_sdg)%%>', '', $templateCode);
	$templateCode = str_replace('<%%UPLOADFILE(bio_dilemma)%%>', '', $templateCode);
	$templateCode = str_replace('<%%UPLOADFILE(bio_goals)%%>', '', $templateCode);
	...
	if($selected_id) {
		...
		if( $dvprint) $templateCode = str_replace('<%%VALUE(bio_sdg)%%>', safe_html($urow['bio_sdg']), $templateCode);
		if(!$dvprint) $templateCode = str_replace('<%%VALUE(bio_sdg)%%>', html_attr($row['bio_sdg']), $templateCode);
		$templateCode = str_replace('<%%URLVALUE(bio_sdg)%%>', urlencode($urow['bio_sdg']), $templateCode);
		if( $dvprint) $templateCode = str_replace('<%%VALUE(bio_dilemma)%%>', safe_html($urow['bio_dilemma']), $templateCode);
		if(!$dvprint) $templateCode = str_replace('<%%VALUE(bio_dilemma)%%>', html_attr($row['bio_dilemma']), $templateCode);
		$templateCode = str_replace('<%%URLVALUE(bio_dilemma)%%>', urlencode($urow['bio_dilemma']), $templateCode);
		if( $dvprint) $templateCode = str_replace('<%%VALUE(bio_goals)%%>', safe_html($urow['bio_goals']), $templateCode);
		if(!$dvprint) $templateCode = str_replace('<%%VALUE(bio_goals)%%>', html_attr($row['bio_goals']), $templateCode);
		$templateCode = str_replace('<%%URLVALUE(bio_goals)%%>', urlencode($urow['bio_goals']), $templateCode);
		...
		$templateCode = str_replace('<%%VALUE(bio_sdg)%%>', '', $templateCode);
		$templateCode = str_replace('<%%URLVALUE(bio_sdg)%%>', urlencode(''), $templateCode);
		$templateCode = str_replace('<%%VALUE(bio_dilemma)%%>', '', $templateCode);
		$templateCode = str_replace('<%%URLVALUE(bio_dilemma)%%>', urlencode(''), $templateCode);
		$templateCode = str_replace('<%%VALUE(bio_goals)%%>', '', $templateCode);
		$templateCode = str_replace('<%%URLVALUE(bio_goals)%%>', urlencode(''), $templateCode);
