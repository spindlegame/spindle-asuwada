...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$table_perms = getTablePermissions('hist_story_chrs');
	...
	switch($mfk) {
		...
		case 'hist_lead_id':
			if(!$id) {
				?>
				$j('#hist_lead_memberid<?php echo $rnd1; ?>').html('&nbsp;');
				$j('#hist_lead_name<?php echo $rnd1; ?>').html('&nbsp;');
				<?php
				break;
			}
			...
			?>
			$j('#hist_lead_memberid<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(array("\r", "\n"), '', nl2br($row['agent_memberid']))); ?>&nbsp;');
			$j('#hist_lead_name<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(array("\r", "\n"), '', nl2br($row['last_name'].', '.$row['first_name']))); ?>&nbsp;');
			<?php
			break;
