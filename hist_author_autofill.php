...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$table_perms = getTablePermissions('hist_author');
	...
	switch($mfk) {
		...
		case 'agent_id':
			if(!$id) {
				?>
				$j('#agent_memberid<?php echo $rnd1; ?>').html('&nbsp;');
			...
			?>
			$j('#agent_memberid<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(array("\r", "\n"), '', nl2br($row['memberID']))); ?>&nbsp;');
