...
// Data functions (insert, update, delete, form) for table character_development

// This script and data application were generated by AppGini 5.76
// Download AppGini for free from https://bigprof.com/appgini/download/

function character_development_insert(){
	global $Translation;

	// mm: can member insert record?
	$arrPerm=getTablePermissions('character_development');
	if(!$arrPerm[1]){
		return false;
	}
...
function character_development_delete($selected_id, $AllowDeleteOfParents=false, $skipChecks=false){
	...
	$arrPerm=getTablePermissions('character_development');
	$ownerGroupID=sqlValue("select groupID from membership_userrecords where tableName='character_development' and pkValue='$selected_id'");
	$ownerMemberID=sqlValue("select lcase(memberID) from membership_userrecords where tableName='character_development' and pkValue='$selected_id'");
	...
	// hook: character_development_before_delete
	if(function_exists('character_development_before_delete')){
		$args=array();
		if(!character_development_before_delete($selected_id, $skipChecks, getMemberInfo(), $args))
			return $Translation['Couldn\'t delete this record'];
	}

	// child table: story_characters
	$res = sql("select `id` from `character_development` where `id`='$selected_id'", $eo);
	$id = db_fetch_row($res);
	$rires = sql("select count(1) from `story_characters` where `character`='".addslashes($id[0])."'", $eo);
	...
	if($rirow[0] && !$AllowDeleteOfParents && !$skipChecks){
		...
		$RetMsg = str_replace("<RelatedRecords>", $rirow[0], $RetMsg);
		$RetMsg = str_replace("<TableName>", "story_characters", $RetMsg);
		$RetMsg = str_replace("<Delete>", "<input type=\"button\" class=\"button\" value=\"".$Translation['yes']."\" onClick=\"window.location='character_development_view.php?SelectedID=".urlencode($selected_id)."&delete_x=1&confirmed=1';\">", $RetMsg);
		$RetMsg = str_replace("<Cancel>", "<input type=\"button\" class=\"button\" value=\"".$Translation['no']."\" onClick=\"window.location='character_development_view.php?SelectedID=".urlencode($selected_id)."';\">", $RetMsg);
		return $RetMsg;
	}
	...
	sql("delete from `character_development` where `id`='$selected_id'", $eo);

	// hook: character_development_after_delete
	if(function_exists('character_development_after_delete')){
		$args=array();
		character_development_after_delete($selected_id, getMemberInfo(), $args);
	}

	// mm: delete ownership data
	sql("delete from membership_userrecords where tableName='character_development' and pkValue='$selected_id'", $eo);
}

function character_development_update($selected_id){
	global $Translation;

	// mm: can member edit record?
	$arrPerm=getTablePermissions('character_development');
	$ownerGroupID=sqlValue("select groupID from membership_userrecords where tableName='character_development' and pkValue='".makeSafe($selected_id)."'");
	$ownerMemberID=sqlValue("select lcase(memberID) from membership_userrecords where tableName='character_development' and pkValue='".makeSafe($selected_id)."'");
	...
	// hook: character_development_before_update
	if(function_exists('character_development_before_update')){
		$args=array();
		if(!character_development_before_update($data, getMemberInfo(), $args)){ return false; }
	}

	$o=array('silentErrors' => true);
	sql('update `character_development` set       `agent_id`=' . (($data['agent_id'] !== '' && $data['agent_id'] !== NULL) ? "'{$data['agent_id']}'" : 'NULL') . ', `agent_name`=' . (($data['agent_name'] !== '' && $data['agent_name'] !== NULL) ? "'{$data['agent_name']}'" : 'NULL') . ', `cw_name`=' . (($data['cw_name'] !== '' && $data['cw_name'] !== NULL) ? "'{$data['cw_name']}'" : 'NULL') . ', ' . ($data['img']!='' ? "`img`='{$data['img']}'" : ($_REQUEST['img_remove'] != 1 ? '`img`=`img`' : '`img`=NULL')) . ', `mc_resolve`=' . (($data['mc_resolve'] !== '' && $data['mc_resolve'] !== NULL) ? "'{$data['mc_resolve']}'" : 'NULL') . ', `illust_resolve`=' . (($data['illust_resolve'] !== '' && $data['illust_resolve'] !== NULL) ? "'{$data['illust_resolve']}'" : 'NULL') . ', `mc_growth`=' . (($data['mc_growth'] !== '' && $data['mc_growth'] !== NULL) ? "'{$data['mc_growth']}'" : 'NULL') . ', `illust_growth`=' . (($data['illust_growth'] !== '' && $data['illust_growth'] !== NULL) ? "'{$data['illust_growth']}'" : 'NULL') . ', `mc_approach`=' . (($data['mc_approach'] !== '' && $data['mc_approach'] !== NULL) ? "'{$data['mc_approach']}'" : 'NULL') . ', `illust_approach`=' . (($data['illust_approach'] !== '' && $data['illust_approach'] !== NULL) ? "'{$data['illust_approach']}'" : 'NULL') . ', `mc_ps_style`=' . (($data['mc_ps_style'] !== '' && $data['mc_ps_style'] !== NULL) ? "'{$data['mc_ps_style']}'" : 'NULL') . ', `illust_ps_style`=' . (($data['illust_ps_style'] !== '' && $data['illust_ps_style'] !== NULL) ? "'{$data['illust_ps_style']}'" : 'NULL') . ', `cw_age`=' . (($data['cw_age'] !== '' && $data['cw_age'] !== NULL) ? "'{$data['cw_age']}'" : 'NULL') . ', `cw_gender`=' . (($data['cw_gender'] !== '' && $data['cw_gender'] !== NULL) ? "'{$data['cw_gender']}'" : 'NULL') . ', `cw_communication_style`=' . (($data['cw_communication_style'] !== '' && $data['cw_communication_style'] !== NULL) ? "'{$data['cw_communication_style']}'" : 'NULL') . ', `cw_background`=' . (($data['cw_background'] !== '' && $data['cw_background'] !== NULL) ? "'{$data['cw_background']}'" : 'NULL') . ', `cw_appearance`=' . (($data['cw_appearance'] !== '' && $data['cw_appearance'] !== NULL) ? "'{$data['cw_appearance']}'" : 'NULL') . ', `cw_relationships`=' . (($data['cw_relationships'] !== '' && $data['cw_relationships'] !== NULL) ? "'{$data['cw_relationships']}'" : 'NULL') . ', `cw_ambition`=' . (($data['cw_ambition'] !== '' && $data['cw_ambition'] !== NULL) ? "'{$data['cw_ambition']}'" : 'NULL') . ', `cw_defects`=' . (($data['cw_defects'] !== '' && $data['cw_defects'] !== NULL) ? "'{$data['cw_defects']}'" : 'NULL') . ', `cw_thoughts`=' . (($data['cw_thoughts'] !== '' && $data['cw_thoughts'] !== NULL) ? "'{$data['cw_thoughts']}'" : 'NULL') . ', `cw_relatedness`=' . (($data['cw_relatedness'] !== '' && $data['cw_relatedness'] !== NULL) ? "'{$data['cw_relatedness']}'" : 'NULL') . ', `cw_restrictions`=' . (($data['cw_restrictions'] !== '' && $data['cw_restrictions'] !== NULL) ? "'{$data['cw_restrictions']}'" : 'NULL') . ', `locations`=' . (($data['locations'] !== '' && $data['locations'] !== NULL) ? "'{$data['locations']}'" : 'NULL') . ', `persons`=' . (($data['persons'] !== '' && $data['persons'] !== NULL) ? "'{$data['persons']}'" : 'NULL') . ', `events`=' . (($data['events'] !== '' && $data['events'] !== NULL) ? "'{$data['events']}'" : 'NULL') . ', `noetictension`=' . (($data['noetictension'] !== '' && $data['noetictension'] !== NULL) ? "'{$data['noetictension']}'" : 'NULL') . ', `illust_nt`=' . (($data['illust_nt'] !== '' && $data['illust_nt'] !== NULL) ? "'{$data['illust_nt']}'" : 'NULL') . ', `impression`=' . (($data['impression'] !== '' && $data['impression'] !== NULL) ? "'{$data['impression']}'" : 'NULL') . ', `illust_im`=' . (($data['illust_im'] !== '' && $data['illust_im'] !== NULL) ? "'{$data['illust_im']}'" : 'NULL') . ', `mcs_problem`=' . (($data['mcs_problem'] !== '' && $data['mcs_problem'] !== NULL) ? "'{$data['mcs_problem']}'" : 'NULL') . ', `illust_mcs_problem`=' . (($data['illust_mcs_problem'] !== '' && $data['illust_mcs_problem'] !== NULL) ? "'{$data['illust_mcs_problem']}'" : 'NULL') . ', `mcs_solution`=' . (($data['mcs_solution'] !== '' && $data['mcs_solution'] !== NULL) ? "'{$data['mcs_solution']}'" : 'NULL') . ', `illust_mcs_solution`=' . (($data['illust_mcs_solution'] !== '' && $data['illust_mcs_solution'] !== NULL) ? "'{$data['illust_mcs_solution']}'" : 'NULL') . ', `mcs_symptom`=' . (($data['mcs_symptom'] !== '' && $data['mcs_symptom'] !== NULL) ? "'{$data['mcs_symptom']}'" : 'NULL') . ', `illust_mcs_symptom`=' . (($data['illust_mcs_symptom'] !== '' && $data['illust_mcs_symptom'] !== NULL) ? "'{$data['illust_mcs_symptom']}'" : 'NULL') . ', `mcs_response`=' . (($data['mcs_response'] !== '' && $data['mcs_response'] !== NULL) ? "'{$data['mcs_response']}'" : 'NULL') . ', `illust_mcs_response`=' . (($data['illust_mcs_response'] !== '' && $data['illust_mcs_response'] !== NULL) ? "'{$data['illust_mcs_response']}'" : 'NULL') . " where `id`='".makeSafe($selected_id)."'", $o);
	if($o['error']!=''){
		echo $o['error'];
		echo '<a href="character_development_view.php?SelectedID='.urlencode($selected_id)."\">{$Translation['< back']}</a>";
		exit;
	}


	// hook: character_development_after_update
	if(function_exists('character_development_after_update')){
		$res = sql("SELECT * FROM `character_development` WHERE `id`='{$data['selectedID']}' LIMIT 1", $eo);
		if($row = db_fetch_assoc($res)){
			$data = array_map('makeSafe', $row);
		}
		$data['selectedID'] = $data['id'];
		$args = array();
		if(!character_development_after_update($data, getMemberInfo(), $args)){ return; }
	}

	// mm: update ownership data
	sql("update membership_userrecords set dateUpdated='".time()."' where tableName='character_development' and pkValue='".makeSafe($selected_id)."'", $eo);

}

function character_development_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = ''){
	...
	if(is_file(dirname(__FILE__).'/hooks/character_development.mc_resolve.csv')){
		$mc_resolve_data = addslashes(implode('', @file(dirname(__FILE__).'/hooks/character_development.mc_resolve.csv')));
	...
	if(is_file(dirname(__FILE__).'/hooks/character_development.mc_growth.csv')){
		$mc_growth_data = addslashes(implode('', @file(dirname(__FILE__).'/hooks/character_development.mc_growth.csv')));
	...
	if(is_file(dirname(__FILE__).'/hooks/character_development.mc_approach.csv')){
		$mc_approach_data = addslashes(implode('', @file(dirname(__FILE__).'/hooks/character_development.mc_approach.csv')));
	...
	if(is_file(dirname(__FILE__).'/hooks/character_development.mc_ps_style.csv')){
		$mc_ps_style_data = addslashes(implode('', @file(dirname(__FILE__).'/hooks/character_development.mc_ps_style.csv')));
	...
	if($selected_id){
		...
		$res = sql("select * from `character_development` where `id`='".makeSafe($selected_id)."'", $eo);
		if(!($row = db_fetch_array($res))){
			return error_message($Translation['No records found'], 'character_development_view.php', false);
		}
			...
			$j("#agent_id-container__RAND__").select2({
				...
				initSelection: function(e, c){
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppGini.current_agent_id__RAND__.value, t: 'character_development', f: 'agent_id' },
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ /* */ return { s: term, p: page, t: 'character_development', f: 'agent_id' }; },
		...
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint){ ?>
			...
			$j("#illust_resolve-container__RAND__").select2({
				...
				initSelection: function(e, c){
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { filterer_agent_id: filterer_agent_id, id: AppGini.current_illust_resolve__RAND__.value, t: 'character_development', f: 'illust_resolve' },
						success: function(resp){
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ /* */ return { filterer_agent_id: filterer_agent_id, s: term, p: page, t: 'character_development', f: 'illust_resolve' }; },
					results: function(resp, page){ /* */ return resp; }
				},
				escapeMarkup: function(str){ /* */ return str; }
			}).on('change', function(e){
			...
			if(!$j("#illust_resolve-container__RAND__").length){
				$j.ajax({
					url: 'ajax_combo.php',
					dataType: 'json',
					data: { id: AppGini.current_illust_resolve__RAND__.value, t: 'character_development', f: 'illust_resolve' },
					success: function(resp){
						$j('[name="illust_resolve"]').val(resp.results[0].id);
						$j('[id=illust_resolve-container-readonly__RAND__]').html('<span id="illust_resolve-match-text">' + resp.results[0].text + '</span>');
						if(resp.results[0].id == '<?php echo empty_lookup_value; ?>'){ $j('.btn[id=character_illustration_view_parent]').hide(); }else{ $j('.btn[id=character_illustration_view_parent]').show(); }
		...
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint){ ?>
			...
			$j("#illust_growth-container__RAND__").select2({
				...
				initSelection: function(e, c){
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { filterer_agent_id: filterer_agent_id, id: AppGini.current_illust_growth__RAND__.value, t: 'character_development', f: 'illust_growth' },
						success: function(resp){
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ /* */ return { filterer_agent_id: filterer_agent_id, s: term, p: page, t: 'character_development', f: 'illust_growth' }; },
					results: function(resp, page){ /* */ return resp; }
				},
				escapeMarkup: function(str){ /* */ return str; }
			}).on('change', function(e){
			...
			if(!$j("#illust_growth-container__RAND__").length){
				$j.ajax({
					url: 'ajax_combo.php',
					dataType: 'json',
					data: { id: AppGini.current_illust_growth__RAND__.value, t: 'character_development', f: 'illust_growth' },
					success: function(resp){
						$j('[name="illust_growth"]').val(resp.results[0].id);
						$j('[id=illust_growth-container-readonly__RAND__]').html('<span id="illust_growth-match-text">' + resp.results[0].text + '</span>');
						if(resp.results[0].id == '<?php echo empty_lookup_value; ?>'){ $j('.btn[id=character_illustration_view_parent]').hide(); }else{ $j('.btn[id=character_illustration_view_parent]').show(); }
		...
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint){ ?>
			...
			$j("#illust_approach-container__RAND__").select2({
				...
				initSelection: function(e, c){
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { filterer_agent_id: filterer_agent_id, id: AppGini.current_illust_approach__RAND__.value, t: 'character_development', f: 'illust_approach' },
						success: function(resp){
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ /* */ return { filterer_agent_id: filterer_agent_id, s: term, p: page, t: 'character_development', f: 'illust_approach' }; },
					results: function(resp, page){ /* */ return resp; }
				},
				escapeMarkup: function(str){ /* */ return str; }
			}).on('change', function(e){
			...
			if(!$j("#illust_approach-container__RAND__").length){
				$j.ajax({
					url: 'ajax_combo.php',
					dataType: 'json',
					data: { id: AppGini.current_illust_approach__RAND__.value, t: 'character_development', f: 'illust_approach' },
					success: function(resp){
						$j('[name="illust_approach"]').val(resp.results[0].id);
						$j('[id=illust_approach-container-readonly__RAND__]').html('<span id="illust_approach-match-text">' + resp.results[0].text + '</span>');
						if(resp.results[0].id == '<?php echo empty_lookup_value; ?>'){ $j('.btn[id=character_illustration_view_parent]').hide(); }else{ $j('.btn[id=character_illustration_view_parent]').show(); }
			...
			$j("#illust_ps_style-container__RAND__").select2({
				...
				initSelection: function(e, c){
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppGini.current_illust_ps_style__RAND__.value, t: 'character_development', f: 'illust_ps_style' },
						success: function(resp){
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ /* */ return { s: term, p: page, t: 'character_development', f: 'illust_ps_style' }; },
					results: function(resp, page){ /* */ return resp; }
				},
				escapeMarkup: function(str){ /* */ return str; }
			}).on('change', function(e){
			...
			$j("#noetictension-container__RAND__").select2({
				...
				initSelection: function(e, c){
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppGini.current_noetictension__RAND__.value, t: 'character_development', f: 'noetictension' },
						success: function(resp){
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ /* */ return { s: term, p: page, t: 'character_development', f: 'noetictension' }; },
					results: function(resp, page){ /* */ return resp; }
				},
				escapeMarkup: function(str){ /* */ return str; }
			}).on('change', function(e){
			...
			$j("#illust_nt-container__RAND__").select2({
				...
				initSelection: function(e, c){
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppGini.current_illust_nt__RAND__.value, t: 'character_development', f: 'illust_nt' },
						success: function(resp){
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ /* */ return { s: term, p: page, t: 'character_development', f: 'illust_nt' }; },
					results: function(resp, page){ /* */ return resp; }
				},
				escapeMarkup: function(str){ /* */ return str; }
			}).on('change', function(e){
			...
			$j("#impression-container__RAND__").select2({
				...
				initSelection: function(e, c){
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppGini.current_impression__RAND__.value, t: 'character_development', f: 'impression' },
						success: function(resp){
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ /* */ return { s: term, p: page, t: 'character_development', f: 'impression' }; },
					results: function(resp, page){ /* */ return resp; }
				},
				escapeMarkup: function(str){ /* */ return str; }
			}).on('change', function(e){
			...
			$j("#illust_im-container__RAND__").select2({
				...
				initSelection: function(e, c){
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppGini.current_illust_im__RAND__.value, t: 'character_development', f: 'illust_im' },
						success: function(resp){
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ /* */ return { s: term, p: page, t: 'character_development', f: 'illust_im' }; },
					results: function(resp, page){ /* */ return resp; }
				},
				escapeMarkup: function(str){ /* */ return str; }
			}).on('change', function(e){
		...
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint){ ?>
			...
			$j("#mcs_problem-container__RAND__").select2({
				...
				initSelection: function(e, c){
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { filterer_story: filterer_story, id: AppGini.current_mcs_problem__RAND__.value, t: 'character_development', f: 'mcs_problem' },
						success: function(resp){
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ /* */ return { filterer_story: filterer_story, s: term, p: page, t: 'character_development', f: 'mcs_problem' }; },
					results: function(resp, page){ /* */ return resp; }
				},
				escapeMarkup: function(str){ /* */ return str; }
			}).on('change', function(e){
			...
			if(!$j("#mcs_problem-container__RAND__").length){
				$j.ajax({
					url: 'ajax_combo.php',
					dataType: 'json',
					data: { id: AppGini.current_mcs_problem__RAND__.value, t: 'character_development', f: 'mcs_problem' },
					success: function(resp){
						$j('[name="mcs_problem"]').val(resp.results[0].id);
						$j('[id=mcs_problem-container-readonly__RAND__]').html('<span id="mcs_problem-match-text">' + resp.results[0].text + '</span>');
						if(resp.results[0].id == '<?php echo empty_lookup_value; ?>'){ $j('.btn[id=storypoints_static_view_parent]').hide(); }else{ $j('.btn[id=storypoints_static_view_parent]').show(); }
			...
			$j("#illust_mcs_problem-container__RAND__").select2({
				...
				initSelection: function(e, c){
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppGini.current_illust_mcs_problem__RAND__.value, t: 'character_development', f: 'illust_mcs_problem' },
						success: function(resp){
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ /* */ return { s: term, p: page, t: 'character_development', f: 'illust_mcs_problem' }; },
					results: function(resp, page){ /* */ return resp; }
				},
				escapeMarkup: function(str){ /* */ return str; }
			}).on('change', function(e){
			...
			$j("#illust_mcs_solution-container__RAND__").select2({
				...
				initSelection: function(e, c){
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppGini.current_illust_mcs_solution__RAND__.value, t: 'character_development', f: 'illust_mcs_solution' },
						success: function(resp){
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ /* */ return { s: term, p: page, t: 'character_development', f: 'illust_mcs_solution' }; },
					results: function(resp, page){ /* */ return resp; }
				},
				escapeMarkup: function(str){ /* */ return str; }
			}).on('change', function(e){
			...
			$j("#illust_mcs_symptom-container__RAND__").select2({
				...
				initSelection: function(e, c){
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppGini.current_illust_mcs_symptom__RAND__.value, t: 'character_development', f: 'illust_mcs_symptom' },
						success: function(resp){
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ /* */ return { s: term, p: page, t: 'character_development', f: 'illust_mcs_symptom' }; },
					results: function(resp, page){ /* */ return resp; }
				},
				escapeMarkup: function(str){ /* */ return str; }
			}).on('change', function(e){
			...
			$j("#illust_mcs_response-container__RAND__").select2({
				...
				initSelection: function(e, c){
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { id: AppGini.current_illust_mcs_response__RAND__.value, t: 'character_development', f: 'illust_mcs_response' },
						success: function(resp){
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page){ /* */ return { s: term, p: page, t: 'character_development', f: 'illust_mcs_response' }; },
					results: function(resp, page){ /* */ return resp; }
				},
				escapeMarkup: function(str){ /* */ return str; }
			}).on('change', function(e){
	...
	if($dvprint){
		$template_file = is_file("./{$TemplateDVP}") ? "./{$TemplateDVP}" : './templates/character_development_templateDVP.html';
		$templateCode = @file_get_contents($template_file);
	}else{
		$template_file = is_file("./{$TemplateDV}") ? "./{$TemplateDV}" : './templates/character_development_templateDV.html';
		$templateCode = @file_get_contents($template_file);
	}
	...
	// process buttons
	if($AllowInsert){
		if(!$selected_id) $templateCode = str_replace('<%%INSERT_BUTTON%%>', '<button type="submit" class="btn btn-success" id="insert" name="insert_x" value="1" onclick="return character_development_validateData();"><i class="glyphicon glyphicon-plus-sign"></i> ' . $Translation['Save New'] . '</button>', $templateCode);
		$templateCode = str_replace('<%%INSERT_BUTTON%%>', '<button type="submit" class="btn btn-default" id="insert" name="insert_x" value="1" onclick="return character_development_validateData();"><i class="glyphicon glyphicon-plus-sign"></i> ' . $Translation['Save As Copy'] . '</button>', $templateCode);
	}else{
	...
	if($selected_id){
		...
		if($AllowUpdate){
			$templateCode = str_replace('<%%UPDATE_BUTTON%%>', '<button type="submit" class="btn btn-success btn-lg" id="update" name="update_x" value="1" onclick="return character_development_validateData();" title="' . html_attr($Translation['Save Changes']) . '"><i class="glyphicon glyphicon-ok"></i> ' . $Translation['Save Changes'] . '</button>', $templateCode);
		}else{
	...
	$templateCode .= "\t\t\$j.ajax({\n";
	if($dvprint) {
		$templateCode .= "\t\t\turl: 'character_development_autofill.php?rnd1=$rnd1&mfk=agent_id&id=' + encodeURIComponent('".addslashes($row['agent_id'])."'),\n";
		$templateCode .= "\t\t\tcontentType: 'application/x-www-form-urlencoded; charset=" . datalist_db_encoding . "',\n";
		$templateCode .= "\t\t\ttype: 'GET'\n";
	} else {
		$templateCode .= "\t\t\turl: 'character_development_autofill.php?rnd1=$rnd1&mfk=agent_id&id=' + encodeURIComponent(AppGini.current_agent_id{$rnd1}.value),\n";
		$templateCode .= "\t\t\tcontentType: 'application/x-www-form-urlencoded; charset=" . datalist_db_encoding . "',\n";
		$templateCode .= "\t\t\ttype: 'GET',\n";
	...
	$templateCode .= "\t\t\$j.ajax({\n";
	if($dvprint) {
		$templateCode .= "\t\t\turl: 'character_development_autofill.php?rnd1=$rnd1&mfk=mcs_problem&id=' + encodeURIComponent('".addslashes($row['mcs_problem'])."'),\n";
		$templateCode .= "\t\t\tcontentType: 'application/x-www-form-urlencoded; charset=" . datalist_db_encoding . "',\n";
		$templateCode .= "\t\t\ttype: 'GET'\n";
	} else {
		$templateCode .= "\t\t\turl: 'character_development_autofill.php?rnd1=$rnd1&mfk=mcs_problem&id=' + encodeURIComponent(AppGini.current_mcs_problem{$rnd1}.value),\n";
		$templateCode .= "\t\t\tcontentType: 'application/x-www-form-urlencoded; charset=" . datalist_db_encoding . "',\n";
		$templateCode .= "\t\t\ttype: 'GET',\n";
	...
	$rdata = $jdata = get_defaults('character_development');
	if($selected_id){
		$jdata = get_joined_record('character_development', $selected_id);
		if($jdata === false) $jdata = get_defaults('character_development');
		$rdata = $row;
	}
	$templateCode .= loadView('character_development-ajax-cache', array('rdata' => $rdata, 'jdata' => $jdata));

	// hook: character_development_dv
	if(function_exists('character_development_dv')){
		$args=array();
		character_development_dv(($selected_id ? $selected_id : FALSE), getMemberInfo(), $templateCode, $args);
	}
