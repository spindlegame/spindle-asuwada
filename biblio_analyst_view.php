...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFrom = "`biblio_analyst` LEFT JOIN `biblio_team` as biblio_team1 ON `biblio_team1`.`id`=`biblio_analyst`.`team` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`biblio_analyst`.`author_id` ";
	$x->QueryWhere = '';
	$x->QueryOrder = '';
	...
	$x->TableTitle = 'Bibliography analyst';
