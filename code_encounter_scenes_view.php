...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->RedirectAfterInsert = "code_encounter_scenes_view.php";
	...
	$x->ColCaption = array("ID", "Scene");
	$x->ColFieldName = array('id', 'scene');
	...
	$x->TemplateDV = 'templates/code_encounter_scenes_templateDV.html';
	$x->TemplateDVP = 'templates/code_encounter_scenes_templateDVP.html';
