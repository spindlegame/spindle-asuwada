...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	@include("$currDir/hooks/class_evaluation.php");
	include("$currDir/class_evaluation_dml.php");
	...
	$x->ColCaption = array("Evaluation type", "Description");
	$x->ColFieldName = array('evaluation_type', 'description');
