...
function biblio_doc_validateData() {
	...
	if(!AppGini.Validation.fieldRequired('lookup', 'author_id', 'Author_id')) return false;
	if(!AppGini.Validation.fieldRequired('text', 'title', 'Title')) return false;
...
function biblio_transcript_validateData() {
	...
	[
		...
		['lookup', 'author_memberID', 'Author ID'],
		['lookup', 'bibliography_title', 'Bibliography title'],
		['text', 'transcript_title', 'Transcript title'],
		['file', 'transcript', 'Transcript'],
		['lookup', 'ip_rights', 'IP rights'],
		[]
	].map(function(rf) {
...
function biblio_token_validateData() {
	...
	// check all required fields have values
	if(!AppGini.Validation.fieldRequired('lookup', 'author_id', 'Author ID')) return false;
	if(!AppGini.Validation.fieldRequired('lookup', 'bibliography', 'Bibliography')) return false;
	if(!AppGini.Validation.fieldRequired('lookup', 'transcript', 'Transcript')) return false;
