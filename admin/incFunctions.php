	...
	*/
	...
	function get_tables_info($skip_authentication = false) {
		...
		$tg = array(
			...
			'III. Producci&#243;n colaborativa narrativa (Historiograf&#237;a)',
			'IV. Encuentros',
			'C&#243;digos de Dramatica',
			'C&#243;digos bibliogr&#225;ficos',
			'C&#243;digos discursivos',
			'Apps'
		);
		...
		$all_tables = array(
			/* ['table_name' => [table props assoc array] */   
				'game_agent' => array(
					'Caption' => 'Agentes',
					'Description' => 'Jugadores activos (vivos) as&#237; como pasivos (difuntos) mediante sus textos y artefactos.',
					'tableIcon' => 'resources/table_icons/status_offline.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'biblio_author' => array(
					'Caption' => 'Autores',
					'Description' => 'Los agentes que tienen corpus de texto se convierten en autores.',
				...
				'biblio_doc' => array(
					'Caption' => 'Corpus',
					'Description' => 'En el nivel III, recopile escritos autobiogr&#225;ficos como parte del corpus de texto.',
				...
				'biblio_transcript' => array(
					...
					'Description' => 'Parte de la preparaci&#243;n necesaria para transcribir todos los manuscritos manuscritos y hacer que todo el texto est&#233; disponible para OCR.',
				...
				'biblio_token' => array(
					'Caption' => 'Tokens',
					'Description' => 'Despu&#233;s de la transcripci&#243;n, los datos est&#225;n listos para ser tokenizados. Utilice Voyant Tools para este prop&#243;sito.<br>voyant-tools.org/',
				...
				'biblio_code_demo' => array(
					...
					'Description' => 'Datos arqueol&#243;gicos y archiveros; como g&#233;nero, duraci&#243;n de vida, etnicidad, clase social, profesi&#243;n, partido pol&#237;tico, etc.<br>Otros crit&#233;rios se podr&#237;an a&#241;adir seg&#250;n necesidad del juego.<br>Un poco de inspiraci&#243;n aqu&#237;: https://applieddemogtoolbox.github.io/',
					'tableIcon' => 'resources/table_icons/application_view_detail.png',
					'group' => $tg[1],
					'homepageShowCount' => 1
				),
				'biblio_team' => array(
					'Caption' => 'Equipos bibliogr&#225;ficos',
					'Description' => 'Aqu&#237; se forman los grupos de archiveros, bibliogr&#225;fos y afines que colaboran en un solo proyecto.',
					'tableIcon' => 'resources/table_icons/folder_user.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'biblio_analyst' => array(
					'Caption' => 'Bibli&#243;grafos',
					'Description' => 'Los agentes que buscan, analizan y transforman textos se convierten en archiverso, bibli&#243;grafos y analistas de texto.<br>En conjunto los llamamos aqu&#237; bibli&#243;grafos.',
					'tableIcon' => 'resources/table_icons/user_policeman.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'bio_team' => array(
					'Caption' => 'Equipos biogr&#225;ficos',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/reseller_account.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'bio_author' => array(
					'Caption' => 'Bi&#243;grafos',
					'Description' => 'Los agentes que escriben sobre agentes se convierten en biograf&#237;as. <br>Si escriben sobre s&#237; mismos, se convierten en autobiograf&#237;as.',
					'tableIcon' => 'resources/table_icons/user_edit.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'bio_story' => array(
					'Caption' => 'Biograf&#237;as',
					'Description' => 'Esta es la biograf&#237;a de un agente, ya sea como escrito autobiogr&#225;fico o por una tercera persona.',
					'tableIcon' => 'resources/table_icons/butterfly.png',
					'group' => $tg[2],
					'homepageShowCount' => 1
				),
				'bio_chr' => array(
					'Caption' => 'Personajes de la biograf&#237;a',
					'Description' => 'Encode a characters role within a biographical context.',
					'tableIcon' => 'resources/table_icons/user_female.png',
					'group' => $tg[2],
					'homepageShowCount' => 1
				),
				'bio_chr_dev' => array(
					'Caption' => 'Desarrollo de personajes de biograf&#237;as',
					'Description' => 'Convierte algunos de los autores en personajes para la historia que est&#225;s contando.<br>Utilice herramientas de creaci&#243;n de personajes como Dramatica Pro Character Builder para asignar elementos de la manera correcta.',
					'tableIcon' => 'resources/table_icons/brain_trainer.png',
					'group' => $tg[2],
					'homepageShowCount' => 1
				),
				'bio_chr_scene' => array(
					'Caption' => 'Escenas personales de la biograf&#237;a',
					'Description' => 'Toma parte del texto aut&#233;ntico y convi&#233;rtelo en escenas de personajes codificando escenas relevantes para el personaje.<br>Para las biograf&#237;as, las escenas de los personajes y las historias son id&#233;nticas, desde el punto de vista de la narraci&#243;n.<br>Las historias codifican el orden en que aparecen estas escenas, y las escenas de los personajes codifican c&#243;digos invivo, demogr&#225;ficos y hermen&#233;uticos para el personaje.',
					'tableIcon' => 'resources/table_icons/camera.png',
					'group' => $tg[2],
					'homepageShowCount' => 1
				),
				'bio_storyline' => array(
					'Caption' => 'Trama biogr&#225;fica',
					'Description' => 'Las l&#237;neas de trama de la biogr&#225;fia (Storylines).',
					'tableIcon' => 'resources/table_icons/chart_curve_edit.png',
					'group' => $tg[2],
					'homepageShowCount' => 1
				),
				'bio_storystatic' => array(
					'Caption' => 'Puntos est&#225;ticos de biograf&#237;a',
					'Description' => 'Codifique los puntos de la historia est&#225;tica.<br>Tambi&#233;n se conocen como puntos de trama est&#225;ticos y siguen siendo los mismos a lo largo de toda la historia.',
					'tableIcon' => 'resources/table_icons/application_view_tile.png',
					'group' => $tg[2],
					'homepageShowCount' => 1
				),
				'bio_storydynamic' => array(
					'Caption' => 'Puntos din&#225;micos de biograf&#237;a',
					'Description' => 'Codifique la base din&#225;mica de la historia en Dramatica.<br>Son las fuerzas din&#225;micas que actuar&#225;n sobre los potenciales dram&#225;ticos para cambiar la relaci&#243;n entre los personajes, cambiar el curso de la trama y desarrollar el tema a medida que se desarrolla la historia.',
					'tableIcon' => 'resources/table_icons/areachart.png',
					'group' => $tg[2],
					'homepageShowCount' => 1
				),
				'bio_storyweaving_scene' => array(
					'Caption' => 'Escenas de Storyweaving',
					'Description' => 'Crea escenas para seguir tejiendo historias.',
					'tableIcon' => 'resources/table_icons/layers_map.png',
					'group' => $tg[2],
					'homepageShowCount' => 1
				),
				'bio_encounter' => array(
					'Caption' => 'Encuentros de vida',
					'Description' => 'Combina escenas de encuentros de diferentes personajes en un encuentro cara a cara.',
					'tableIcon' => 'resources/table_icons/arrow_refresh.png',
					'group' => $tg[4],
					'homepageShowCount' => 1
				),
				'bio_encounter_scene' => array(
					'Caption' => 'Escenas de encuentro biogr&#225;fico',
					'Description' => 'Seleccione escenas especiales en las que los personajes se encuentren con otros.',
					'tableIcon' => 'resources/table_icons/comments.png',
					'group' => $tg[4],
					'homepageShowCount' => 1
				),
				'bio_code_herme' => array(
					'Caption' => 'Hermen&#233;utica',
					'Description' => 'Con base en el uso del lenguaje y el contexto, codifique la gesti&#243;n de impresiones y la interpretaci&#243;n no&#233;tica.<br><br>TapoRWare para an&#225;lisis de texto: http://tapor.ca/home/',
					'tableIcon' => 'resources/table_icons/book_next.png',
					'group' => $tg[2],
					'homepageShowCount' => 1
				),
				'hist_team' => array(
					'Caption' => 'Equipos de histori&#243;grafos',
					'Description' => '',
				...
				'hist_author' => array(
					'Caption' => 'Histori&#243;grafos',
					'Description' => 'Los agentes que combinan los escritos de la vida individual en una historia sobre una comunidad concreta se convierten en histori&#243;grafos.',
					'tableIcon' => 'resources/table_icons/user_edit.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'hist_story' => array(
					'Caption' => 'Historias',
					'Description' => 'Esta es la historia final de su comunidad o naci&#243;n, que puede analizarse y compararse.<br>El objetivo es crear una Historia de Gran Argumento (GAS; Grand Argument Story) seg&#250;n la teor&#237;a de Dramatica.',
					'tableIcon' => 'resources/table_icons/butterfly.png',
					'group' => $tg[3],
					'homepageShowCount' => 1
				),
				'hist_chr' => array(
					'Caption' => 'Personajes de la historia',
					'Description' => 'Codifique el rol de un personaje dentro del contexto de la historia de la naci&#243;n.',
					'tableIcon' => 'resources/table_icons/user_orange.png',
					'group' => $tg[3],
					'homepageShowCount' => 1
				),
				'hist_chr_dev' => array(
					'Caption' => 'Desarrollo de personaje de hist&#243;ria',
					'Description' => 'Convierta algunos de los personajes biogr&#225;ficos en personajes de la historia.<br>En este nivel ya se dan los aspectos psicol&#243;gicos. Aqu&#237; codificamos solo los aspectos dram&#225;ticos.<br>Utilice herramientas de creaci&#243;n de personajes como Dramatica Pro Character Builder para asignar elementos de la manera correcta.',
					'tableIcon' => 'resources/table_icons/private.png',
					'group' => $tg[3],
					'homepageShowCount' => 1
				),
				'hist_chr_scene' => array(
					'Caption' => 'Escenas de personajes de la Historia',
					'Description' => 'Elige parte de las historias biogr&#225;ficas y convi&#233;rtelas en escenas de personajes.',
					'tableIcon' => 'resources/table_icons/camera.png',
					'group' => $tg[3],
					'homepageShowCount' => 1
				),
				'hist_storyline' => array(
					'Caption' => 'L&#237;neas de la trama (Storyline)',
					'Description' => 'Teje la trama a lo largo de una historia.',
					'tableIcon' => 'resources/table_icons/chart_curve_edit.png',
					'group' => $tg[3],
					'homepageShowCount' => 1
				),
				'hist_storystatic' => array(
					'Caption' => 'Puntos est&#225;ticos de la historia',
					'Description' => 'Codifique los puntos de la historia est&#225;tica.<br>Tambi&#233;n se conocen como puntos de trama est&#225;ticos y siguen siendo los mismos a lo largo de toda la historia.',
					'tableIcon' => 'resources/table_icons/application_view_tile.png',
					'group' => $tg[3],
					'homepageShowCount' => 1
				...
				'hist_storyweaving_scene' => array(
					'Caption' => 'Escenas de Storyweaving',
					'Description' => 'Teje las escenas dentro de tu historia.<br>Esto es m&#225;s que un recurso literario. Es la herramienta en la que estableces la argumentaci&#243;n completa del Gran Argumento dentro de tu historia.',
					'tableIcon' => 'resources/table_icons/layers_map.png',
					'group' => $tg[3],
					'homepageShowCount' => 1
				),
				'hist_encounter' => array(
					'Caption' => 'Encuentros hist&#243;ricos',
					'Description' => 'Combina escenas de encuentros de diferentes personajes en un encuentro cara a cara.',
					'tableIcon' => 'resources/table_icons/arrow_refresh.png',
					'group' => $tg[4],
					'homepageShowCount' => 1
				...
				'hist_encounter_scene' => array(
					'Caption' => 'Escenas de encuentros hist&#243;ricos',
					'Description' => 'Escribe escenas de encuentro.',
					'tableIcon' => 'resources/table_icons/comments.png',
					'group' => $tg[4],
					'homepageShowCount' => 1
				),
				'encounter_team' => array(
					'Caption' => 'Equipos de soluci&#243;n de conflictos',
					'Description' => 'Equipo de soluci&#243;n de conflictos',
					'tableIcon' => 'resources/table_icons/group_gear.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				),
				'ecounter_analyst' => array(
					'Caption' => 'Analistas de conflictos',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/user_female.png',
					'group' => $tg[0],
					'homepageShowCount' => 0
				...
				'hist_community' => array(
					'Caption' => 'Comunidades',
					'Description' => 's&#237;, comunidades cuya narrativa compartida vinculaba su existencia material con una experiencia trascendente.',
				...
				'class_agent_selection' => array(
					...
					'tableIcon' => 'resources/table_icons/page_magnifier.png',
					'group' => $tg[6],
					'homepageShowCount' => 0
				),
				...
				'class_story_path' => array(
					...
					'Description' => 'This is used for the structural encoding of Signposts within the Dramatica framework.',
					'tableIcon' => 'resources/table_icons/edit_path.png',
					'group' => $tg[5],
					'homepageShowCount' => 0
				),
				...
				'class_dynamicstorypoints1' => array(
					'Caption' => 'Dynamic storypoints 1',
					'Description' => 'Dramatica encoding of dynamic storypoints.',
					'tableIcon' => 'resources/table_icons/application_tile_horizontal.png',
					'group' => $tg[5],
					'homepageShowCount' => 0
				),
				'class_dynamicstorypoints2' => array(
					'Caption' => 'Dynamic storypoints 2',
					'Description' => 'Dramatica encoding of dynamic storypoints.',
					'tableIcon' => 'resources/table_icons/application_tile_horizontal.png',
					'group' => $tg[5],
					'homepageShowCount' => 0
				...
				'class_pc' => array(
					...
					'tableIcon' => 'resources/table_icons/resize_picture.png',
					'group' => $tg[7],
					'homepageShowCount' => 0
				),
				'class_nt' => array(
				...
				'class_dilemma' => array(
					'Caption' => 'Defense ethical categories',
					'Description' => 'Ethical categories used in defense.',
					'tableIcon' => 'resources/table_icons/universal_binary.png',
					'group' => $tg[7],
					'homepageShowCount' => 0
				),
				'class_cuadrilemma' => array(
					'Caption' => 'Class cuadrilemma',
					'Description' => 'Cuadrilamma according Albert Schweizer',
					'tableIcon' => 'table.gif',
					'group' => $tg[7],
					'homepageShowCount' => 0
				),
				'class_sdg' => array(
					...
					'tableIcon' => 'resources/table_icons/Plant.png',
					'group' => $tg[7],
					'homepageShowCount' => 0
				),
				'class_sdg_intgr' => array(
					'Caption' => 'SDG integration',
					'Description' => '',
					'tableIcon' => 'resources/table_icons/recycle.png',
					'group' => $tg[7],
					'homepageShowCount' => 0
				),
				'class_goals' => array(
				...
				'class_counterfactual' => array(
					...
					'Description' => 'Counterfactual categories',
					'tableIcon' => 'resources/table_icons/arrow_refresh.png',
					'group' => $tg[7],
					'homepageShowCount' => 0
				),
				...
				'projects' => array(
					...
					'Description' => 'Define your projects here',
					'tableIcon' => 'table.gif',
					'group' => $tg[8],
					'homepageShowCount' => 0
				),
				'gallery_authors' => array(
					'Caption' => 'Gallery authors',
					'Description' => '',
					'tableIcon' => 'table.gif',
					'group' => $tg[8],
					'homepageShowCount' => 0
	...
	if(!function_exists('getTableList')) {
		function getTableList($skip_authentication = false) {
			$arrTables = array(
				'game_agent' => 'Agentes',
				'biblio_author' => 'Autores',
				'biblio_doc' => 'Corpus',
				'biblio_transcript' => 'Transcripci&#243;n',
				'biblio_token' => 'Tokens',
				'biblio_code_invivo' => 'Invivo',
				'biblio_code_demo' => 'Datos demogr&#225;ficos',
				'biblio_team' => 'Equipos bibliogr&#225;ficos',
				'biblio_analyst' => 'Bibli&#243;grafos',
				'bio_team' => 'Equipos biogr&#225;ficos',
				'bio_author' => 'Bi&#243;grafos',
				'bio_story' => 'Biograf&#237;as',
				'bio_chr' => 'Personajes de la biograf&#237;a',
				'bio_chr_dev' => 'Desarrollo de personajes de biograf&#237;as',
				'bio_chr_scene' => 'Escenas personales de la biograf&#237;a',
				'bio_storyline' => 'Trama biogr&#225;fica',
				'bio_storystatic' => 'Puntos est&#225;ticos de biograf&#237;a',
				'bio_storydynamic' => 'Puntos din&#225;micos de biograf&#237;a',
				'bio_storyweaving_scene' => 'Escenas de Storyweaving',
				'bio_encounter' => 'Encuentros de vida',
				'bio_encounter_scene' => 'Escenas de encuentro biogr&#225;fico',
				'bio_code_herme' => 'Hermen&#233;utica',
				'hist_team' => 'Equipos de histori&#243;grafos',
				'hist_author' => 'Histori&#243;grafos',
				'hist_story' => 'Historias',
				'hist_chr' => 'Personajes de la historia',
				'hist_chr_dev' => 'Desarrollo de personaje de hist&#243;ria',
				'hist_chr_scene' => 'Escenas de personajes de la Historia',
				'hist_storyline' => 'L&#237;neas de la trama (Storyline)',
				'hist_storystatic' => 'Puntos est&#225;ticos de la historia',
				'hist_storydynamic' => 'Puntos din&#225;micos de biograf&#237;a',
				'hist_storyweaving_scene' => 'Escenas de Storyweaving',
				'hist_encounter' => 'Encuentros hist&#243;ricos',
				'hist_encounter_scene' => 'Escenas de encuentros hist&#243;ricos',
				'encounter_team' => 'Equipos de soluci&#243;n de conflictos',
				'ecounter_analyst' => 'Analistas de conflictos',
				'hist_community' => 'Comunidades',
				...
				'class_gender' => 'Gender',
				'class_agent_race' => 'Class agent race',
				'class_agent_religion' => 'Class agent religion',
				'class_agent_job' => 'Class agent job',
				'class_agent_party' => 'Class agent party',
				'class_agent_status' => 'Class agent status',
				'class_authority_agent' => 'Agent authority code',
				'class_evaluation' => 'Evaluation phase',
				'class_bibliography_type' => 'Text type',
				'class_bibliography_media' => 'Class media',
				...
				'class_dynamicstorypoints1' => 'Dynamic storypoints 1',
				'class_dynamicstorypoints2' => 'Dynamic storypoints 2',
				'class_dynamicstorypoints3' => 'Dynamic storypoints 3',
				'class_dynamicstorypoints4' => 'Dynamic storypoints 4',
				'class_im' => 'Impressions',
				'class_pc' => 'Performative contradiction',
				'class_nt' => 'Noetic tension',
				'class_dilemma' => 'Defense ethical categories',
				'class_cuadrilemma' => 'Class cuadrilemma',
				'class_sdg' => 'SDG',
				'class_sdg_intgr' => 'SDG integration',
				'class_goals' => 'Class goals',
				'class_counterfactual' => 'Counterfactual',
				'dictionary' => 'Dictionary',
				'class_dictionary1' => 'Dictionary category 1',
				'class_dictionary2' => 'Dictionary category 2',
				'class_dictionary3' => 'Dictionary category 3',
				'class_dictionary4' => 'Dictionary category 4',
				'class_dictionary5' => 'Dictionary category 5',
				'assignments' => 'Chrono events',
				'resources' => 'Agents',
				'projects' => 'Chronologies',
				'gallery_authors' => 'Gallery authors',
			);
	...
	function getThumbnailSpecs($tableName, $fieldName, $view) {
		...
		elseif($tableName=='bio_chr' && $fieldName=='img' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='class_sdg' && $fieldName=='icon' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='class_sdg' && $fieldName=='icon' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='gallery_authors' && $fieldName=='img' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='gallery_authors' && $fieldName=='img' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		return FALSE;
	}
	########################################################################
...
########################################################################
		...
		if($schema === null) {
			...
			$schema = [
				'game_agent' => [
					...
					'groupID' => ['appgini' => "VARCHAR(250) NULL"],
					...
					'titles' => ['appgini' => "VARCHAR(40) NULL"],
					'titles_academic' => ['appgini' => "VARCHAR(40) NULL"],
					'titles_nobility' => ['appgini' => "TEXT NULL"],
				...
				'biblio_author' => [
					...
					'viaf_no' => ['appgini' => "VARCHAR(250) NULL"],
					'authority_organization' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'authority_code' => ['appgini' => "VARCHAR(250) NULL"],
					'viaf_link' => ['appgini' => "VARCHAR(250) NULL DEFAULT 'https://viaf.org/viaf/'"],
					'authority_link' => ['appgini' => "VARCHAR(40) NULL"],
					'data_evaluation' => ['appgini' => "INT UNSIGNED NULL"],
				],
				'biblio_doc' => [
					'id' => ['appgini' => "INT(10) UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					...
					'authority_organization' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'authority_code' => ['appgini' => "INT(10) UNSIGNED NULL"],
				...
				'biblio_code_invivo' => [
					...
					'invivo' => ['appgini' => "TEXT NULL"],
					'start_date' => ['appgini' => "DATETIME NULL"],
					'end_date' => ['appgini' => "DATETIME NULL"],
					'person' => ['appgini' => "TEXT NULL"],
					'place' => ['appgini' => "TEXT NULL"],
					'tags' => ['appgini' => "TEXT NULL"],
					'comments' => ['appgini' => "LONGTEXT NULL"],
					'team' => ['appgini' => "INT UNSIGNED NULL"],
					'biblio_lead' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'data_evaluation' => ['appgini' => "INT UNSIGNED NULL"],
				],
				'biblio_code_demo' => [
					...
					'game_agent' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'author' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'bibliography' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'transcript' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'token_id' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'token' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'sex' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'race' => ['appgini' => "INT UNSIGNED NULL"],
					'age' => ['appgini' => "VARCHAR(40) NULL"],
					'religion' => ['appgini' => "INT UNSIGNED NULL"],
					'party' => ['appgini' => "INT UNSIGNED NULL"],
					'job' => ['appgini' => "INT UNSIGNED NULL"],
					'status' => ['appgini' => "INT UNSIGNED NULL"],
				],
				'biblio_team' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'team' => ['appgini' => "VARCHAR(250) NULL"],
					'description' => ['appgini' => "TEXT NULL"],
				],
				'biblio_analyst' => [
					'id' => ['appgini' => "INT(10) UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
				...
				'bio_chr_dev' => [
					...
					'cw_gender' => ['appgini' => "INT UNSIGNED NULL"],
					...
					'locations' => ['appgini' => "TEXT NULL"],
					'persons' => ['appgini' => "TEXT NULL"],
				...
				'bio_chr_scene' => [
					...
					'counterfactual' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'goal' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'dilemma_ethics' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'sdg' => ['appgini' => "INT(10) UNSIGNED NULL"],
				...
				'bio_storyline' => [
					...
					'startdate' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'enddate' => ['appgini' => "INT(10) UNSIGNED NULL"],
				],
				'bio_storystatic' => [
					'id' => ['appgini' => "INT(10) UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
				...
				'bio_encounter' => [
					...
					'bio_impressionA' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'bio_ntA' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'bio_counterfactualA' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'bio_dilemmaA' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'bio_sdgA' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'startdateA' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'enddateA' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'sceneA' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'authorB' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'author_nameB' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'bibliographyB' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'transcriptB' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'tokenB' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'bio_impressionB' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'bio_ntB' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'bio_counterfactualB' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'bio_dilemmaB' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'bio_sdgB' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'startdateB' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'enddateB' => ['appgini' => "INT(10) UNSIGNED NULL"],
					...
					'story_scene' => ['appgini' => "LONGTEXT NULL"],
					...
					'encounter_team' => ['appgini' => "INT UNSIGNED NULL"],
					'encounter_analyst' => ['appgini' => "INT UNSIGNED NULL"],
				],
				'bio_encounter_scene' => [
					'id' => ['appgini' => "INT(10) UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'encounter_team' => ['appgini' => "INT UNSIGNED NULL"],
					'encounter_analyst' => ['appgini' => "INT UNSIGNED NULL"],
					'scene' => ['appgini' => "INT(10) UNSIGNED NULL"],
				],
				'bio_code_herme' => [
					'id' => ['appgini' => "INT(10) UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'biography' => ['appgini' => "INT(10) UNSIGNED NULL"],
					...
					'counterfactual' => ['appgini' => "INT UNSIGNED NULL"],
					'bio_sdg' => ['appgini' => "INT UNSIGNED NULL"],
					'bio_dilemma' => ['appgini' => "INT UNSIGNED NULL"],
					'bio_goals' => ['appgini' => "INT UNSIGNED NULL"],
				...
				'hist_story' => [
					'id' => ['appgini' => "INT(10) UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'team' => ['appgini' => "INT UNSIGNED NULL"],
					'hist_author_id' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'hist_author_name' => ['appgini' => "INT(10) UNSIGNED NULL"],
				...
				'hist_chr' => [
					...
					'team' => ['appgini' => "INT UNSIGNED NULL"],
					'hist_author_id' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'hist_author_memberid' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'hist_author_name' => ['appgini' => "INT(10) UNSIGNED NULL"],
				...
				'hist_chr_scene' => [
					...
					'pc' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'counterfactual' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'dilemma' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'comment' => ['appgini' => "TEXT NULL"],
					'illustration' => ['appgini' => "TEXT NULL"],
					'scene' => ['appgini' => "LONGTEXT NULL"],
				],
				...
				'hist_encounter' => [
					'id' => ['appgini' => "INT(10) UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'hist_story' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'agentA' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'agent_nameA' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'bio_storyA' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'hist_chrA' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'bio_chr_sceneA' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'bio_impressionA' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'bio_ntA' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'bio_counterfactualA' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'bio_dilemmaA' => ['appgini' => "INT(10) UNSIGNED NULL"],
					...
					'enddateA' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'sceneA' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'agentB' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'agent_nameB' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'bio_storyB' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'hist_chrB' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'bio_chr_sceneB' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'bio_impressionB' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'bio_ntB' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'bio_counterfactualB' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'bio_dilemmaB' => ['appgini' => "INT(10) UNSIGNED NULL"],
					...
					'type' => ['appgini' => "VARCHAR(40) NULL"],
					'conflicttype' => ['appgini' => "VARCHAR(40) NULL"],
					'sdg_intgr' => ['appgini' => "INT UNSIGNED NULL"],
				...
				'class_agent_religion' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'religion' => ['appgini' => "VARCHAR(40) NULL"],
					'description' => ['appgini' => "TEXT NULL"],
				],
				'class_agent_job' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'job' => ['appgini' => "VARCHAR(40) NULL"],
					'description' => ['appgini' => "TEXT NULL"],
				],
				'class_agent_party' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'party' => ['appgini' => "VARCHAR(40) NULL"],
					'description' => ['appgini' => "TEXT NULL"],
				],
				'class_agent_status' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'status' => ['appgini' => "VARCHAR(40) NULL"],
					'description' => ['appgini' => "TEXT NULL"],
				],
				...
				'class_dilemma' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'defense' => ['appgini' => "VARCHAR(250) NULL"],
					'description' => ['appgini' => "LONGTEXT NULL"],
				],
				'class_cuadrilemma' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'dilemma' => ['appgini' => "VARCHAR(40) NULL"],
					'orientation1' => ['appgini' => "VARCHAR(40) NULL"],
					'orientation2' => ['appgini' => "VARCHAR(40) NULL"],
				],
				'class_sdg' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'no' => ['appgini' => "VARCHAR(40) NULL"],
					'sdg_topic' => ['appgini' => "VARCHAR(250) NULL"],
					'description' => ['appgini' => "LONGTEXT NULL"],
					'rank' => ['appgini' => "VARCHAR(40) NULL"],
					'av_rank' => ['appgini' => "VARCHAR(40) NULL"],
					'mentions' => ['appgini' => "VARCHAR(40) NULL"],
					'icon' => ['appgini' => "VARCHAR(40) NULL"],
				],
				'class_sdg_intgr' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'integration' => ['appgini' => "VARCHAR(40) NULL"],
					'sdgA' => ['appgini' => "INT UNSIGNED NULL"],
					'sdgB' => ['appgini' => "INT UNSIGNED NULL"],
					'description' => ['appgini' => "TEXT NULL"],
				],
				'class_goals' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'goal' => ['appgini' => "VARCHAR(40) NULL"],
					'class' => ['appgini' => "VARCHAR(40) NULL"],
					'description' => ['appgini' => "TEXT NULL"],
					'hierarchy' => ['appgini' => "VARCHAR(40) NULL"],
				],
				'class_counterfactual' => [
					'id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'counterfactual' => ['appgini' => "VARCHAR(250) NULL"],
					'description' => ['appgini' => "LONGTEXT NULL"],
					'example' => ['appgini' => "LONGTEXT NULL"],
				],
				'dictionary' => [
					'id' => ['appgini' => "INT(10) UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'term' => ['appgini' => "VARCHAR(40) NULL"],
				...
				'assignments' => [
					'Id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'ProjectId' => ['appgini' => "INT UNSIGNED NULL"],
					'ProjectDuration' => ['appgini' => "INT UNSIGNED NULL"],
					'RessourceId' => ['appgini' => "INT UNSIGNED NULL"],
					'Commitment' => ['appgini' => "FLOAT(3,2) NOT NULL DEFAULT '1.00'"],
					'author_id' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'author_name' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'biblio_doc' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'biblio_trascript' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'biblio_token' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'invivio_code' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'StartDate' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'EndDate' => ['appgini' => "INT(10) UNSIGNED NULL"],
				],
				'resources' => [
					'Id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'agent_id' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'Name' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'Available' => ['appgini' => "VARCHAR(40) NULL DEFAULT '1'"],
				],
				'projects' => [
					'Id' => ['appgini' => "INT UNSIGNED NOT NULL PRIMARY KEY AUTO_INCREMENT"],
					'community' => ['appgini' => "INT(10) UNSIGNED NULL"],
					'Name' => ['appgini' => "VARCHAR(250) NULL"],
				...
				'gallery_authors' => [
					...
					'img' => ['appgini' => "VARCHAR(40) NULL"],
					'select' => ['appgini' => "VARCHAR(40) NULL"],
				],
			];
		}
	...
	*/
	...
	function get_parent_tables($table) {
		...
		$parents = [
			...
			'biblio_doc' => [
				...
				'class_bibliography_genre' => ['genre'],
				'class_bibliography_media' => ['medium'],
			...
			'biblio_code_demo' => [
				...
				'class_agent_race' => ['race'],
				'class_agent_religion' => ['religion'],
				'class_agent_party' => ['party'],
				'class_agent_job' => ['job'],
				'class_agent_status' => ['status'],
			],
			'biblio_analyst' => [
				'biblio_team' => ['team'],
				'game_agent' => ['author_memberid', 'author_id'],
			],
			'bio_author' => [
				'bio_team' => ['team'],
				'game_agent' => ['author_id'],
			...
			'bio_chr_dev' => [
				...
				'bio_story' => ['bio_story'],
				'bio_chr' => ['cw_name'],
				'class_dynamicstorypoints1' => ['dp1_resolve'],
				'class_dynamicstorypoints2' => ['dp2_resolve'],
				'class_dynamicstorypoints3' => ['dp3_psstyle', 'dp3_approach', 'dp3_growth', 'dp3_resolve'],
			...
			'bio_storydynamic' => [
				...
				'class_dynamicstorypoints1' => ['dp_cat1'],
				'class_dynamicstorypoints2' => ['dp_cat2'],
				'class_dynamicstorypoints3' => ['dp_cat3_judgement', 'dp_cat3_outcome', 'dp_cat3_limit', 'dp_cat3_driver'],
			...
			'bio_encounter' => [
				'game_agent' => ['authorB', 'authorA'],
				'biblio_doc' => ['bibliographyB', 'bibliographyA'],
				'biblio_transcript' => ['transcriptB', 'transcriptA'],
				'biblio_token' => ['tokenB', 'tokenA'],
				'bio_chr_scene' => ['sceneB', 'enddateB', 'startdateB', 'bio_sdgB', 'bio_dilemmaB', 'bio_counterfactualB', 'bio_ntB', 'bio_impressionB', 'sceneA', 'enddateA', 'startdateA', 'bio_sdgA', 'bio_dilemmaA', 'bio_counterfactualA', 'bio_ntA', 'bio_impressionA'],
				'encounter_team' => ['encounter_team'],
				'ecounter_analyst' => ['encounter_analyst'],
			],
			'bio_encounter_scene' => [
				'encounter_team' => ['encounter_team'],
				'ecounter_analyst' => ['encounter_analyst'],
			...
			'bio_code_herme' => [
				...
				'class_counterfactual' => ['counterfactual'],
				'class_sdg' => ['bio_sdg'],
				'class_dilemma' => ['bio_dilemma'],
				'class_goals' => ['bio_goals'],
			],
			'hist_author' => [
				'hist_team' => ['team'],
				'game_agent' => ['agent_id'],
			...
			'hist_chr_scene' => [
				...
				'class_character_element' => ['chr_element'],
				'bio_chr_scene' => ['dilemma', 'counterfactual', 'pc', 'noetictension', 'impression', 'herme_code', 'place', 'person', 'enddate', 'startdate', 'invivo_code', 'bio_chr_scene'],
			],
			'hist_storyline' => [
				'hist_story' => ['story'],
				'class_story_acts' => ['story_act'],
			...
			'hist_encounter' => [
				'hist_story' => ['hist_story'],
				'game_agent' => ['agentB', 'agentA'],
				'bio_story' => ['bio_storyB', 'bio_storyA'],
				'hist_chr' => ['hist_chrB', 'hist_chrA'],
				'bio_chr_scene' => ['enddateB', 'startdateB', 'bio_sdgB', 'bio_dilemmaB', 'bio_counterfactualB', 'bio_ntB', 'bio_impressionB', 'bio_chr_sceneB', 'sceneA', 'enddateA', 'startdateA', 'bio_sdgA', 'bio_dilemmaA', 'bio_counterfactualA', 'bio_ntA', 'bio_impressionA', 'bio_chr_sceneA'],
				'class_sdg_intgr' => ['sdg_intgr'],
				'encounter_team' => ['encounter_team'],
				'ecounter_analyst' => ['encounter_analyst'],
			],
			'hist_encounter_scene' => [
				'hist_encounter' => ['scene'],
				'ecounter_analyst' => ['encounter_analyst'],
			],
			'ecounter_analyst' => [
				'encounter_team' => ['team'],
			...
			'class_dynamicstorypoints2' => [
				'class_dynamicstorypoints1' => ['cat1'],
			],
			'class_dynamicstorypoints3' => [
				'class_dynamicstorypoints1' => ['cat1'],
				'class_dynamicstorypoints2' => ['cat2'],
			],
			'class_dynamicstorypoints4' => [
				'class_dynamicstorypoints1' => ['cat1'],
				'class_dynamicstorypoints2' => ['cat2'],
				'class_dynamicstorypoints3' => ['cat3'],
			],
			'class_sdg_intgr' => [
				'class_sdg' => ['sdgB', 'sdgA'],
			],
			...
			'assignments' => [
				...
				'biblio_author' => ['author_id'],
				'biblio_doc' => ['biblio_doc'],
				'biblio_transcript' => ['biblio_trascript'],
				'biblio_token' => ['biblio_token'],
				'biblio_code_invivo' => ['StartDate', 'invivio_code'],
			],
			'resources' => [
				'biblio_author' => ['agent_id'],
			],
			'projects' => [
				'hist_community' => ['community'],
			],
		];
	...
	function calculated_fields() {
		...
		return array(
			'game_agent' => array(
				'life_span' => 'DATEDIFF(YYYY ,`game_agent`.`birthday`, `game_agent`.`deathday`)',
			),
			'biblio_author' => array(
				'authority_link' => 'SELECT CONCAT(`biblio_author`.`viaf_link`,`biblio_author`.`viaf_no`)',
			),
			'biblio_doc' => array(
			),
			'biblio_transcript' => array(
		...
		*/
		$lookupQuery = [
			...
			'biblio_author' => [
				...
				'other_name' => 'SELECT `game_agent`.`id`, `game_agent`.`other_name` FROM `game_agent` LEFT JOIN `class_agent_selection` as class_agent_selection1 ON `class_agent_selection1`.`id`=`game_agent`.`selection_class` LEFT JOIN `class_agent_type1` as class_agent_type11 ON `class_agent_type11`.`id`=`game_agent`.`agenttype1` LEFT JOIN `class_agent_type2` as class_agent_type21 ON `class_agent_type21`.`id`=`game_agent`.`agenttype2` LEFT JOIN `class_gender` as class_gender1 ON `class_gender1`.`id`=`game_agent`.`gender` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`game_agent`.`data_evaluation` ORDER BY 2',
			...
			'biblio_doc' => [
				'author_name' => 'SELECT `biblio_author`.`id`, IF(CHAR_LENGTH(`biblio_author`.`last_name`) || CHAR_LENGTH(`biblio_author`.`first_name`), CONCAT_WS(\'\', IF(    CHAR_LENGTH(`game_agent1`.`last_name`), CONCAT_WS(\'\',   `game_agent1`.`last_name`), \'\'), \', \', IF(    CHAR_LENGTH(`game_agent1`.`first_name`), CONCAT_WS(\'\',   `game_agent1`.`first_name`), \'\')), \'\') FROM `biblio_author` LEFT JOIN `biblio_team` as biblio_team1 ON `biblio_team1`.`id`=`biblio_author`.`team` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`biblio_author`.`author_id` LEFT JOIN `class_authority_agent` as class_authority_agent1 ON `class_authority_agent1`.`id`=`biblio_author`.`authority_organization` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`biblio_author`.`data_evaluation` ORDER BY 2',
				...
				'medium' => 'SELECT `class_bibliography_media`.`id`, `class_bibliography_media`.`definition` FROM `class_bibliography_media` ORDER BY 2',
				...
				'team' => 'SELECT `biblio_team`.`id`, `biblio_team`.`team` FROM `biblio_team` ORDER BY 2',
				'biblio_lead' => 'SELECT `biblio_analyst`.`id`, IF(CHAR_LENGTH(`biblio_analyst`.`last_name`) || CHAR_LENGTH(`biblio_analyst`.`first_name`), CONCAT_WS(\'\', IF(    CHAR_LENGTH(`game_agent1`.`last_name`), CONCAT_WS(\'\',   `game_agent1`.`last_name`), \'\'), \', \', IF(    CHAR_LENGTH(`game_agent1`.`first_name`), CONCAT_WS(\'\',   `game_agent1`.`first_name`), \'\')), \'\') FROM `biblio_analyst` LEFT JOIN `biblio_team` as biblio_team1 ON `biblio_team1`.`id`=`biblio_analyst`.`team` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`biblio_analyst`.`author_id` LEFT JOIN `game_agent` as game_agent2 ON `game_agent2`.`id`=`biblio_analyst`.`author_memberid` ORDER BY 2',
				'data_evaluation' => 'SELECT `class_evaluation`.`id`, `class_evaluation`.`evaluation_type` FROM `class_evaluation` ORDER BY 2',
			],
			'biblio_transcript' => [
				'author' => 'SELECT `biblio_author`.`id`, IF(CHAR_LENGTH(`biblio_author`.`last_name`) || CHAR_LENGTH(`biblio_author`.`first_name`), CONCAT_WS(\'\', IF(    CHAR_LENGTH(`game_agent1`.`last_name`), CONCAT_WS(\'\',   `game_agent1`.`last_name`), \'\'), \', \', IF(    CHAR_LENGTH(`game_agent1`.`first_name`), CONCAT_WS(\'\',   `game_agent1`.`first_name`), \'\')), \'\') FROM `biblio_author` LEFT JOIN `biblio_team` as biblio_team1 ON `biblio_team1`.`id`=`biblio_author`.`team` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`biblio_author`.`author_id` LEFT JOIN `class_authority_agent` as class_authority_agent1 ON `class_authority_agent1`.`id`=`biblio_author`.`authority_organization` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`biblio_author`.`data_evaluation` ORDER BY 2',
			...
			'biblio_code_demo' => [
				'game_agent' => 'SELECT `game_agent`.`id`, IF(CHAR_LENGTH(`game_agent`.`id`) || CHAR_LENGTH(`game_agent`.`memberID`), CONCAT_WS(\'\', `game_agent`.`id`, \'   \', `game_agent`.`memberID`), \'\') FROM `game_agent` LEFT JOIN `class_agent_selection` as class_agent_selection1 ON `class_agent_selection1`.`id`=`game_agent`.`selection_class` LEFT JOIN `class_agent_type1` as class_agent_type11 ON `class_agent_type11`.`id`=`game_agent`.`agenttype1` LEFT JOIN `class_agent_type2` as class_agent_type21 ON `class_agent_type21`.`id`=`game_agent`.`agenttype2` LEFT JOIN `class_gender` as class_gender1 ON `class_gender1`.`id`=`game_agent`.`gender` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`game_agent`.`data_evaluation` ORDER BY 2',
				'author' => 'SELECT `biblio_author`.`id`, IF(CHAR_LENGTH(`biblio_author`.`id`) || CHAR_LENGTH(`biblio_author`.`author_memberid`), CONCAT_WS(\'\', `biblio_author`.`id`, \'   \', IF(    CHAR_LENGTH(`game_agent1`.`memberID`), CONCAT_WS(\'\',   `game_agent1`.`memberID`), \'\')), \'\') FROM `biblio_author` LEFT JOIN `biblio_team` as biblio_team1 ON `biblio_team1`.`id`=`biblio_author`.`team` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`biblio_author`.`author_id` LEFT JOIN `class_authority_agent` as class_authority_agent1 ON `class_authority_agent1`.`id`=`biblio_author`.`authority_organization` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`biblio_author`.`data_evaluation` ORDER BY 2',
				'bibliography' => 'SELECT `biblio_doc`.`id`, IF(CHAR_LENGTH(`biblio_doc`.`id`) || CHAR_LENGTH(`biblio_doc`.`title`), CONCAT_WS(\'\', `biblio_doc`.`id`, \' - \', `biblio_doc`.`title`), \'\') FROM `biblio_doc` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`biblio_doc`.`author_id` LEFT JOIN `class_bibliography_type` as class_bibliography_type1 ON `class_bibliography_type1`.`id`=`biblio_doc`.`type` LEFT JOIN `class_bibliography_genre` as class_bibliography_genre1 ON `class_bibliography_genre1`.`id`=`biblio_doc`.`genre` LEFT JOIN `class_bibliography_media` as class_bibliography_media1 ON `class_bibliography_media1`.`id`=`biblio_doc`.`medium` LEFT JOIN `class_language` as class_language1 ON `class_language1`.`id`=`biblio_doc`.`language` LEFT JOIN `class_rights` as class_rights1 ON `class_rights1`.`id`=`biblio_doc`.`rights` LEFT JOIN `class_authority_library` as class_authority_library1 ON `class_authority_library1`.`id`=`biblio_doc`.`authority_organization` LEFT JOIN `biblio_team` as biblio_team1 ON `biblio_team1`.`id`=`biblio_doc`.`team` LEFT JOIN `biblio_analyst` as biblio_analyst1 ON `biblio_analyst1`.`id`=`biblio_doc`.`biblio_lead` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`biblio_doc`.`data_evaluation` ORDER BY 2',
				'transcript' => 'SELECT `biblio_transcript`.`id`, IF(CHAR_LENGTH(`biblio_transcript`.`id`) || CHAR_LENGTH(`biblio_transcript`.`transcript_title`), CONCAT_WS(\'\', `biblio_transcript`.`id`, \' - \', `biblio_transcript`.`transcript_title`), \'\') FROM `biblio_transcript` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`biblio_transcript`.`author_memberID` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`biblio_transcript`.`bibliography_title` LEFT JOIN `class_rights` as class_rights1 ON `class_rights1`.`id`=`biblio_transcript`.`ip_rights` LEFT JOIN `biblio_team` as biblio_team1 ON `biblio_team1`.`id`=`biblio_transcript`.`team` LEFT JOIN `biblio_analyst` as biblio_analyst1 ON `biblio_analyst1`.`id`=`biblio_transcript`.`biblio_lead` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`biblio_transcript`.`data_evaluation` ORDER BY 2',
				'token_id' => 'SELECT `biblio_token`.`id`, IF(CHAR_LENGTH(`biblio_token`.`id`) || CHAR_LENGTH(`biblio_token`.`token_sequence`), CONCAT_WS(\'\', `biblio_token`.`id`, \' - \', `biblio_token`.`token_sequence`), \'\') FROM `biblio_token` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`biblio_token`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`biblio_token`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`biblio_token`.`transcript` LEFT JOIN `biblio_team` as biblio_team1 ON `biblio_team1`.`id`=`biblio_token`.`team` LEFT JOIN `biblio_analyst` as biblio_analyst1 ON `biblio_analyst1`.`id`=`biblio_token`.`biblio_lead` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`biblio_token`.`data_evaluation` ORDER BY 2',
				'token' => 'SELECT `biblio_token`.`id`, `biblio_token`.`token` FROM `biblio_token` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`biblio_token`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`biblio_token`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`biblio_token`.`transcript` LEFT JOIN `biblio_team` as biblio_team1 ON `biblio_team1`.`id`=`biblio_token`.`team` LEFT JOIN `biblio_analyst` as biblio_analyst1 ON `biblio_analyst1`.`id`=`biblio_token`.`biblio_lead` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`biblio_token`.`data_evaluation` ORDER BY 2',
				'sex' => 'SELECT `game_agent`.`id`, IF(    CHAR_LENGTH(`class_gender1`.`gender`), CONCAT_WS(\'\',   `class_gender1`.`gender`), \'\') FROM `game_agent` LEFT JOIN `class_agent_selection` as class_agent_selection1 ON `class_agent_selection1`.`id`=`game_agent`.`selection_class` LEFT JOIN `class_agent_type1` as class_agent_type11 ON `class_agent_type11`.`id`=`game_agent`.`agenttype1` LEFT JOIN `class_agent_type2` as class_agent_type21 ON `class_agent_type21`.`id`=`game_agent`.`agenttype2` LEFT JOIN `class_gender` as class_gender1 ON `class_gender1`.`id`=`game_agent`.`gender` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`game_agent`.`data_evaluation` ORDER BY 2',
				'race' => 'SELECT `class_agent_race`.`id`, `class_agent_race`.`race` FROM `class_agent_race` ORDER BY 2',
				'religion' => 'SELECT `class_agent_religion`.`id`, `class_agent_religion`.`religion` FROM `class_agent_religion` ORDER BY 2',
				'party' => 'SELECT `class_agent_party`.`id`, `class_agent_party`.`party` FROM `class_agent_party` ORDER BY 2',
				'job' => 'SELECT `class_agent_job`.`id`, `class_agent_job`.`job` FROM `class_agent_job` ORDER BY 2',
				'status' => 'SELECT `class_agent_status`.`id`, `class_agent_status`.`status` FROM `class_agent_status` ORDER BY 2',
			],
			'biblio_team' => [
			],
			'biblio_analyst' => [
			...
			'bio_story' => [
				...
				'author_id' => 'SELECT `bio_author`.`id`, IF(CHAR_LENGTH(`bio_author`.`id`), CONCAT_WS(\'\', `bio_author`.`id`, \'   \'), \'\') FROM `bio_author` LEFT JOIN `bio_team` as bio_team1 ON `bio_team1`.`id`=`bio_author`.`team` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`bio_author`.`author_id` ORDER BY 2',
				'author_name' => 'SELECT `bio_author`.`id`, IF(CHAR_LENGTH(`bio_author`.`last_name`) || CHAR_LENGTH(`bio_author`.`first_name`), CONCAT_WS(\'\', IF(    CHAR_LENGTH(`game_agent1`.`last_name`), CONCAT_WS(\'\',   `game_agent1`.`last_name`), \'\'), \', \', IF(    CHAR_LENGTH(`game_agent1`.`first_name`), CONCAT_WS(\'\',   `game_agent1`.`first_name`), \'\')), \'\') FROM `bio_author` LEFT JOIN `bio_team` as bio_team1 ON `bio_team1`.`id`=`bio_author`.`team` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`bio_author`.`author_id` ORDER BY 2',
				'type' => 'SELECT `class_bibliography_type`.`id`, `class_bibliography_type`.`type` FROM `class_bibliography_type` ORDER BY 2',
			...
			'bio_chr' => [
				'author_id' => 'SELECT `bio_author`.`id`, IF(CHAR_LENGTH(`bio_author`.`id`) || CHAR_LENGTH(`bio_author`.`author_memberid`), CONCAT_WS(\'\', `bio_author`.`id`, \'   \', IF(    CHAR_LENGTH(`game_agent1`.`memberID`), CONCAT_WS(\'\',   `game_agent1`.`memberID`), \'\')), \'\') FROM `bio_author` LEFT JOIN `bio_team` as bio_team1 ON `bio_team1`.`id`=`bio_author`.`team` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`bio_author`.`author_id` ORDER BY 2',
				'author_name' => 'SELECT `bio_author`.`id`, IF(CHAR_LENGTH(`bio_author`.`last_name`) || CHAR_LENGTH(`bio_author`.`first_name`), CONCAT_WS(\'\', IF(    CHAR_LENGTH(`game_agent1`.`last_name`), CONCAT_WS(\'\',   `game_agent1`.`last_name`), \'\'), \', \', IF(    CHAR_LENGTH(`game_agent1`.`first_name`), CONCAT_WS(\'\',   `game_agent1`.`first_name`), \'\')), \'\') FROM `bio_author` LEFT JOIN `bio_team` as bio_team1 ON `bio_team1`.`id`=`bio_author`.`team` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`bio_author`.`author_id` ORDER BY 2',
				'agent_id' => 'SELECT `game_agent`.`id`, IF(CHAR_LENGTH(`game_agent`.`id`) || CHAR_LENGTH(`game_agent`.`memberID`), CONCAT_WS(\'\', `game_agent`.`id`, \'   \', `game_agent`.`memberID`), \'\') FROM `game_agent` LEFT JOIN `class_agent_selection` as class_agent_selection1 ON `class_agent_selection1`.`id`=`game_agent`.`selection_class` LEFT JOIN `class_agent_type1` as class_agent_type11 ON `class_agent_type11`.`id`=`game_agent`.`agenttype1` LEFT JOIN `class_agent_type2` as class_agent_type21 ON `class_agent_type21`.`id`=`game_agent`.`agenttype2` LEFT JOIN `class_gender` as class_gender1 ON `class_gender1`.`id`=`game_agent`.`gender` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`game_agent`.`data_evaluation` ORDER BY 2',
				'agent_name' => 'SELECT `game_agent`.`id`, IF(CHAR_LENGTH(`game_agent`.`last_name`) || CHAR_LENGTH(`game_agent`.`first_name`), CONCAT_WS(\'\', `game_agent`.`last_name`, \', \', `game_agent`.`first_name`), \'\') FROM `game_agent` LEFT JOIN `class_agent_selection` as class_agent_selection1 ON `class_agent_selection1`.`id`=`game_agent`.`selection_class` LEFT JOIN `class_agent_type1` as class_agent_type11 ON `class_agent_type11`.`id`=`game_agent`.`agenttype1` LEFT JOIN `class_agent_type2` as class_agent_type21 ON `class_agent_type21`.`id`=`game_agent`.`agenttype2` LEFT JOIN `class_gender` as class_gender1 ON `class_gender1`.`id`=`game_agent`.`gender` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`game_agent`.`data_evaluation` ORDER BY 2',
			...
			'bio_chr_dev' => [
				...
				'dp1_resolve' => 'SELECT `class_dynamicstorypoints1`.`id`, `class_dynamicstorypoints1`.`term` FROM `class_dynamicstorypoints1` ORDER BY 2',
				'dp2_resolve' => 'SELECT `class_dynamicstorypoints2`.`id`, `class_dynamicstorypoints2`.`term` FROM `class_dynamicstorypoints2` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints2`.`cat1` ORDER BY 2',
				'dp3_resolve' => 'SELECT `class_dynamicstorypoints3`.`id`, `class_dynamicstorypoints3`.`term` FROM `class_dynamicstorypoints3` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints3`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints3`.`cat2` ORDER BY 2',
				'mc_resolve' => 'SELECT `class_dynamicstorypoints4`.`id`, `class_dynamicstorypoints4`.`term` FROM `class_dynamicstorypoints4` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints4`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints4`.`cat2` LEFT JOIN `class_dynamicstorypoints3` as class_dynamicstorypoints31 ON `class_dynamicstorypoints31`.`id`=`class_dynamicstorypoints4`.`cat3` ORDER BY 2',
				...
				'dp3_growth' => 'SELECT `class_dynamicstorypoints3`.`id`, `class_dynamicstorypoints3`.`term` FROM `class_dynamicstorypoints3` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints3`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints3`.`cat2` ORDER BY 2',
				...
				'dp3_approach' => 'SELECT `class_dynamicstorypoints3`.`id`, `class_dynamicstorypoints3`.`term` FROM `class_dynamicstorypoints3` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints3`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints3`.`cat2` ORDER BY 2',
				...
				'dp3_psstyle' => 'SELECT `class_dynamicstorypoints3`.`id`, `class_dynamicstorypoints3`.`term` FROM `class_dynamicstorypoints3` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints3`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints3`.`cat2` ORDER BY 2',
				...
				'cw_gender' => 'SELECT `class_gender`.`id`, `class_gender`.`gender` FROM `class_gender` ORDER BY 2',
			...
			'bio_chr_scene' => [
				...
				'pc' => 'SELECT `bio_code_herme`.`id`, IF(    CHAR_LENGTH(`class_pc1`.`perform_contrad`), CONCAT_WS(\'\',   `class_pc1`.`perform_contrad`), \'\') FROM `bio_code_herme` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_code_herme`.`biography` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`bio_code_herme`.`agent_id` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_code_herme`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_code_herme`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_code_herme`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_code_herme`.`token_sequence` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme`.`counterfactual` LEFT JOIN `class_sdg` as class_sdg1 ON `class_sdg1`.`id`=`bio_code_herme`.`bio_sdg` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme`.`bio_dilemma` LEFT JOIN `class_goals` as class_goals1 ON `class_goals1`.`id`=`bio_code_herme`.`bio_goals` ORDER BY 2',
				'counterfactual' => 'SELECT `bio_code_herme`.`id`, IF(    CHAR_LENGTH(`class_counterfactual1`.`counterfactual`), CONCAT_WS(\'\',   `class_counterfactual1`.`counterfactual`), \'\') FROM `bio_code_herme` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_code_herme`.`biography` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`bio_code_herme`.`agent_id` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_code_herme`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_code_herme`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_code_herme`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_code_herme`.`token_sequence` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme`.`counterfactual` LEFT JOIN `class_sdg` as class_sdg1 ON `class_sdg1`.`id`=`bio_code_herme`.`bio_sdg` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme`.`bio_dilemma` LEFT JOIN `class_goals` as class_goals1 ON `class_goals1`.`id`=`bio_code_herme`.`bio_goals` ORDER BY 2',
				'goal' => 'SELECT `bio_code_herme`.`id`, IF(    CHAR_LENGTH(`class_dilemma1`.`defense`), CONCAT_WS(\'\',   `class_dilemma1`.`defense`), \'\') FROM `bio_code_herme` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_code_herme`.`biography` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`bio_code_herme`.`agent_id` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_code_herme`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_code_herme`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_code_herme`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_code_herme`.`token_sequence` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme`.`counterfactual` LEFT JOIN `class_sdg` as class_sdg1 ON `class_sdg1`.`id`=`bio_code_herme`.`bio_sdg` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme`.`bio_dilemma` LEFT JOIN `class_goals` as class_goals1 ON `class_goals1`.`id`=`bio_code_herme`.`bio_goals` ORDER BY 2',
				'dilemma_ethics' => 'SELECT `bio_code_herme`.`id`, IF(    CHAR_LENGTH(`class_dilemma1`.`defense`), CONCAT_WS(\'\',   `class_dilemma1`.`defense`), \'\') FROM `bio_code_herme` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_code_herme`.`biography` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`bio_code_herme`.`agent_id` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_code_herme`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_code_herme`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_code_herme`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_code_herme`.`token_sequence` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme`.`counterfactual` LEFT JOIN `class_sdg` as class_sdg1 ON `class_sdg1`.`id`=`bio_code_herme`.`bio_sdg` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme`.`bio_dilemma` LEFT JOIN `class_goals` as class_goals1 ON `class_goals1`.`id`=`bio_code_herme`.`bio_goals` ORDER BY 2',
				'sdg' => 'SELECT `bio_code_herme`.`id`, IF(CHAR_LENGTH(`bio_code_herme`.`id`), CONCAT_WS(\'\', `bio_code_herme`.`id`, \'   \'), \'\') FROM `bio_code_herme` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_code_herme`.`biography` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`bio_code_herme`.`agent_id` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_code_herme`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_code_herme`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_code_herme`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_code_herme`.`token_sequence` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme`.`counterfactual` LEFT JOIN `class_sdg` as class_sdg1 ON `class_sdg1`.`id`=`bio_code_herme`.`bio_sdg` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme`.`bio_dilemma` LEFT JOIN `class_goals` as class_goals1 ON `class_goals1`.`id`=`bio_code_herme`.`bio_goals` ORDER BY 2',
			...
			'bio_storyline' => [
				...
				'character_event' => 'SELECT `bio_encounter_scene`.`id`, IF(    CHAR_LENGTH(`bio_encounter1`.`id`) || CHAR_LENGTH(`bio_encounter1`.`story_scene`), CONCAT_WS(\'\',   `bio_encounter1`.`id`, \'   \', `bio_encounter1`.`story_scene`), \'\') FROM `bio_encounter_scene` LEFT JOIN `encounter_team` as encounter_team1 ON `encounter_team1`.`id`=`bio_encounter_scene`.`encounter_team` LEFT JOIN `ecounter_analyst` as ecounter_analyst1 ON `ecounter_analyst1`.`id`=`bio_encounter_scene`.`encounter_analyst` LEFT JOIN `bio_encounter` as bio_encounter1 ON `bio_encounter1`.`id`=`bio_encounter_scene`.`scene` ORDER BY 2',
				'startdate' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(if(`biblio_code_invivo2`.`start_date`,date_format(`biblio_code_invivo2`.`start_date`,\'%d/%m/%Y %H:%i\'),\'\')) || CHAR_LENGTH(if(`biblio_code_invivo2`.`end_date`,date_format(`biblio_code_invivo2`.`end_date`,\'%d/%m/%Y %H:%i\'),\'\')), CONCAT_WS(\'\',   if(`biblio_code_invivo2`.`start_date`,date_format(`biblio_code_invivo2`.`start_date`,\'%d/%m/%Y %H:%i\'),\'\'), \' - \', if(`biblio_code_invivo2`.`end_date`,date_format(`biblio_code_invivo2`.`end_date`,\'%d/%m/%Y %H:%i\'),\'\')), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'enddate' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(if(`biblio_code_invivo1`.`end_date`,date_format(`biblio_code_invivo1`.`end_date`,\'%d/%m/%Y %H:%i\'),\'\')), CONCAT_WS(\'\',   if(`biblio_code_invivo1`.`end_date`,date_format(`biblio_code_invivo1`.`end_date`,\'%d/%m/%Y %H:%i\'),\'\')), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
			],
			'bio_storystatic' => [
			...
			'bio_storydynamic' => [
				...
				'dp_cat1' => 'SELECT `class_dynamicstorypoints1`.`id`, `class_dynamicstorypoints1`.`term` FROM `class_dynamicstorypoints1` ORDER BY 2',
				'dp_cat2' => 'SELECT `class_dynamicstorypoints2`.`id`, `class_dynamicstorypoints2`.`term` FROM `class_dynamicstorypoints2` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints2`.`cat1` ORDER BY 2',
				'dp_cat3_driver' => 'SELECT `class_dynamicstorypoints3`.`id`, `class_dynamicstorypoints3`.`term` FROM `class_dynamicstorypoints3` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints3`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints3`.`cat2` ORDER BY 2',
				...
				'dp_cat3_limit' => 'SELECT `class_dynamicstorypoints3`.`id`, `class_dynamicstorypoints3`.`term` FROM `class_dynamicstorypoints3` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints3`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints3`.`cat2` ORDER BY 2',
				...
				'dp_cat3_outcome' => 'SELECT `class_dynamicstorypoints3`.`id`, `class_dynamicstorypoints3`.`term` FROM `class_dynamicstorypoints3` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints3`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints3`.`cat2` ORDER BY 2',
				...
				'dp_cat3_judgement' => 'SELECT `class_dynamicstorypoints3`.`id`, `class_dynamicstorypoints3`.`term` FROM `class_dynamicstorypoints3` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints3`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints3`.`cat2` ORDER BY 2',
			...
			'bio_encounter' => [
				...
				'author_nameA' => 'SELECT `game_agent`.`id`, IF(CHAR_LENGTH(`game_agent`.`last_name`) || CHAR_LENGTH(`game_agent`.`first_name`), CONCAT_WS(\'\', `game_agent`.`last_name`, \', \', `game_agent`.`first_name`), \'\') FROM `game_agent` LEFT JOIN `class_agent_selection` as class_agent_selection1 ON `class_agent_selection1`.`id`=`game_agent`.`selection_class` LEFT JOIN `class_agent_type1` as class_agent_type11 ON `class_agent_type11`.`id`=`game_agent`.`agenttype1` LEFT JOIN `class_agent_type2` as class_agent_type21 ON `class_agent_type21`.`id`=`game_agent`.`agenttype2` LEFT JOIN `class_gender` as class_gender1 ON `class_gender1`.`id`=`game_agent`.`gender` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`game_agent`.`data_evaluation` ORDER BY 2',
				...
				'bio_impressionA' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(`class_im1`.`impression`), CONCAT_WS(\'\',   `class_im1`.`impression`), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'bio_ntA' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(`class_nt1`.`noetictension`), CONCAT_WS(\'\',   `class_nt1`.`noetictension`), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'bio_counterfactualA' => 'SELECT `bio_chr_scene`.`id`, `bio_chr_scene`.`id` FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'bio_dilemmaA' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(`class_dilemma2`.`defense`), CONCAT_WS(\'\',   `class_dilemma2`.`defense`), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'bio_sdgA' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(`bio_code_herme1`.`id`), CONCAT_WS(\'\',   `bio_code_herme1`.`id`, \'   \'), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'startdateA' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(if(`biblio_code_invivo2`.`start_date`,date_format(`biblio_code_invivo2`.`start_date`,\'%d/%m/%Y %H:%i\'),\'\')) || CHAR_LENGTH(if(`biblio_code_invivo2`.`end_date`,date_format(`biblio_code_invivo2`.`end_date`,\'%d/%m/%Y %H:%i\'),\'\')), CONCAT_WS(\'\',   if(`biblio_code_invivo2`.`start_date`,date_format(`biblio_code_invivo2`.`start_date`,\'%d/%m/%Y %H:%i\'),\'\'), \' - \', if(`biblio_code_invivo2`.`end_date`,date_format(`biblio_code_invivo2`.`end_date`,\'%d/%m/%Y %H:%i\'),\'\')), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'enddateA' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(if(`biblio_code_invivo1`.`end_date`,date_format(`biblio_code_invivo1`.`end_date`,\'%d/%m/%Y %H:%i\'),\'\')), CONCAT_WS(\'\',   if(`biblio_code_invivo1`.`end_date`,date_format(`biblio_code_invivo1`.`end_date`,\'%d/%m/%Y %H:%i\'),\'\')), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				...
				'author_nameB' => 'SELECT `game_agent`.`id`, IF(CHAR_LENGTH(`game_agent`.`last_name`) || CHAR_LENGTH(`game_agent`.`first_name`), CONCAT_WS(\'\', `game_agent`.`last_name`, \', \', `game_agent`.`first_name`), \'\') FROM `game_agent` LEFT JOIN `class_agent_selection` as class_agent_selection1 ON `class_agent_selection1`.`id`=`game_agent`.`selection_class` LEFT JOIN `class_agent_type1` as class_agent_type11 ON `class_agent_type11`.`id`=`game_agent`.`agenttype1` LEFT JOIN `class_agent_type2` as class_agent_type21 ON `class_agent_type21`.`id`=`game_agent`.`agenttype2` LEFT JOIN `class_gender` as class_gender1 ON `class_gender1`.`id`=`game_agent`.`gender` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`game_agent`.`data_evaluation` ORDER BY 2',
			...
			'bio_code_herme' => [
				...
				'counterfactual' => 'SELECT `class_counterfactual`.`id`, `class_counterfactual`.`counterfactual` FROM `class_counterfactual` ORDER BY 2',
				'bio_sdg' => 'SELECT `class_sdg`.`id`, IF(CHAR_LENGTH(`class_sdg`.`no`) || CHAR_LENGTH(`class_sdg`.`sdg_topic`), CONCAT_WS(\'\', `class_sdg`.`no`, \'   \', `class_sdg`.`sdg_topic`), \'\') FROM `class_sdg` ORDER BY 2',
				'bio_dilemma' => 'SELECT `class_dilemma`.`id`, `class_dilemma`.`defense` FROM `class_dilemma` ORDER BY 2',
				'bio_goals' => 'SELECT `class_goals`.`id`, `class_goals`.`id` FROM `class_goals` ORDER BY 2',
			],
			'hist_team' => [
			],
			'hist_author' => [
			...
			'hist_story' => [
				'team' => 'SELECT `hist_team`.`id`, IF(CHAR_LENGTH(`hist_team`.`id`) || CHAR_LENGTH(`hist_team`.`team`), CONCAT_WS(\'\', `hist_team`.`id`, \' - \', `hist_team`.`team`), \'\') FROM `hist_team` ORDER BY 2',
				'hist_author_id' => 'SELECT `hist_author`.`id`, IF(CHAR_LENGTH(`hist_author`.`agent_id`) || CHAR_LENGTH(`hist_author`.`agent_memberid`), CONCAT_WS(\'\', IF(    CHAR_LENGTH(`game_agent1`.`id`) || CHAR_LENGTH(`game_agent1`.`memberID`), CONCAT_WS(\'\',   `game_agent1`.`id`, \'   \', `game_agent1`.`memberID`), \'\'), \'   \', IF(    CHAR_LENGTH(`game_agent1`.`memberID`), CONCAT_WS(\'\',   `game_agent1`.`memberID`), \'\')), \'\') FROM `hist_author` LEFT JOIN `hist_team` as hist_team1 ON `hist_team1`.`id`=`hist_author`.`team` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`hist_author`.`agent_id` ORDER BY 2',
				'hist_author_name' => 'SELECT `hist_author`.`id`, IF(CHAR_LENGTH(`hist_author`.`last_name`) || CHAR_LENGTH(`hist_author`.`first_name`), CONCAT_WS(\'\', IF(    CHAR_LENGTH(`game_agent1`.`last_name`), CONCAT_WS(\'\',   `game_agent1`.`last_name`), \'\'), \', \', IF(    CHAR_LENGTH(`game_agent1`.`first_name`), CONCAT_WS(\'\',   `game_agent1`.`first_name`), \'\')), \'\') FROM `hist_author` LEFT JOIN `hist_team` as hist_team1 ON `hist_team1`.`id`=`hist_author`.`team` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`hist_author`.`agent_id` ORDER BY 2',
			...
			'hist_chr' => [
				...
				'hist_author_id' => 'SELECT `hist_author`.`id`, IF(CHAR_LENGTH(`hist_author`.`agent_id`) || CHAR_LENGTH(`hist_author`.`agent_memberid`), CONCAT_WS(\'\', IF(    CHAR_LENGTH(`game_agent1`.`id`) || CHAR_LENGTH(`game_agent1`.`memberID`), CONCAT_WS(\'\',   `game_agent1`.`id`, \'   \', `game_agent1`.`memberID`), \'\'), \'   \', IF(    CHAR_LENGTH(`game_agent1`.`memberID`), CONCAT_WS(\'\',   `game_agent1`.`memberID`), \'\')), \'\') FROM `hist_author` LEFT JOIN `hist_team` as hist_team1 ON `hist_team1`.`id`=`hist_author`.`team` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`hist_author`.`agent_id` ORDER BY 2',
				'hist_author_memberid' => 'SELECT `hist_author`.`id`, IF(CHAR_LENGTH(`hist_author`.`last_name`) || CHAR_LENGTH(`hist_author`.`first_name`), CONCAT_WS(\'\', IF(    CHAR_LENGTH(`game_agent1`.`last_name`), CONCAT_WS(\'\',   `game_agent1`.`last_name`), \'\'), IF(    CHAR_LENGTH(`game_agent1`.`first_name`), CONCAT_WS(\'\',   `game_agent1`.`first_name`), \'\')), \'\') FROM `hist_author` LEFT JOIN `hist_team` as hist_team1 ON `hist_team1`.`id`=`hist_author`.`team` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`hist_author`.`agent_id` ORDER BY 2',
				'hist_author_name' => 'SELECT `hist_author`.`id`, IF(CHAR_LENGTH(`hist_author`.`last_name`) || CHAR_LENGTH(`hist_author`.`first_name`), CONCAT_WS(\'\', IF(    CHAR_LENGTH(`game_agent1`.`last_name`), CONCAT_WS(\'\',   `game_agent1`.`last_name`), \'\'), \', \', IF(    CHAR_LENGTH(`game_agent1`.`first_name`), CONCAT_WS(\'\',   `game_agent1`.`first_name`), \'\')), \'\') FROM `hist_author` LEFT JOIN `hist_team` as hist_team1 ON `hist_team1`.`id`=`hist_author`.`team` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`hist_author`.`agent_id` ORDER BY 2',
			...
			'hist_chr_dev' => [
				...
				'dp3_growth' => 'SELECT `class_dynamicstorypoints3`.`id`, `class_dynamicstorypoints3`.`term` FROM `class_dynamicstorypoints3` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints3`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints3`.`cat2` ORDER BY 2',
				'mc_growth' => 'SELECT `class_dynamicstorypoints4`.`id`, `class_dynamicstorypoints4`.`term` FROM `class_dynamicstorypoints4` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints4`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints4`.`cat2` LEFT JOIN `class_dynamicstorypoints3` as class_dynamicstorypoints31 ON `class_dynamicstorypoints31`.`id`=`class_dynamicstorypoints4`.`cat3` ORDER BY 2',
				'illust_growth' => 'SELECT `hist_chr_scene`.`id`, IF(CHAR_LENGTH(`hist_chr_scene`.`id`) || CHAR_LENGTH(`hist_chr_scene`.`illustration`), CONCAT_WS(\'\', `hist_chr_scene`.`id`, \' - \', `hist_chr_scene`.`illustration`), \'\') FROM `hist_chr_scene` LEFT JOIN `hist_team` as hist_team1 ON `hist_team1`.`id`=`hist_chr_scene`.`team` LEFT JOIN `hist_author` as hist_author1 ON `hist_author1`.`id`=`hist_chr_scene`.`author_id` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`hist_author1`.`agent_id` LEFT JOIN `hist_story` as hist_story1 ON `hist_story1`.`id`=`hist_chr_scene`.`hist_story` LEFT JOIN `game_agent` as game_agent3 ON `game_agent3`.`id`=`hist_chr_scene`.`agent_id` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`hist_chr_scene`.`bio_story` LEFT JOIN `hist_chr` as hist_chr1 ON `hist_chr1`.`id`=`hist_chr_scene`.`hist_chr` LEFT JOIN `bio_storyline` as bio_storyline1 ON `bio_storyline1`.`id`=`hist_chr_scene`.`bio_storyline_no` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`hist_chr_scene`.`chr_element` LEFT JOIN `bio_chr_scene` as bio_chr_scene1 ON `bio_chr_scene1`.`id`=`hist_chr_scene`.`bio_chr_scene` LEFT JOIN `bio_chr_scene` as bio_chr_scene2 ON `bio_chr_scene2`.`id`=`hist_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene2`.`invivo_code` LEFT JOIN `bio_chr_scene` as bio_chr_scene3 ON `bio_chr_scene3`.`id`=`hist_chr_scene`.`startdate` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene3`.`startdate` LEFT JOIN `bio_chr_scene` as bio_chr_scene4 ON `bio_chr_scene4`.`id`=`hist_chr_scene`.`enddate` LEFT JOIN `bio_chr_scene` as bio_chr_scene5 ON `bio_chr_scene5`.`id`=`hist_chr_scene`.`person` LEFT JOIN `bio_chr_scene` as bio_chr_scene6 ON `bio_chr_scene6`.`id`=`hist_chr_scene`.`place` LEFT JOIN `bio_chr_scene` as bio_chr_scene7 ON `bio_chr_scene7`.`id`=`hist_chr_scene`.`herme_code` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene7`.`herme_code` LEFT JOIN `bio_chr_scene` as bio_chr_scene8 ON `bio_chr_scene8`.`id`=`hist_chr_scene`.`impression` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `bio_chr_scene` as bio_chr_scene9 ON `bio_chr_scene9`.`id`=`hist_chr_scene`.`noetictension` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `bio_chr_scene` as bio_chr_scene10 ON `bio_chr_scene10`.`id`=`hist_chr_scene`.`pc` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `bio_chr_scene` as bio_chr_scene11 ON `bio_chr_scene11`.`id`=`hist_chr_scene`.`counterfactual` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `bio_chr_scene` as bio_chr_scene12 ON `bio_chr_scene12`.`id`=`hist_chr_scene`.`dilemma` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'dp3_approach' => 'SELECT `class_dynamicstorypoints3`.`id`, `class_dynamicstorypoints3`.`term` FROM `class_dynamicstorypoints3` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints3`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints3`.`cat2` ORDER BY 2',
				'mc_approach' => 'SELECT `class_dynamicstorypoints4`.`id`, `class_dynamicstorypoints4`.`term` FROM `class_dynamicstorypoints4` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints4`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints4`.`cat2` LEFT JOIN `class_dynamicstorypoints3` as class_dynamicstorypoints31 ON `class_dynamicstorypoints31`.`id`=`class_dynamicstorypoints4`.`cat3` ORDER BY 2',
				'illust_approach' => 'SELECT `hist_chr_scene`.`id`, IF(CHAR_LENGTH(`hist_chr_scene`.`id`) || CHAR_LENGTH(`hist_chr_scene`.`illustration`), CONCAT_WS(\'\', `hist_chr_scene`.`id`, \' - \', `hist_chr_scene`.`illustration`), \'\') FROM `hist_chr_scene` LEFT JOIN `hist_team` as hist_team1 ON `hist_team1`.`id`=`hist_chr_scene`.`team` LEFT JOIN `hist_author` as hist_author1 ON `hist_author1`.`id`=`hist_chr_scene`.`author_id` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`hist_author1`.`agent_id` LEFT JOIN `hist_story` as hist_story1 ON `hist_story1`.`id`=`hist_chr_scene`.`hist_story` LEFT JOIN `game_agent` as game_agent3 ON `game_agent3`.`id`=`hist_chr_scene`.`agent_id` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`hist_chr_scene`.`bio_story` LEFT JOIN `hist_chr` as hist_chr1 ON `hist_chr1`.`id`=`hist_chr_scene`.`hist_chr` LEFT JOIN `bio_storyline` as bio_storyline1 ON `bio_storyline1`.`id`=`hist_chr_scene`.`bio_storyline_no` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`hist_chr_scene`.`chr_element` LEFT JOIN `bio_chr_scene` as bio_chr_scene1 ON `bio_chr_scene1`.`id`=`hist_chr_scene`.`bio_chr_scene` LEFT JOIN `bio_chr_scene` as bio_chr_scene2 ON `bio_chr_scene2`.`id`=`hist_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene2`.`invivo_code` LEFT JOIN `bio_chr_scene` as bio_chr_scene3 ON `bio_chr_scene3`.`id`=`hist_chr_scene`.`startdate` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene3`.`startdate` LEFT JOIN `bio_chr_scene` as bio_chr_scene4 ON `bio_chr_scene4`.`id`=`hist_chr_scene`.`enddate` LEFT JOIN `bio_chr_scene` as bio_chr_scene5 ON `bio_chr_scene5`.`id`=`hist_chr_scene`.`person` LEFT JOIN `bio_chr_scene` as bio_chr_scene6 ON `bio_chr_scene6`.`id`=`hist_chr_scene`.`place` LEFT JOIN `bio_chr_scene` as bio_chr_scene7 ON `bio_chr_scene7`.`id`=`hist_chr_scene`.`herme_code` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene7`.`herme_code` LEFT JOIN `bio_chr_scene` as bio_chr_scene8 ON `bio_chr_scene8`.`id`=`hist_chr_scene`.`impression` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `bio_chr_scene` as bio_chr_scene9 ON `bio_chr_scene9`.`id`=`hist_chr_scene`.`noetictension` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `bio_chr_scene` as bio_chr_scene10 ON `bio_chr_scene10`.`id`=`hist_chr_scene`.`pc` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `bio_chr_scene` as bio_chr_scene11 ON `bio_chr_scene11`.`id`=`hist_chr_scene`.`counterfactual` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `bio_chr_scene` as bio_chr_scene12 ON `bio_chr_scene12`.`id`=`hist_chr_scene`.`dilemma` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'dp3_psstyle' => 'SELECT `class_dynamicstorypoints3`.`id`, `class_dynamicstorypoints3`.`term` FROM `class_dynamicstorypoints3` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints3`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints3`.`cat2` ORDER BY 2',
				'mc_ps_style' => 'SELECT `class_dynamicstorypoints4`.`id`, `class_dynamicstorypoints4`.`term` FROM `class_dynamicstorypoints4` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints4`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints4`.`cat2` LEFT JOIN `class_dynamicstorypoints3` as class_dynamicstorypoints31 ON `class_dynamicstorypoints31`.`id`=`class_dynamicstorypoints4`.`cat3` ORDER BY 2',
			...
			'hist_chr_scene' => [
				...
				'chr_element' => 'SELECT `class_character_element`.`id`, IF(CHAR_LENGTH(`class_character_element`.`element`) || CHAR_LENGTH(`class_character_element`.`value`), CONCAT_WS(\'\', `class_character_element`.`element`, \'- \', `class_character_element`.`value`), \'\') FROM `class_character_element` ORDER BY 2',
				'bio_chr_scene' => 'SELECT `bio_chr_scene`.`id`, IF(CHAR_LENGTH(`bio_chr_scene`.`id`) || CHAR_LENGTH(`bio_chr_scene`.`scene`), CONCAT_WS(\'\', `bio_chr_scene`.`id`, \'   \', `bio_chr_scene`.`scene`), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'invivo_code' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(`biblio_code_invivo1`.`invivo`), CONCAT_WS(\'\',   `biblio_code_invivo1`.`invivo`), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'startdate' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(if(`biblio_code_invivo2`.`start_date`,date_format(`biblio_code_invivo2`.`start_date`,\'%d/%m/%Y %H:%i\'),\'\')) || CHAR_LENGTH(if(`biblio_code_invivo2`.`end_date`,date_format(`biblio_code_invivo2`.`end_date`,\'%d/%m/%Y %H:%i\'),\'\')), CONCAT_WS(\'\',   if(`biblio_code_invivo2`.`start_date`,date_format(`biblio_code_invivo2`.`start_date`,\'%d/%m/%Y %H:%i\'),\'\'), \' - \', if(`biblio_code_invivo2`.`end_date`,date_format(`biblio_code_invivo2`.`end_date`,\'%d/%m/%Y %H:%i\'),\'\')), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'enddate' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(if(`biblio_code_invivo1`.`end_date`,date_format(`biblio_code_invivo1`.`end_date`,\'%d/%m/%Y %H:%i\'),\'\')), CONCAT_WS(\'\',   if(`biblio_code_invivo1`.`end_date`,date_format(`biblio_code_invivo1`.`end_date`,\'%d/%m/%Y %H:%i\'),\'\')), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'person' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(`biblio_code_invivo1`.`person`), CONCAT_WS(\'\',   `biblio_code_invivo1`.`person`), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'place' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(`biblio_code_invivo1`.`place`), CONCAT_WS(\'\',   `biblio_code_invivo1`.`place`), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'herme_code' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(`bio_code_herme1`.`hermeneutic`), CONCAT_WS(\'\',   `bio_code_herme1`.`hermeneutic`), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'impression' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(`class_im1`.`impression`), CONCAT_WS(\'\',   `class_im1`.`impression`), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'noetictension' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(`class_nt1`.`noetictension`), CONCAT_WS(\'\',   `class_nt1`.`noetictension`), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'pc' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(`class_pc1`.`perform_contrad`), CONCAT_WS(\'\',   `class_pc1`.`perform_contrad`), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'counterfactual' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(`class_counterfactual1`.`counterfactual`), CONCAT_WS(\'\',   `class_counterfactual1`.`counterfactual`), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'dilemma' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(`class_dilemma2`.`defense`), CONCAT_WS(\'\',   `class_dilemma2`.`defense`), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
			],
			'hist_storyline' => [
				...
				'startdate' => 'SELECT `hist_chr_scene`.`id`, IF(    CHAR_LENGTH(if(`biblio_code_invivo2`.`start_date`,date_format(`biblio_code_invivo2`.`start_date`,\'%d/%m/%Y %H:%i\'),\'\')) || CHAR_LENGTH(if(`biblio_code_invivo2`.`end_date`,date_format(`biblio_code_invivo2`.`end_date`,\'%d/%m/%Y %H:%i\'),\'\')), CONCAT_WS(\'\',   if(`biblio_code_invivo2`.`start_date`,date_format(`biblio_code_invivo2`.`start_date`,\'%d/%m/%Y %H:%i\'),\'\'), \' - \', if(`biblio_code_invivo2`.`end_date`,date_format(`biblio_code_invivo2`.`end_date`,\'%d/%m/%Y %H:%i\'),\'\')), \'\') FROM `hist_chr_scene` LEFT JOIN `hist_team` as hist_team1 ON `hist_team1`.`id`=`hist_chr_scene`.`team` LEFT JOIN `hist_author` as hist_author1 ON `hist_author1`.`id`=`hist_chr_scene`.`author_id` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`hist_author1`.`agent_id` LEFT JOIN `hist_story` as hist_story1 ON `hist_story1`.`id`=`hist_chr_scene`.`hist_story` LEFT JOIN `game_agent` as game_agent3 ON `game_agent3`.`id`=`hist_chr_scene`.`agent_id` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`hist_chr_scene`.`bio_story` LEFT JOIN `hist_chr` as hist_chr1 ON `hist_chr1`.`id`=`hist_chr_scene`.`hist_chr` LEFT JOIN `bio_storyline` as bio_storyline1 ON `bio_storyline1`.`id`=`hist_chr_scene`.`bio_storyline_no` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`hist_chr_scene`.`chr_element` LEFT JOIN `bio_chr_scene` as bio_chr_scene1 ON `bio_chr_scene1`.`id`=`hist_chr_scene`.`bio_chr_scene` LEFT JOIN `bio_chr_scene` as bio_chr_scene2 ON `bio_chr_scene2`.`id`=`hist_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene2`.`invivo_code` LEFT JOIN `bio_chr_scene` as bio_chr_scene3 ON `bio_chr_scene3`.`id`=`hist_chr_scene`.`startdate` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene3`.`startdate` LEFT JOIN `bio_chr_scene` as bio_chr_scene4 ON `bio_chr_scene4`.`id`=`hist_chr_scene`.`enddate` LEFT JOIN `bio_chr_scene` as bio_chr_scene5 ON `bio_chr_scene5`.`id`=`hist_chr_scene`.`person` LEFT JOIN `bio_chr_scene` as bio_chr_scene6 ON `bio_chr_scene6`.`id`=`hist_chr_scene`.`place` LEFT JOIN `bio_chr_scene` as bio_chr_scene7 ON `bio_chr_scene7`.`id`=`hist_chr_scene`.`herme_code` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene7`.`herme_code` LEFT JOIN `bio_chr_scene` as bio_chr_scene8 ON `bio_chr_scene8`.`id`=`hist_chr_scene`.`impression` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `bio_chr_scene` as bio_chr_scene9 ON `bio_chr_scene9`.`id`=`hist_chr_scene`.`noetictension` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `bio_chr_scene` as bio_chr_scene10 ON `bio_chr_scene10`.`id`=`hist_chr_scene`.`pc` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `bio_chr_scene` as bio_chr_scene11 ON `bio_chr_scene11`.`id`=`hist_chr_scene`.`counterfactual` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `bio_chr_scene` as bio_chr_scene12 ON `bio_chr_scene12`.`id`=`hist_chr_scene`.`dilemma` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'enddate' => 'SELECT `hist_chr_scene`.`id`, IF(    CHAR_LENGTH(if(`biblio_code_invivo1`.`end_date`,date_format(`biblio_code_invivo1`.`end_date`,\'%d/%m/%Y %H:%i\'),\'\')), CONCAT_WS(\'\',   if(`biblio_code_invivo1`.`end_date`,date_format(`biblio_code_invivo1`.`end_date`,\'%d/%m/%Y %H:%i\'),\'\')), \'\') FROM `hist_chr_scene` LEFT JOIN `hist_team` as hist_team1 ON `hist_team1`.`id`=`hist_chr_scene`.`team` LEFT JOIN `hist_author` as hist_author1 ON `hist_author1`.`id`=`hist_chr_scene`.`author_id` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`hist_author1`.`agent_id` LEFT JOIN `hist_story` as hist_story1 ON `hist_story1`.`id`=`hist_chr_scene`.`hist_story` LEFT JOIN `game_agent` as game_agent3 ON `game_agent3`.`id`=`hist_chr_scene`.`agent_id` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`hist_chr_scene`.`bio_story` LEFT JOIN `hist_chr` as hist_chr1 ON `hist_chr1`.`id`=`hist_chr_scene`.`hist_chr` LEFT JOIN `bio_storyline` as bio_storyline1 ON `bio_storyline1`.`id`=`hist_chr_scene`.`bio_storyline_no` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`hist_chr_scene`.`chr_element` LEFT JOIN `bio_chr_scene` as bio_chr_scene1 ON `bio_chr_scene1`.`id`=`hist_chr_scene`.`bio_chr_scene` LEFT JOIN `bio_chr_scene` as bio_chr_scene2 ON `bio_chr_scene2`.`id`=`hist_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene2`.`invivo_code` LEFT JOIN `bio_chr_scene` as bio_chr_scene3 ON `bio_chr_scene3`.`id`=`hist_chr_scene`.`startdate` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene3`.`startdate` LEFT JOIN `bio_chr_scene` as bio_chr_scene4 ON `bio_chr_scene4`.`id`=`hist_chr_scene`.`enddate` LEFT JOIN `bio_chr_scene` as bio_chr_scene5 ON `bio_chr_scene5`.`id`=`hist_chr_scene`.`person` LEFT JOIN `bio_chr_scene` as bio_chr_scene6 ON `bio_chr_scene6`.`id`=`hist_chr_scene`.`place` LEFT JOIN `bio_chr_scene` as bio_chr_scene7 ON `bio_chr_scene7`.`id`=`hist_chr_scene`.`herme_code` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene7`.`herme_code` LEFT JOIN `bio_chr_scene` as bio_chr_scene8 ON `bio_chr_scene8`.`id`=`hist_chr_scene`.`impression` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `bio_chr_scene` as bio_chr_scene9 ON `bio_chr_scene9`.`id`=`hist_chr_scene`.`noetictension` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `bio_chr_scene` as bio_chr_scene10 ON `bio_chr_scene10`.`id`=`hist_chr_scene`.`pc` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `bio_chr_scene` as bio_chr_scene11 ON `bio_chr_scene11`.`id`=`hist_chr_scene`.`counterfactual` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `bio_chr_scene` as bio_chr_scene12 ON `bio_chr_scene12`.`id`=`hist_chr_scene`.`dilemma` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
			],
			'hist_storystatic' => [
				'story' => 'SELECT `hist_story`.`id`, IF(CHAR_LENGTH(`hist_story`.`id`) || CHAR_LENGTH(`hist_story`.`story_title`), CONCAT_WS(\'\', `hist_story`.`id`, \'   \', `hist_story`.`story_title`), \'\') FROM `hist_story` LEFT JOIN `hist_team` as hist_team1 ON `hist_team1`.`id`=`hist_story`.`team` LEFT JOIN `hist_author` as hist_author1 ON `hist_author1`.`id`=`hist_story`.`hist_author_id` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`hist_author1`.`agent_id` LEFT JOIN `hist_community` as hist_community1 ON `hist_community1`.`id`=`hist_story`.`community_id` LEFT JOIN `class_bibliography_genre` as class_bibliography_genre1 ON `class_bibliography_genre1`.`id`=`hist_story`.`genre` LEFT JOIN `class_story_collab_type` as class_story_collab_type1 ON `class_story_collab_type1`.`id`=`hist_story`.`collaboration_status` LEFT JOIN `class_language` as class_language1 ON `class_language1`.`id`=`hist_story`.`language` ORDER BY 2',
				'throughline' => 'SELECT `class_dramatica_throughline`.`id`, `class_dramatica_throughline`.`throughline` FROM `class_dramatica_throughline` ORDER BY 2',
			...
			'hist_storydynamic' => [
				...
				'dp_cat2' => 'SELECT `class_dynamicstorypoints2`.`id`, `class_dynamicstorypoints2`.`term` FROM `class_dynamicstorypoints2` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints2`.`cat1` ORDER BY 2',
				'dp_cat3_driver' => 'SELECT `class_dynamicstorypoints3`.`id`, `class_dynamicstorypoints3`.`term` FROM `class_dynamicstorypoints3` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints3`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints3`.`cat2` ORDER BY 2',
				'os_driver' => 'SELECT `class_dynamicstorypoints4`.`id`, `class_dynamicstorypoints4`.`term` FROM `class_dynamicstorypoints4` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints4`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints4`.`cat2` LEFT JOIN `class_dynamicstorypoints3` as class_dynamicstorypoints31 ON `class_dynamicstorypoints31`.`id`=`class_dynamicstorypoints4`.`cat3` ORDER BY 2',
				'dp_cat3_limit' => 'SELECT `class_dynamicstorypoints3`.`id`, `class_dynamicstorypoints3`.`term` FROM `class_dynamicstorypoints3` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints3`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints3`.`cat2` ORDER BY 2',
				'os_limit' => 'SELECT `class_dynamicstorypoints4`.`id`, `class_dynamicstorypoints4`.`term` FROM `class_dynamicstorypoints4` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints4`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints4`.`cat2` LEFT JOIN `class_dynamicstorypoints3` as class_dynamicstorypoints31 ON `class_dynamicstorypoints31`.`id`=`class_dynamicstorypoints4`.`cat3` ORDER BY 2',
				'dp_cat3_outcome' => 'SELECT `class_dynamicstorypoints3`.`id`, `class_dynamicstorypoints3`.`term` FROM `class_dynamicstorypoints3` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints3`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints3`.`cat2` ORDER BY 2',
				'os_outcome' => 'SELECT `class_dynamicstorypoints4`.`id`, `class_dynamicstorypoints4`.`term` FROM `class_dynamicstorypoints4` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints4`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints4`.`cat2` LEFT JOIN `class_dynamicstorypoints3` as class_dynamicstorypoints31 ON `class_dynamicstorypoints31`.`id`=`class_dynamicstorypoints4`.`cat3` ORDER BY 2',
				'dp_cat3_judgement' => 'SELECT `class_dynamicstorypoints3`.`id`, `class_dynamicstorypoints3`.`term` FROM `class_dynamicstorypoints3` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints3`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints3`.`cat2` ORDER BY 2',
				'os_judgement' => 'SELECT `class_dynamicstorypoints4`.`id`, `class_dynamicstorypoints4`.`term` FROM `class_dynamicstorypoints4` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints4`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints4`.`cat2` LEFT JOIN `class_dynamicstorypoints3` as class_dynamicstorypoints31 ON `class_dynamicstorypoints31`.`id`=`class_dynamicstorypoints4`.`cat3` ORDER BY 2',
				'os_goal_domain' => 'SELECT `bio_storystatic`.`id`, IF(    CHAR_LENGTH(`class_dramatica_domain1`.`domain`), CONCAT_WS(\'\',   `class_dramatica_domain1`.`domain`), \'\') FROM `bio_storystatic` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_storystatic`.`story` LEFT JOIN `class_dramatica_throughline` as class_dramatica_throughline1 ON `class_dramatica_throughline1`.`id`=`bio_storystatic`.`throughline` LEFT JOIN `bio_chr` as bio_chr1 ON `bio_chr1`.`id`=`bio_storystatic`.`story_character_mc` LEFT JOIN `class_dramatica_archetype` as class_dramatica_archetype1 ON `class_dramatica_archetype1`.`id`=`bio_chr1`.`bio_archetype` LEFT JOIN `class_dramatica_domain` as class_dramatica_domain1 ON `class_dramatica_domain1`.`id`=`bio_storystatic`.`throughline_domain` LEFT JOIN `class_dramatica_concern` as class_dramatica_concern1 ON `class_dramatica_concern1`.`id`=`bio_storystatic`.`concern` LEFT JOIN `class_dramatica_issue` as class_dramatica_issue1 ON `class_dramatica_issue1`.`id`=`bio_storystatic`.`issue` LEFT JOIN `class_dramatica_themes` as class_dramatica_themes1 ON `class_dramatica_themes1`.`id`=`bio_storystatic`.`problem` LEFT JOIN `class_dramatica_themes` as class_dramatica_themes2 ON `class_dramatica_themes2`.`id`=`bio_storystatic`.`solution` LEFT JOIN `class_dramatica_themes` as class_dramatica_themes3 ON `class_dramatica_themes3`.`id`=`bio_storystatic`.`symptom` LEFT JOIN `class_dramatica_themes` as class_dramatica_themes4 ON `class_dramatica_themes4`.`id`=`bio_storystatic`.`response` LEFT JOIN `class_dramatica_themes` as class_dramatica_themes5 ON `class_dramatica_themes5`.`id`=`bio_storystatic`.`catalyst` LEFT JOIN `class_dramatica_issue` as class_dramatica_issue2 ON `class_dramatica_issue2`.`id`=`class_dramatica_themes5`.`issue` LEFT JOIN `class_dramatica_concern` as class_dramatica_concern2 ON `class_dramatica_concern2`.`id`=`class_dramatica_themes5`.`concern` LEFT JOIN `class_dramatica_themes` as class_dramatica_themes6 ON `class_dramatica_themes6`.`id`=`bio_storystatic`.`inhibitor` LEFT JOIN `class_dramatica_issue` as class_dramatica_issue3 ON `class_dramatica_issue3`.`id`=`class_dramatica_themes6`.`issue` LEFT JOIN `class_dramatica_concern` as class_dramatica_concern3 ON `class_dramatica_concern3`.`id`=`class_dramatica_themes6`.`concern` LEFT JOIN `class_dramatica_themes` as class_dramatica_themes7 ON `class_dramatica_themes7`.`id`=`bio_storystatic`.`benchmark` LEFT JOIN `class_dramatica_concern` as class_dramatica_concern4 ON `class_dramatica_concern4`.`id`=`class_dramatica_themes7`.`concern` LEFT JOIN `class_dramatica_domain` as class_dramatica_domain2 ON `class_dramatica_domain2`.`id`=`class_dramatica_themes7`.`domain` LEFT JOIN `class_dramatica_concern` as class_dramatica_concern5 ON `class_dramatica_concern5`.`id`=`bio_storystatic`.`signpost1` LEFT JOIN `class_dramatica_concern` as class_dramatica_concern6 ON `class_dramatica_concern6`.`id`=`bio_storystatic`.`signpost2` LEFT JOIN `class_dramatica_concern` as class_dramatica_concern7 ON `class_dramatica_concern7`.`id`=`bio_storystatic`.`signpost3` LEFT JOIN `class_dramatica_concern` as class_dramatica_concern8 ON `class_dramatica_concern8`.`id`=`bio_storystatic`.`signpost4` ORDER BY 2',
				'os_goal_concern' => 'SELECT `bio_storystatic`.`id`, IF(    CHAR_LENGTH(`class_dramatica_concern1`.`concern`), CONCAT_WS(\'\',   `class_dramatica_concern1`.`concern`), \'\') FROM `bio_storystatic` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_storystatic`.`story` LEFT JOIN `class_dramatica_throughline` as class_dramatica_throughline1 ON `class_dramatica_throughline1`.`id`=`bio_storystatic`.`throughline` LEFT JOIN `bio_chr` as bio_chr1 ON `bio_chr1`.`id`=`bio_storystatic`.`story_character_mc` LEFT JOIN `class_dramatica_archetype` as class_dramatica_archetype1 ON `class_dramatica_archetype1`.`id`=`bio_chr1`.`bio_archetype` LEFT JOIN `class_dramatica_domain` as class_dramatica_domain1 ON `class_dramatica_domain1`.`id`=`bio_storystatic`.`throughline_domain` LEFT JOIN `class_dramatica_concern` as class_dramatica_concern1 ON `class_dramatica_concern1`.`id`=`bio_storystatic`.`concern` LEFT JOIN `class_dramatica_issue` as class_dramatica_issue1 ON `class_dramatica_issue1`.`id`=`bio_storystatic`.`issue` LEFT JOIN `class_dramatica_themes` as class_dramatica_themes1 ON `class_dramatica_themes1`.`id`=`bio_storystatic`.`problem` LEFT JOIN `class_dramatica_themes` as class_dramatica_themes2 ON `class_dramatica_themes2`.`id`=`bio_storystatic`.`solution` LEFT JOIN `class_dramatica_themes` as class_dramatica_themes3 ON `class_dramatica_themes3`.`id`=`bio_storystatic`.`symptom` LEFT JOIN `class_dramatica_themes` as class_dramatica_themes4 ON `class_dramatica_themes4`.`id`=`bio_storystatic`.`response` LEFT JOIN `class_dramatica_themes` as class_dramatica_themes5 ON `class_dramatica_themes5`.`id`=`bio_storystatic`.`catalyst` LEFT JOIN `class_dramatica_issue` as class_dramatica_issue2 ON `class_dramatica_issue2`.`id`=`class_dramatica_themes5`.`issue` LEFT JOIN `class_dramatica_concern` as class_dramatica_concern2 ON `class_dramatica_concern2`.`id`=`class_dramatica_themes5`.`concern` LEFT JOIN `class_dramatica_themes` as class_dramatica_themes6 ON `class_dramatica_themes6`.`id`=`bio_storystatic`.`inhibitor` LEFT JOIN `class_dramatica_issue` as class_dramatica_issue3 ON `class_dramatica_issue3`.`id`=`class_dramatica_themes6`.`issue` LEFT JOIN `class_dramatica_concern` as class_dramatica_concern3 ON `class_dramatica_concern3`.`id`=`class_dramatica_themes6`.`concern` LEFT JOIN `class_dramatica_themes` as class_dramatica_themes7 ON `class_dramatica_themes7`.`id`=`bio_storystatic`.`benchmark` LEFT JOIN `class_dramatica_concern` as class_dramatica_concern4 ON `class_dramatica_concern4`.`id`=`class_dramatica_themes7`.`concern` LEFT JOIN `class_dramatica_domain` as class_dramatica_domain2 ON `class_dramatica_domain2`.`id`=`class_dramatica_themes7`.`domain` LEFT JOIN `class_dramatica_concern` as class_dramatica_concern5 ON `class_dramatica_concern5`.`id`=`bio_storystatic`.`signpost1` LEFT JOIN `class_dramatica_concern` as class_dramatica_concern6 ON `class_dramatica_concern6`.`id`=`bio_storystatic`.`signpost2` LEFT JOIN `class_dramatica_concern` as class_dramatica_concern7 ON `class_dramatica_concern7`.`id`=`bio_storystatic`.`signpost3` LEFT JOIN `class_dramatica_concern` as class_dramatica_concern8 ON `class_dramatica_concern8`.`id`=`bio_storystatic`.`signpost4` ORDER BY 2',
				'os_consequence_domain' => 'SELECT `class_dramatica_domain`.`id`, `class_dramatica_domain`.`domain` FROM `class_dramatica_domain` ORDER BY 2',
				'os_consequence_concern' => 'SELECT `class_dramatica_concern`.`id`, `class_dramatica_concern`.`concern` FROM `class_dramatica_concern` LEFT JOIN `class_dramatica_domain` as class_dramatica_domain1 ON `class_dramatica_domain1`.`id`=`class_dramatica_concern`.`domain` ORDER BY 2',
			...
			'hist_encounter' => [
				'hist_story' => 'SELECT `hist_story`.`id`, IF(CHAR_LENGTH(`hist_story`.`id`) || CHAR_LENGTH(`hist_story`.`story_title`), CONCAT_WS(\'\', `hist_story`.`id`, \'   \', `hist_story`.`story_title`), \'\') FROM `hist_story` LEFT JOIN `hist_team` as hist_team1 ON `hist_team1`.`id`=`hist_story`.`team` LEFT JOIN `hist_author` as hist_author1 ON `hist_author1`.`id`=`hist_story`.`hist_author_id` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`hist_author1`.`agent_id` LEFT JOIN `hist_community` as hist_community1 ON `hist_community1`.`id`=`hist_story`.`community_id` LEFT JOIN `class_bibliography_genre` as class_bibliography_genre1 ON `class_bibliography_genre1`.`id`=`hist_story`.`genre` LEFT JOIN `class_story_collab_type` as class_story_collab_type1 ON `class_story_collab_type1`.`id`=`hist_story`.`collaboration_status` LEFT JOIN `class_language` as class_language1 ON `class_language1`.`id`=`hist_story`.`language` ORDER BY 2',
				'agentA' => 'SELECT `game_agent`.`id`, IF(CHAR_LENGTH(`game_agent`.`id`) || CHAR_LENGTH(`game_agent`.`memberID`), CONCAT_WS(\'\', `game_agent`.`id`, \'   \', `game_agent`.`memberID`), \'\') FROM `game_agent` LEFT JOIN `class_agent_selection` as class_agent_selection1 ON `class_agent_selection1`.`id`=`game_agent`.`selection_class` LEFT JOIN `class_agent_type1` as class_agent_type11 ON `class_agent_type11`.`id`=`game_agent`.`agenttype1` LEFT JOIN `class_agent_type2` as class_agent_type21 ON `class_agent_type21`.`id`=`game_agent`.`agenttype2` LEFT JOIN `class_gender` as class_gender1 ON `class_gender1`.`id`=`game_agent`.`gender` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`game_agent`.`data_evaluation` ORDER BY 2',
				'agent_nameA' => 'SELECT `game_agent`.`id`, IF(CHAR_LENGTH(`game_agent`.`last_name`) || CHAR_LENGTH(`game_agent`.`first_name`), CONCAT_WS(\'\', `game_agent`.`last_name`, \', \', `game_agent`.`first_name`), \'\') FROM `game_agent` LEFT JOIN `class_agent_selection` as class_agent_selection1 ON `class_agent_selection1`.`id`=`game_agent`.`selection_class` LEFT JOIN `class_agent_type1` as class_agent_type11 ON `class_agent_type11`.`id`=`game_agent`.`agenttype1` LEFT JOIN `class_agent_type2` as class_agent_type21 ON `class_agent_type21`.`id`=`game_agent`.`agenttype2` LEFT JOIN `class_gender` as class_gender1 ON `class_gender1`.`id`=`game_agent`.`gender` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`game_agent`.`data_evaluation` ORDER BY 2',
				'bio_storyA' => 'SELECT `bio_story`.`id`, IF(CHAR_LENGTH(`bio_story`.`id`) || CHAR_LENGTH(`bio_story`.`story_title`), CONCAT_WS(\'\', `bio_story`.`id`, \'   \', `bio_story`.`story_title`), \'\') FROM `bio_story` LEFT JOIN `bio_team` as bio_team1 ON `bio_team1`.`id`=`bio_story`.`bio_team` LEFT JOIN `bio_author` as bio_author1 ON `bio_author1`.`id`=`bio_story`.`author_id` LEFT JOIN `class_bibliography_type` as class_bibliography_type1 ON `class_bibliography_type1`.`id`=`bio_story`.`type` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`bio_story`.`agent_id` LEFT JOIN `class_story_collab_type` as class_story_collab_type1 ON `class_story_collab_type1`.`id`=`bio_story`.`collaboration_status` ORDER BY 2',
				'hist_chrA' => 'SELECT `hist_chr`.`id`, IF(CHAR_LENGTH(`hist_chr`.`character_name`) || CHAR_LENGTH(`hist_chr`.`agent_name`), CONCAT_WS(\'\', `hist_chr`.`character_name`, IF(    CHAR_LENGTH(`game_agent3`.`last_name`) || CHAR_LENGTH(`game_agent3`.`first_name`), CONCAT_WS(\'\',   `game_agent3`.`last_name`, \', \', `game_agent3`.`first_name`), \'\')), \'\') FROM `hist_chr` LEFT JOIN `hist_team` as hist_team1 ON `hist_team1`.`id`=`hist_chr`.`team` LEFT JOIN `hist_author` as hist_author1 ON `hist_author1`.`id`=`hist_chr`.`hist_author_id` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`hist_author1`.`agent_id` LEFT JOIN `hist_story` as hist_story1 ON `hist_story1`.`id`=`hist_chr`.`hist_story` LEFT JOIN `game_agent` as game_agent3 ON `game_agent3`.`id`=`hist_chr`.`agent_id` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`hist_chr`.`bio_story` LEFT JOIN `class_dramatica_character` as class_dramatica_character1 ON `class_dramatica_character1`.`id`=`hist_chr`.`story_character` LEFT JOIN `class_dramatica_archetype` as class_dramatica_archetype1 ON `class_dramatica_archetype1`.`id`=`hist_chr`.`story_archetype` ORDER BY 2',
				'bio_chr_sceneA' => 'SELECT `bio_chr_scene`.`id`, IF(CHAR_LENGTH(`bio_chr_scene`.`id`) || CHAR_LENGTH(`bio_chr_scene`.`scene`), CONCAT_WS(\'\', `bio_chr_scene`.`id`, \'   \', `bio_chr_scene`.`scene`), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'bio_impressionA' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(`class_im1`.`impression`), CONCAT_WS(\'\',   `class_im1`.`impression`), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'bio_ntA' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(`class_nt1`.`noetictension`), CONCAT_WS(\'\',   `class_nt1`.`noetictension`), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'bio_counterfactualA' => 'SELECT `bio_chr_scene`.`id`, `bio_chr_scene`.`id` FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'bio_dilemmaA' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(`class_dilemma2`.`defense`), CONCAT_WS(\'\',   `class_dilemma2`.`defense`), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				...
				'enddateA' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(if(`biblio_code_invivo1`.`end_date`,date_format(`biblio_code_invivo1`.`end_date`,\'%d/%m/%Y %H:%i\'),\'\')), CONCAT_WS(\'\',   if(`biblio_code_invivo1`.`end_date`,date_format(`biblio_code_invivo1`.`end_date`,\'%d/%m/%Y %H:%i\'),\'\')), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'sceneA' => 'SELECT `bio_chr_scene`.`id`, IF(CHAR_LENGTH(`bio_chr_scene`.`id`) || CHAR_LENGTH(`bio_chr_scene`.`scene`), CONCAT_WS(\'\', `bio_chr_scene`.`id`, \'   \', `bio_chr_scene`.`scene`), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'agentB' => 'SELECT `game_agent`.`id`, IF(CHAR_LENGTH(`game_agent`.`id`) || CHAR_LENGTH(`game_agent`.`memberID`), CONCAT_WS(\'\', `game_agent`.`id`, \'   \', `game_agent`.`memberID`), \'\') FROM `game_agent` LEFT JOIN `class_agent_selection` as class_agent_selection1 ON `class_agent_selection1`.`id`=`game_agent`.`selection_class` LEFT JOIN `class_agent_type1` as class_agent_type11 ON `class_agent_type11`.`id`=`game_agent`.`agenttype1` LEFT JOIN `class_agent_type2` as class_agent_type21 ON `class_agent_type21`.`id`=`game_agent`.`agenttype2` LEFT JOIN `class_gender` as class_gender1 ON `class_gender1`.`id`=`game_agent`.`gender` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`game_agent`.`data_evaluation` ORDER BY 2',
				'agent_nameB' => 'SELECT `game_agent`.`id`, IF(CHAR_LENGTH(`game_agent`.`last_name`) || CHAR_LENGTH(`game_agent`.`first_name`), CONCAT_WS(\'\', `game_agent`.`last_name`, \', \', `game_agent`.`first_name`), \'\') FROM `game_agent` LEFT JOIN `class_agent_selection` as class_agent_selection1 ON `class_agent_selection1`.`id`=`game_agent`.`selection_class` LEFT JOIN `class_agent_type1` as class_agent_type11 ON `class_agent_type11`.`id`=`game_agent`.`agenttype1` LEFT JOIN `class_agent_type2` as class_agent_type21 ON `class_agent_type21`.`id`=`game_agent`.`agenttype2` LEFT JOIN `class_gender` as class_gender1 ON `class_gender1`.`id`=`game_agent`.`gender` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`game_agent`.`data_evaluation` ORDER BY 2',
				'bio_storyB' => 'SELECT `bio_story`.`id`, IF(CHAR_LENGTH(`bio_story`.`id`) || CHAR_LENGTH(`bio_story`.`story_title`), CONCAT_WS(\'\', `bio_story`.`id`, \'   \', `bio_story`.`story_title`), \'\') FROM `bio_story` LEFT JOIN `bio_team` as bio_team1 ON `bio_team1`.`id`=`bio_story`.`bio_team` LEFT JOIN `bio_author` as bio_author1 ON `bio_author1`.`id`=`bio_story`.`author_id` LEFT JOIN `class_bibliography_type` as class_bibliography_type1 ON `class_bibliography_type1`.`id`=`bio_story`.`type` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`bio_story`.`agent_id` LEFT JOIN `class_story_collab_type` as class_story_collab_type1 ON `class_story_collab_type1`.`id`=`bio_story`.`collaboration_status` ORDER BY 2',
				'hist_chrB' => 'SELECT `hist_chr`.`id`, IF(CHAR_LENGTH(`hist_chr`.`character_name`) || CHAR_LENGTH(`hist_chr`.`story_archetype`), CONCAT_WS(\'\', `hist_chr`.`character_name`, \'   \', IF(    CHAR_LENGTH(`class_dramatica_archetype1`.`archetype`), CONCAT_WS(\'\',   `class_dramatica_archetype1`.`archetype`, \' \'), \'\')), \'\') FROM `hist_chr` LEFT JOIN `hist_team` as hist_team1 ON `hist_team1`.`id`=`hist_chr`.`team` LEFT JOIN `hist_author` as hist_author1 ON `hist_author1`.`id`=`hist_chr`.`hist_author_id` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`hist_author1`.`agent_id` LEFT JOIN `hist_story` as hist_story1 ON `hist_story1`.`id`=`hist_chr`.`hist_story` LEFT JOIN `game_agent` as game_agent3 ON `game_agent3`.`id`=`hist_chr`.`agent_id` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`hist_chr`.`bio_story` LEFT JOIN `class_dramatica_character` as class_dramatica_character1 ON `class_dramatica_character1`.`id`=`hist_chr`.`story_character` LEFT JOIN `class_dramatica_archetype` as class_dramatica_archetype1 ON `class_dramatica_archetype1`.`id`=`hist_chr`.`story_archetype` ORDER BY 2',
				'bio_chr_sceneB' => 'SELECT `bio_chr_scene`.`id`, IF(CHAR_LENGTH(`bio_chr_scene`.`id`) || CHAR_LENGTH(`bio_chr_scene`.`scene`), CONCAT_WS(\'\', `bio_chr_scene`.`id`, \'   \', `bio_chr_scene`.`scene`), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'bio_impressionB' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(`class_im1`.`impression`), CONCAT_WS(\'\',   `class_im1`.`impression`), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'bio_ntB' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(`class_nt1`.`noetictension`), CONCAT_WS(\'\',   `class_nt1`.`noetictension`), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'bio_counterfactualB' => 'SELECT `bio_chr_scene`.`id`, `bio_chr_scene`.`id` FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
				'bio_dilemmaB' => 'SELECT `bio_chr_scene`.`id`, IF(    CHAR_LENGTH(`class_dilemma2`.`defense`), CONCAT_WS(\'\',   `class_dilemma2`.`defense`), \'\') FROM `bio_chr_scene` LEFT JOIN `bio_story` as bio_story1 ON `bio_story1`.`id`=`bio_chr_scene`.`biography` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`bio_chr_scene`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`bio_chr_scene`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`bio_chr_scene`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`bio_chr_scene`.`token` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo1 ON `biblio_code_invivo1`.`id`=`bio_chr_scene`.`invivo_code` LEFT JOIN `biblio_code_invivo` as biblio_code_invivo2 ON `biblio_code_invivo2`.`id`=`bio_chr_scene`.`startdate` LEFT JOIN `bio_code_herme` as bio_code_herme1 ON `bio_code_herme1`.`id`=`bio_chr_scene`.`herme_code` LEFT JOIN `class_character_element` as class_character_element1 ON `class_character_element1`.`id`=`bio_chr_scene`.`chr_element` LEFT JOIN `class_im` as class_im1 ON `class_im1`.`id`=`bio_code_herme1`.`impression` LEFT JOIN `class_nt` as class_nt1 ON `class_nt1`.`id`=`bio_code_herme1`.`noetictension` LEFT JOIN `class_pc` as class_pc1 ON `class_pc1`.`id`=`bio_code_herme1`.`pc` LEFT JOIN `class_counterfactual` as class_counterfactual1 ON `class_counterfactual1`.`id`=`bio_code_herme1`.`counterfactual` LEFT JOIN `class_dilemma` as class_dilemma1 ON `class_dilemma1`.`id`=`bio_code_herme1`.`bio_dilemma` LEFT JOIN `class_dilemma` as class_dilemma2 ON `class_dilemma2`.`id`=`bio_code_herme1`.`bio_dilemma` ORDER BY 2',
			...
			'class_dynamicstorypoints2' => [
				'cat1' => 'SELECT `class_dynamicstorypoints1`.`id`, `class_dynamicstorypoints1`.`term` FROM `class_dynamicstorypoints1` ORDER BY 2',
			],
			'class_dynamicstorypoints3' => [
				'cat1' => 'SELECT `class_dynamicstorypoints1`.`id`, `class_dynamicstorypoints1`.`term` FROM `class_dynamicstorypoints1` ORDER BY 2',
				'cat2' => 'SELECT `class_dynamicstorypoints2`.`id`, `class_dynamicstorypoints2`.`term` FROM `class_dynamicstorypoints2` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints2`.`cat1` ORDER BY 2',
			],
			'class_dynamicstorypoints4' => [
				'cat1' => 'SELECT `class_dynamicstorypoints1`.`id`, `class_dynamicstorypoints1`.`term` FROM `class_dynamicstorypoints1` ORDER BY 2',
				'cat2' => 'SELECT `class_dynamicstorypoints2`.`id`, `class_dynamicstorypoints2`.`term` FROM `class_dynamicstorypoints2` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints2`.`cat1` ORDER BY 2',
				'cat3' => 'SELECT `class_dynamicstorypoints3`.`id`, `class_dynamicstorypoints3`.`term` FROM `class_dynamicstorypoints3` LEFT JOIN `class_dynamicstorypoints1` as class_dynamicstorypoints11 ON `class_dynamicstorypoints11`.`id`=`class_dynamicstorypoints3`.`cat1` LEFT JOIN `class_dynamicstorypoints2` as class_dynamicstorypoints21 ON `class_dynamicstorypoints21`.`id`=`class_dynamicstorypoints3`.`cat2` ORDER BY 2',
			],
			'class_im' => [
			],
			'class_pc' => [
			...
			'class_sdg_intgr' => [
				'sdgA' => 'SELECT `class_sdg`.`id`, IF(CHAR_LENGTH(`class_sdg`.`no`) || CHAR_LENGTH(`class_sdg`.`sdg_topic`), CONCAT_WS(\'\', `class_sdg`.`no`, \'   \', `class_sdg`.`sdg_topic`), \'\') FROM `class_sdg` ORDER BY 2',
				'sdgB' => 'SELECT `class_sdg`.`id`, IF(CHAR_LENGTH(`class_sdg`.`no`) || CHAR_LENGTH(`class_sdg`.`sdg_topic`), CONCAT_WS(\'\', `class_sdg`.`no`, \'   \', `class_sdg`.`sdg_topic`), \'\') FROM `class_sdg` ORDER BY 2',
			],
			'class_goals' => [
			],
			'class_counterfactual' => [
			...
			'assignments' => [
				'ProjectId' => 'SELECT `projects`.`Id`, `projects`.`Name` FROM `projects` LEFT JOIN `hist_community` as hist_community1 ON `hist_community1`.`id`=`projects`.`community` ORDER BY 2',
				'ProjectDuration' => 'SELECT `projects`.`Id`, IF(CHAR_LENGTH(if(`projects`.`StartDate`,date_format(`projects`.`StartDate`,\'%d/%m/%Y %H:%i\'),\'\')) || CHAR_LENGTH(if(`projects`.`EndDate`,date_format(`projects`.`EndDate`,\'%d/%m/%Y %H:%i\'),\'\')), CONCAT_WS(\'\', if(`projects`.`StartDate`,date_format(`projects`.`StartDate`,\'%d/%m/%Y %H:%i\'),\'\'), \' <b>to</b> \', if(`projects`.`EndDate`,date_format(`projects`.`EndDate`,\'%d/%m/%Y %H:%i\'),\'\')), \'\') FROM `projects` LEFT JOIN `hist_community` as hist_community1 ON `hist_community1`.`id`=`projects`.`community` ORDER BY 2',
				'RessourceId' => 'SELECT `resources`.`Id`, IF(    CHAR_LENGTH(`biblio_author1`.`last_name`) || CHAR_LENGTH(`biblio_author1`.`first_name`), CONCAT_WS(\'\',   `biblio_author1`.`last_name`, \', \', `biblio_author1`.`first_name`), \'\') FROM `resources` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`resources`.`agent_id` ORDER BY 2',
				'author_id' => 'SELECT `biblio_author`.`id`, IF(CHAR_LENGTH(`biblio_author`.`id`) || CHAR_LENGTH(`biblio_author`.`author_memberid`), CONCAT_WS(\'\', `biblio_author`.`id`, \'   \', IF(    CHAR_LENGTH(`game_agent1`.`memberID`), CONCAT_WS(\'\',   `game_agent1`.`memberID`), \'\')), \'\') FROM `biblio_author` LEFT JOIN `biblio_team` as biblio_team1 ON `biblio_team1`.`id`=`biblio_author`.`team` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`biblio_author`.`author_id` LEFT JOIN `class_authority_agent` as class_authority_agent1 ON `class_authority_agent1`.`id`=`biblio_author`.`authority_organization` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`biblio_author`.`data_evaluation` ORDER BY 2',
				'author_name' => 'SELECT `biblio_author`.`id`, IF(CHAR_LENGTH(`biblio_author`.`last_name`) || CHAR_LENGTH(`biblio_author`.`first_name`), CONCAT_WS(\'\', IF(    CHAR_LENGTH(`game_agent1`.`last_name`), CONCAT_WS(\'\',   `game_agent1`.`last_name`), \'\'), \', \', IF(    CHAR_LENGTH(`game_agent1`.`first_name`), CONCAT_WS(\'\',   `game_agent1`.`first_name`), \'\')), \'\') FROM `biblio_author` LEFT JOIN `biblio_team` as biblio_team1 ON `biblio_team1`.`id`=`biblio_author`.`team` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`biblio_author`.`author_id` LEFT JOIN `class_authority_agent` as class_authority_agent1 ON `class_authority_agent1`.`id`=`biblio_author`.`authority_organization` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`biblio_author`.`data_evaluation` ORDER BY 2',
				'biblio_doc' => 'SELECT `biblio_doc`.`id`, IF(CHAR_LENGTH(`biblio_doc`.`id`) || CHAR_LENGTH(`biblio_doc`.`title`), CONCAT_WS(\'\', `biblio_doc`.`id`, \'   \', `biblio_doc`.`title`), \'\') FROM `biblio_doc` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`biblio_doc`.`author_id` LEFT JOIN `class_bibliography_type` as class_bibliography_type1 ON `class_bibliography_type1`.`id`=`biblio_doc`.`type` LEFT JOIN `class_bibliography_genre` as class_bibliography_genre1 ON `class_bibliography_genre1`.`id`=`biblio_doc`.`genre` LEFT JOIN `class_bibliography_media` as class_bibliography_media1 ON `class_bibliography_media1`.`id`=`biblio_doc`.`medium` LEFT JOIN `class_language` as class_language1 ON `class_language1`.`id`=`biblio_doc`.`language` LEFT JOIN `class_rights` as class_rights1 ON `class_rights1`.`id`=`biblio_doc`.`rights` LEFT JOIN `class_authority_library` as class_authority_library1 ON `class_authority_library1`.`id`=`biblio_doc`.`authority_organization` LEFT JOIN `biblio_team` as biblio_team1 ON `biblio_team1`.`id`=`biblio_doc`.`team` LEFT JOIN `biblio_analyst` as biblio_analyst1 ON `biblio_analyst1`.`id`=`biblio_doc`.`biblio_lead` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`biblio_doc`.`data_evaluation` ORDER BY 2',
				'biblio_trascript' => 'SELECT `biblio_transcript`.`id`, IF(CHAR_LENGTH(`biblio_transcript`.`id`) || CHAR_LENGTH(`biblio_transcript`.`transcript_title`), CONCAT_WS(\'\', `biblio_transcript`.`id`, \'   \', `biblio_transcript`.`transcript_title`), \'\') FROM `biblio_transcript` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`biblio_transcript`.`author_memberID` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`biblio_transcript`.`bibliography_title` LEFT JOIN `class_rights` as class_rights1 ON `class_rights1`.`id`=`biblio_transcript`.`ip_rights` LEFT JOIN `biblio_team` as biblio_team1 ON `biblio_team1`.`id`=`biblio_transcript`.`team` LEFT JOIN `biblio_analyst` as biblio_analyst1 ON `biblio_analyst1`.`id`=`biblio_transcript`.`biblio_lead` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`biblio_transcript`.`data_evaluation` ORDER BY 2',
				'biblio_token' => 'SELECT `biblio_token`.`id`, IF(CHAR_LENGTH(`biblio_token`.`id`) || CHAR_LENGTH(`biblio_token`.`token`), CONCAT_WS(\'\', `biblio_token`.`id`, \' - \', `biblio_token`.`token`), \'\') FROM `biblio_token` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`biblio_token`.`author_id` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`biblio_token`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`biblio_token`.`transcript` LEFT JOIN `biblio_team` as biblio_team1 ON `biblio_team1`.`id`=`biblio_token`.`team` LEFT JOIN `biblio_analyst` as biblio_analyst1 ON `biblio_analyst1`.`id`=`biblio_token`.`biblio_lead` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`biblio_token`.`data_evaluation` ORDER BY 2',
				'invivio_code' => 'SELECT `biblio_code_invivo`.`id`, IF(CHAR_LENGTH(`biblio_code_invivo`.`id`) || CHAR_LENGTH(`biblio_code_invivo`.`token`), CONCAT_WS(\'\', `biblio_code_invivo`.`id`, \' - \', IF(    CHAR_LENGTH(`biblio_token1`.`token`), CONCAT_WS(\'\',   `biblio_token1`.`token`), \'\')), \'\') FROM `biblio_code_invivo` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`biblio_code_invivo`.`author` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`biblio_code_invivo`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`biblio_code_invivo`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`biblio_code_invivo`.`token_sequence` LEFT JOIN `biblio_team` as biblio_team1 ON `biblio_team1`.`id`=`biblio_code_invivo`.`team` LEFT JOIN `biblio_analyst` as biblio_analyst1 ON `biblio_analyst1`.`id`=`biblio_code_invivo`.`biblio_lead` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`biblio_code_invivo`.`data_evaluation` ORDER BY 2',
				'StartDate' => 'SELECT `biblio_code_invivo`.`id`, if(`biblio_code_invivo`.`start_date`,date_format(`biblio_code_invivo`.`start_date`,\'%d/%m/%Y %H:%i\'),\'\') FROM `biblio_code_invivo` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`biblio_code_invivo`.`author` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`biblio_code_invivo`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`biblio_code_invivo`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`biblio_code_invivo`.`token_sequence` LEFT JOIN `biblio_team` as biblio_team1 ON `biblio_team1`.`id`=`biblio_code_invivo`.`team` LEFT JOIN `biblio_analyst` as biblio_analyst1 ON `biblio_analyst1`.`id`=`biblio_code_invivo`.`biblio_lead` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`biblio_code_invivo`.`data_evaluation` ORDER BY 2',
				'EndDate' => 'SELECT `biblio_code_invivo`.`id`, if(`biblio_code_invivo`.`end_date`,date_format(`biblio_code_invivo`.`end_date`,\'%d/%m/%Y %H:%i\'),\'\') FROM `biblio_code_invivo` LEFT JOIN `biblio_author` as biblio_author1 ON `biblio_author1`.`id`=`biblio_code_invivo`.`author` LEFT JOIN `biblio_doc` as biblio_doc1 ON `biblio_doc1`.`id`=`biblio_code_invivo`.`bibliography` LEFT JOIN `biblio_transcript` as biblio_transcript1 ON `biblio_transcript1`.`id`=`biblio_code_invivo`.`transcript` LEFT JOIN `biblio_token` as biblio_token1 ON `biblio_token1`.`id`=`biblio_code_invivo`.`token_sequence` LEFT JOIN `biblio_team` as biblio_team1 ON `biblio_team1`.`id`=`biblio_code_invivo`.`team` LEFT JOIN `biblio_analyst` as biblio_analyst1 ON `biblio_analyst1`.`id`=`biblio_code_invivo`.`biblio_lead` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`biblio_code_invivo`.`data_evaluation` ORDER BY 2',
			],
			'resources' => [
				'agent_id' => 'SELECT `biblio_author`.`id`, IF(CHAR_LENGTH(`biblio_author`.`id`) || CHAR_LENGTH(`biblio_author`.`author_memberid`), CONCAT_WS(\'\', `biblio_author`.`id`, \'   \', IF(    CHAR_LENGTH(`game_agent1`.`memberID`), CONCAT_WS(\'\',   `game_agent1`.`memberID`), \'\')), \'\') FROM `biblio_author` LEFT JOIN `biblio_team` as biblio_team1 ON `biblio_team1`.`id`=`biblio_author`.`team` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`biblio_author`.`author_id` LEFT JOIN `class_authority_agent` as class_authority_agent1 ON `class_authority_agent1`.`id`=`biblio_author`.`authority_organization` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`biblio_author`.`data_evaluation` ORDER BY 2',
				'Name' => 'SELECT `biblio_author`.`id`, IF(CHAR_LENGTH(`biblio_author`.`last_name`) || CHAR_LENGTH(`biblio_author`.`first_name`), CONCAT_WS(\'\', IF(    CHAR_LENGTH(`game_agent1`.`last_name`), CONCAT_WS(\'\',   `game_agent1`.`last_name`), \'\'), \', \', IF(    CHAR_LENGTH(`game_agent1`.`first_name`), CONCAT_WS(\'\',   `game_agent1`.`first_name`), \'\')), \'\') FROM `biblio_author` LEFT JOIN `biblio_team` as biblio_team1 ON `biblio_team1`.`id`=`biblio_author`.`team` LEFT JOIN `game_agent` as game_agent1 ON `game_agent1`.`id`=`biblio_author`.`author_id` LEFT JOIN `class_authority_agent` as class_authority_agent1 ON `class_authority_agent1`.`id`=`biblio_author`.`authority_organization` LEFT JOIN `class_evaluation` as class_evaluation1 ON `class_evaluation1`.`id`=`biblio_author`.`data_evaluation` ORDER BY 2',
			],
			'projects' => [
				'community' => 'SELECT `hist_community`.`id`, IF(CHAR_LENGTH(`hist_community`.`id`) || CHAR_LENGTH(`hist_community`.`com_name`), CONCAT_WS(\'\', `hist_community`.`id`, \'   \', `hist_community`.`com_name`), \'\') FROM `hist_community` ORDER BY 2',
			],
			'gallery_authors' => [
			],
		];
