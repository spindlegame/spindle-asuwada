...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$table_perms = getTablePermissions('biblio_author');
	...
	switch($mfk) {
		...
		case 'author_id':
			if(!$id) {
				...
				$j('#other_name<?php echo $rnd1; ?>').html('&nbsp;');
				<?php
				break;
			}
			...
			$j('#other_name<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(array("\r", "\n"), '', nl2br($row['other_name']))); ?>&nbsp;');
			<?php
			break;
