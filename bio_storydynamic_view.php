...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$x->QueryFieldsTV = [
		...
		"IF(    CHAR_LENGTH(`bio_chr1`.`character_name`) || CHAR_LENGTH(`bio_chr1`.`agent_name`), CONCAT_WS('',   `bio_chr1`.`character_name`, ' agent:', `bio_chr1`.`agent_name`), '') /* Personaje principal */" => "story_chr_mc",
		...
		"IF(    CHAR_LENGTH(`class_dynamicstorypoints44`.`term`), CONCAT_WS('',   `class_dynamicstorypoints44`.`term`), '') /* Estilo de soluci&#243;n de problemas del MC */" => "mc_ps_style",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern8`.`concern`), CONCAT_WS('',   `class_dramatica_concern8`.`concern`), '') /* Aspecto (Concern) OS */" => "os_goal_concern",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern1`.`concern`), CONCAT_WS('',   `class_dramatica_concern1`.`concern`), '') /* Aspecto de consecuencia OS */" => "os_consequence_concern",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern2`.`concern`), CONCAT_WS('',   `class_dramatica_concern2`.`concern`), '') /* Aspecto de coste OS */" => "os_cost_concern",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern3`.`concern`), CONCAT_WS('',   `class_dramatica_concern3`.`concern`), '') /* Aspecto de dividendo OS */" => "os_dividend_concern",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern4`.`concern`), CONCAT_WS('',   `class_dramatica_concern4`.`concern`), '') /* Aspecto de requisitos OS */" => "os_requirements_concern",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern5`.`concern`), CONCAT_WS('',   `class_dramatica_concern5`.`concern`), '') /* Aspecto de prerequisitos OS */" => "os_prerequesites_concern",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern6`.`concern`), CONCAT_WS('',   `class_dramatica_concern6`.`concern`), '') /* Aspecto de la precondici&#243;n OS */" => "os_preconditions_concern",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern7`.`concern`), CONCAT_WS('',   `class_dramatica_concern7`.`concern`), '') /* Aspecto de la preaviso OS */" => "os_forewarnings_concern",
	];
	...
	$x->SortFields = [
		...
		10 => 10,
		11 => 11,
		12 => '`class_dynamicstorypoints11`.`term`',
		13 => '`class_dynamicstorypoints21`.`term`',
		14 => '`class_dynamicstorypoints31`.`term`',
		15 => '`class_dynamicstorypoints46`.`term`',
		16 => '`class_dynamicstorypoints32`.`term`',
		17 => '`class_dynamicstorypoints47`.`term`',
		18 => '`class_dynamicstorypoints33`.`term`',
		19 => '`class_dynamicstorypoints48`.`term`',
		20 => '`class_dynamicstorypoints34`.`term`',
	...
	$x->QueryFieldsFilters = [
		...
		"IF(    CHAR_LENGTH(`bio_chr1`.`character_name`) || CHAR_LENGTH(`bio_chr1`.`agent_name`), CONCAT_WS('',   `bio_chr1`.`character_name`, ' agent:', `bio_chr1`.`agent_name`), '') /* Personaje principal */" => "Personaje principal",
		...
		"IF(    CHAR_LENGTH(`class_dynamicstorypoints44`.`term`), CONCAT_WS('',   `class_dynamicstorypoints44`.`term`), '') /* Estilo de soluci&#243;n de problemas del MC */" => "Estilo de soluci&#243;n de problemas del MC",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern8`.`concern`), CONCAT_WS('',   `class_dramatica_concern8`.`concern`), '') /* Aspecto (Concern) OS */" => "Aspecto (Concern) OS",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern1`.`concern`), CONCAT_WS('',   `class_dramatica_concern1`.`concern`), '') /* Aspecto de consecuencia OS */" => "Aspecto de consecuencia OS",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern2`.`concern`), CONCAT_WS('',   `class_dramatica_concern2`.`concern`), '') /* Aspecto de coste OS */" => "Aspecto de coste OS",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern3`.`concern`), CONCAT_WS('',   `class_dramatica_concern3`.`concern`), '') /* Aspecto de dividendo OS */" => "Aspecto de dividendo OS",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern4`.`concern`), CONCAT_WS('',   `class_dramatica_concern4`.`concern`), '') /* Aspecto de requisitos OS */" => "Aspecto de requisitos OS",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern5`.`concern`), CONCAT_WS('',   `class_dramatica_concern5`.`concern`), '') /* Aspecto de prerequisitos OS */" => "Aspecto de prerequisitos OS",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern6`.`concern`), CONCAT_WS('',   `class_dramatica_concern6`.`concern`), '') /* Aspecto de la precondici&#243;n OS */" => "Aspecto de la precondici&#243;n OS",
		...
		"IF(    CHAR_LENGTH(`class_dramatica_concern7`.`concern`), CONCAT_WS('',   `class_dramatica_concern7`.`concern`), '') /* Aspecto de la preaviso OS */" => "Aspecto de la preaviso OS",
	];
