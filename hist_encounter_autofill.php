...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$table_perms = getTablePermissions('hist_encounter');
	...
	switch($mfk) {
		...
		case 'agentA':
			if(!$id) {
				?>
				$j('#agent_nameA<?php echo $rnd1; ?>').html('&nbsp;');
				$j('#agent_nameB<?php echo $rnd1; ?>').html('&nbsp;');
				<?php
				break;
			}
			...
			?>
			$j('#agent_nameA<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(array("\r", "\n"), '', nl2br($row['last_name'].', '.$row['first_name']))); ?>&nbsp;');
			$j('#agent_nameB<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(array("\r", "\n"), '', nl2br($row['last_name'].', '.$row['first_name']))); ?>&nbsp;');
			<?php
			break;
