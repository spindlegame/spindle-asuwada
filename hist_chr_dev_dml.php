...
function hist_chr_dev_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = '') {
	...
	if($filterer_illust_resolve && !$filterer_agent_name) $filterer_agent_name = sqlValue("select character from hist_chr_scene where id='" . makeSafe($filterer_illust_resolve) . "'");
	...
	if($filterer_illust_growth && !$filterer_agent_name) $filterer_agent_name = sqlValue("select character from hist_chr_scene where id='" . makeSafe($filterer_illust_growth) . "'");
	...
	if($filterer_illust_approach && !$filterer_agent_name) $filterer_agent_name = sqlValue("select character from hist_chr_scene where id='" . makeSafe($filterer_illust_approach) . "'");
	...
	if($filterer_dp3_psstyle && !$filterer_dp1_resolve) $filterer_dp1_resolve = sqlValue("select cat1 from class_dramatica_storypoints3 where id='" . makeSafe($filterer_dp3_psstyle) . "'");
	if($filterer_dp3_psstyle && !$filterer_dp2_resolve) $filterer_dp2_resolve = sqlValue("select cat2 from class_dramatica_storypoints3 where id='" . makeSafe($filterer_dp3_psstyle) . "'");
	...
	if($filterer_illust_ps_style && !$filterer_agent_name) $filterer_agent_name = sqlValue("select character from hist_chr_scene where id='" . makeSafe($filterer_illust_ps_style) . "'");
	...
	if($filterer_illust_nt && !$filterer_agent_name) $filterer_agent_name = sqlValue("select character from hist_chr_scene where id='" . makeSafe($filterer_illust_nt) . "'");
	...
	if($filterer_illust_im && !$filterer_agent_name) $filterer_agent_name = sqlValue("select character from hist_chr_scene where id='" . makeSafe($filterer_illust_im) . "'");
	...
	if($filterer_illust_mcs_problem && !$filterer_agent_name) $filterer_agent_name = sqlValue("select character from hist_chr_scene where id='" . makeSafe($filterer_illust_mcs_problem) . "'");
	...
	if($filterer_illust_mcs_solution && !$filterer_agent_name) $filterer_agent_name = sqlValue("select character from hist_chr_scene where id='" . makeSafe($filterer_illust_mcs_solution) . "'");
	...
	if($filterer_illust_mcs_symptom && !$filterer_agent_name) $filterer_agent_name = sqlValue("select character from hist_chr_scene where id='" . makeSafe($filterer_illust_mcs_symptom) . "'");
	...
	if($filterer_illust_mcs_response && !$filterer_agent_name) $filterer_agent_name = sqlValue("select character from hist_chr_scene where id='" . makeSafe($filterer_illust_mcs_response) . "'");
	...
	// combobox: illust_resolve, filterable by: agent_name,hist_story
	...
	// combobox: illust_growth, filterable by: agent_name,hist_story
	...
	// combobox: illust_approach, filterable by: agent_name,hist_story
	...
	// combobox: illust_ps_style, filterable by: agent_name,hist_story
	$combo_illust_ps_style = new DataCombo;
	// combobox: noetictension
	$combo_noetictension = new DataCombo;
	// combobox: illust_nt, filterable by: agent_name,hist_story
	$combo_illust_nt = new DataCombo;
	// combobox: impression
	$combo_impression = new DataCombo;
	// combobox: illust_im, filterable by: agent_name,hist_story
	$combo_illust_im = new DataCombo;
	// combobox: mcs_problem
	$combo_mcs_problem = new DataCombo;
	// combobox: illust_mcs_problem, filterable by: agent_name,hist_story
	$combo_illust_mcs_problem = new DataCombo;
	// combobox: illust_mcs_solution, filterable by: agent_name,hist_story
	$combo_illust_mcs_solution = new DataCombo;
	// combobox: illust_mcs_symptom, filterable by: agent_name,hist_story
	...
	<script>
		...
		jQuery(function() {
			setTimeout(function() {
				...
				<?php echo (!$AllowUpdate || $dvprint ? 'if(typeof(illust_resolve_reload__RAND__) == \'function\') illust_resolve_reload__RAND__(AppGini.current_agent_name__RAND__.value, AppGini.current_hist_story__RAND__.value);' : ''); ?>
				...
				<?php echo (!$AllowUpdate || $dvprint ? 'if(typeof(illust_growth_reload__RAND__) == \'function\') illust_growth_reload__RAND__(AppGini.current_agent_name__RAND__.value, AppGini.current_hist_story__RAND__.value);' : ''); ?>
				...
				<?php echo (!$AllowUpdate || $dvprint ? 'if(typeof(illust_approach_reload__RAND__) == \'function\') illust_approach_reload__RAND__(AppGini.current_agent_name__RAND__.value, AppGini.current_hist_story__RAND__.value);' : ''); ?>
				...
				<?php echo (!$AllowUpdate || $dvprint ? 'if(typeof(illust_ps_style_reload__RAND__) == \'function\') illust_ps_style_reload__RAND__(AppGini.current_agent_name__RAND__.value, AppGini.current_hist_story__RAND__.value);' : ''); ?>
				if(typeof(noetictension_reload__RAND__) == 'function') noetictension_reload__RAND__();
				<?php echo (!$AllowUpdate || $dvprint ? 'if(typeof(illust_nt_reload__RAND__) == \'function\') illust_nt_reload__RAND__(AppGini.current_agent_name__RAND__.value, AppGini.current_hist_story__RAND__.value);' : ''); ?>
				if(typeof(impression_reload__RAND__) == 'function') impression_reload__RAND__();
				<?php echo (!$AllowUpdate || $dvprint ? 'if(typeof(illust_im_reload__RAND__) == \'function\') illust_im_reload__RAND__(AppGini.current_agent_name__RAND__.value, AppGini.current_hist_story__RAND__.value);' : ''); ?>
				if(typeof(mcs_problem_reload__RAND__) == 'function') mcs_problem_reload__RAND__();
				<?php echo (!$AllowUpdate || $dvprint ? 'if(typeof(illust_mcs_problem_reload__RAND__) == \'function\') illust_mcs_problem_reload__RAND__(AppGini.current_agent_name__RAND__.value, AppGini.current_hist_story__RAND__.value);' : ''); ?>
				<?php echo (!$AllowUpdate || $dvprint ? 'if(typeof(illust_mcs_solution_reload__RAND__) == \'function\') illust_mcs_solution_reload__RAND__(AppGini.current_agent_name__RAND__.value, AppGini.current_hist_story__RAND__.value);' : ''); ?>
				<?php echo (!$AllowUpdate || $dvprint ? 'if(typeof(illust_mcs_symptom_reload__RAND__) == \'function\') illust_mcs_symptom_reload__RAND__(AppGini.current_agent_name__RAND__.value, AppGini.current_hist_story__RAND__.value);' : ''); ?>
			...
			$j("#agent_name-container__RAND__").select2({
				...
				initSelection: function(e, c) {
					$j.ajax({
						...
						if(typeof(illust_resolve_reload__RAND__) == 'function') illust_resolve_reload__RAND__(AppGini.current_agent_name__RAND__.value, $j('#hist_story').val());
						if(typeof(illust_growth_reload__RAND__) == 'function') illust_growth_reload__RAND__(AppGini.current_agent_name__RAND__.value, $j('#hist_story').val());
						if(typeof(illust_approach_reload__RAND__) == 'function') illust_approach_reload__RAND__(AppGini.current_agent_name__RAND__.value, $j('#hist_story').val());
						if(typeof(illust_ps_style_reload__RAND__) == 'function') illust_ps_style_reload__RAND__(AppGini.current_agent_name__RAND__.value, $j('#hist_story').val());
						if(typeof(illust_nt_reload__RAND__) == 'function') illust_nt_reload__RAND__(AppGini.current_agent_name__RAND__.value, $j('#hist_story').val());
						if(typeof(illust_im_reload__RAND__) == 'function') illust_im_reload__RAND__(AppGini.current_agent_name__RAND__.value, $j('#hist_story').val());
						if(typeof(illust_mcs_problem_reload__RAND__) == 'function') illust_mcs_problem_reload__RAND__(AppGini.current_agent_name__RAND__.value, $j('#hist_story').val());
						if(typeof(illust_mcs_solution_reload__RAND__) == 'function') illust_mcs_solution_reload__RAND__(AppGini.current_agent_name__RAND__.value, $j('#hist_story').val());
						if(typeof(illust_mcs_symptom_reload__RAND__) == 'function') illust_mcs_symptom_reload__RAND__(AppGini.current_agent_name__RAND__.value, $j('#hist_story').val());
		...
		function illust_resolve_reload__RAND__(filterer_agent_name, filterer_hist_story) {
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint) { ?>
			...
			$j("#illust_resolve-container__RAND__").select2({
				...
				initSelection: function(e, c) {
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { filterer_agent_name: filterer_agent_name, filterer_hist_story: filterer_hist_story, id: AppGini.current_illust_resolve__RAND__.value, t: 'hist_chr_dev', f: 'illust_resolve' },
						success: function(resp) {
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page) { return { filterer_agent_name: filterer_agent_name, filterer_hist_story: filterer_hist_story, s: term, p: page, t: 'hist_chr_dev', f: 'illust_resolve' }; },
					results: function(resp, page) { return resp; }
				},
				escapeMarkup: function(str) { return str; }
			}).on('change', function(e) {
		...
		function illust_growth_reload__RAND__(filterer_agent_name, filterer_hist_story) {
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint) { ?>
			...
			$j("#illust_growth-container__RAND__").select2({
				...
				initSelection: function(e, c) {
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { filterer_agent_name: filterer_agent_name, filterer_hist_story: filterer_hist_story, id: AppGini.current_illust_growth__RAND__.value, t: 'hist_chr_dev', f: 'illust_growth' },
						success: function(resp) {
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page) { return { filterer_agent_name: filterer_agent_name, filterer_hist_story: filterer_hist_story, s: term, p: page, t: 'hist_chr_dev', f: 'illust_growth' }; },
					results: function(resp, page) { return resp; }
				},
				escapeMarkup: function(str) { return str; }
			}).on('change', function(e) {
		...
		function illust_approach_reload__RAND__(filterer_agent_name, filterer_hist_story) {
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint) { ?>
			...
			$j("#illust_approach-container__RAND__").select2({
				...
				initSelection: function(e, c) {
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { filterer_agent_name: filterer_agent_name, filterer_hist_story: filterer_hist_story, id: AppGini.current_illust_approach__RAND__.value, t: 'hist_chr_dev', f: 'illust_approach' },
						success: function(resp) {
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page) { return { filterer_agent_name: filterer_agent_name, filterer_hist_story: filterer_hist_story, s: term, p: page, t: 'hist_chr_dev', f: 'illust_approach' }; },
					results: function(resp, page) { return resp; }
				},
				escapeMarkup: function(str) { return str; }
			}).on('change', function(e) {
		...
		function illust_ps_style_reload__RAND__(filterer_agent_name, filterer_hist_story) {
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint) { ?>
			...
			$j("#illust_ps_style-container__RAND__").select2({
				...
				initSelection: function(e, c) {
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { filterer_agent_name: filterer_agent_name, filterer_hist_story: filterer_hist_story, id: AppGini.current_illust_ps_style__RAND__.value, t: 'hist_chr_dev', f: 'illust_ps_style' },
						success: function(resp) {
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page) { return { filterer_agent_name: filterer_agent_name, filterer_hist_story: filterer_hist_story, s: term, p: page, t: 'hist_chr_dev', f: 'illust_ps_style' }; },
					results: function(resp, page) { return resp; }
				},
				escapeMarkup: function(str) { return str; }
			}).on('change', function(e) {
		...
		function illust_nt_reload__RAND__(filterer_agent_name, filterer_hist_story) {
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint) { ?>
			...
			$j("#illust_nt-container__RAND__").select2({
				...
				initSelection: function(e, c) {
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { filterer_agent_name: filterer_agent_name, filterer_hist_story: filterer_hist_story, id: AppGini.current_illust_nt__RAND__.value, t: 'hist_chr_dev', f: 'illust_nt' },
						success: function(resp) {
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page) { return { filterer_agent_name: filterer_agent_name, filterer_hist_story: filterer_hist_story, s: term, p: page, t: 'hist_chr_dev', f: 'illust_nt' }; },
					results: function(resp, page) { return resp; }
				},
				escapeMarkup: function(str) { return str; }
			}).on('change', function(e) {
		...
		function illust_im_reload__RAND__(filterer_agent_name, filterer_hist_story) {
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint) { ?>
			...
			$j("#illust_im-container__RAND__").select2({
				...
				initSelection: function(e, c) {
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { filterer_agent_name: filterer_agent_name, filterer_hist_story: filterer_hist_story, id: AppGini.current_illust_im__RAND__.value, t: 'hist_chr_dev', f: 'illust_im' },
						success: function(resp) {
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page) { return { filterer_agent_name: filterer_agent_name, filterer_hist_story: filterer_hist_story, s: term, p: page, t: 'hist_chr_dev', f: 'illust_im' }; },
					results: function(resp, page) { return resp; }
				},
				escapeMarkup: function(str) { return str; }
			}).on('change', function(e) {
		...
		function illust_mcs_problem_reload__RAND__(filterer_agent_name, filterer_hist_story) {
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint) { ?>
			...
			$j("#illust_mcs_problem-container__RAND__").select2({
				...
				initSelection: function(e, c) {
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { filterer_agent_name: filterer_agent_name, filterer_hist_story: filterer_hist_story, id: AppGini.current_illust_mcs_problem__RAND__.value, t: 'hist_chr_dev', f: 'illust_mcs_problem' },
						success: function(resp) {
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page) { return { filterer_agent_name: filterer_agent_name, filterer_hist_story: filterer_hist_story, s: term, p: page, t: 'hist_chr_dev', f: 'illust_mcs_problem' }; },
					results: function(resp, page) { return resp; }
				},
				escapeMarkup: function(str) { return str; }
			}).on('change', function(e) {
		...
		function illust_mcs_solution_reload__RAND__(filterer_agent_name, filterer_hist_story) {
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint) { ?>
			...
			$j("#illust_mcs_solution-container__RAND__").select2({
				...
				initSelection: function(e, c) {
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { filterer_agent_name: filterer_agent_name, filterer_hist_story: filterer_hist_story, id: AppGini.current_illust_mcs_solution__RAND__.value, t: 'hist_chr_dev', f: 'illust_mcs_solution' },
						success: function(resp) {
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page) { return { filterer_agent_name: filterer_agent_name, filterer_hist_story: filterer_hist_story, s: term, p: page, t: 'hist_chr_dev', f: 'illust_mcs_solution' }; },
					results: function(resp, page) { return resp; }
				},
				escapeMarkup: function(str) { return str; }
			}).on('change', function(e) {
		...
		function illust_mcs_symptom_reload__RAND__(filterer_agent_name, filterer_hist_story) {
		<?php if(($AllowUpdate || $AllowInsert) && !$dvprint) { ?>
			...
			$j("#illust_mcs_symptom-container__RAND__").select2({
				...
				initSelection: function(e, c) {
					$j.ajax({
						url: 'ajax_combo.php',
						dataType: 'json',
						data: { filterer_agent_name: filterer_agent_name, filterer_hist_story: filterer_hist_story, id: AppGini.current_illust_mcs_symptom__RAND__.value, t: 'hist_chr_dev', f: 'illust_mcs_symptom' },
						success: function(resp) {
							c({
								id: resp.results[0].id,
								text: resp.results[0].text
				...
				ajax: {
					...
					dataType: 'json',
					cache: true,
					data: function(term, page) { return { filterer_agent_name: filterer_agent_name, filterer_hist_story: filterer_hist_story, s: term, p: page, t: 'hist_chr_dev', f: 'illust_mcs_symptom' }; },
					results: function(resp, page) { return resp; }
				},
				escapeMarkup: function(str) { return str; }
			}).on('change', function(e) {
	...
	$lookup_fields = array('hist_story' => array('hist_story', 'Hist story'), 'bio_story' => array('bio_story', 'Bio story'), 'agent_id' => array('biblio_author', 'MemberID'), 'agent_name' => array('hist_chr', 'Agent name'), 'cw_name' => array('hist_chr', 'Cw name'), 'dp1_resolve' => array('class_dramatica_storypoints1', 'Dynamic point cat1'), 'dp2_resolve' => array('class_dramatica_storypoints2', 'Dynamic point cat2'), 'dp3_resolve' => array('class_dramatica_storypoints3', 'Dynamic point cat3'), 'mc_resolve' => array('class_dynamicstorypoints4', 'MC resolve'), 'illust_resolve' => array('hist_chr_scene', 'Illustration of MC Resolve'), 'dp3_growth' => array('class_dramatica_storypoints3', 'Dynamic point cat3'), 'mc_growth' => array('class_dynamicstorypoints4', 'Growth'), 'illust_growth' => array('hist_chr_scene', 'Illustration of MC Growth'), 'dp3_approach' => array('class_dramatica_storypoints3', 'Dynamic point cat3'), 'mc_approach' => array('class_dynamicstorypoints4', 'Approach'), 'illust_approach' => array('hist_chr_scene', 'Illustration of MC Approach'), 'dp3_psstyle' => array('class_dramatica_storypoints3', 'Dynamic point cat3'), 'mc_ps_style' => array('class_dynamicstorypoints4', 'Problem Solving Style'), 'illust_ps_style' => array('hist_chr_scene', 'Illustration of MC PS Style'), 'noetictension' => array('class_nt', 'Noetic tension'), 'illust_nt' => array('hist_chr_scene', 'Illustration of Noetic Tension'), 'impression' => array('class_im', 'Overall Impression Management'), 'illust_im' => array('hist_chr_scene', 'Illustration of Impression Mnmt.'), 'mcs_problem' => array('hist_storystatic', 'Problem'), 'illust_mcs_problem' => array('hist_chr_scene', 'Illustration of MCS Problem'), 'illust_mcs_solution' => array('hist_chr_scene', 'Illustration of MCS Solution'), 'illust_mcs_symptom' => array('hist_chr_scene', 'Illustration of MCS Symptome'), 'illust_mcs_response' => array('hist_chr_scene', 'Illustration of MCS Response'), );
