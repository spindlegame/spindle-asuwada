...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$table_perms = getTablePermissions('hist_chr');
	...
	switch($mfk) {
		...
		case 'hist_author_id':
			if(!$id) {
				?>
				$j('#hist_author_memberid<?php echo $rnd1; ?>').html('&nbsp;');
			...
			?>
			$j('#hist_author_memberid<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(array("\r", "\n"), '', nl2br($row['last_name'].''.$row['first_name']))); ?>&nbsp;');
