<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_authority_agent' table. 
	...
	*/
	...
	function class_authority_agent_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function class_authority_agent_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function class_authority_agent_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function class_authority_agent_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_authority_agent_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function class_authority_agent_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_authority_agent_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function class_authority_agent_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function class_authority_agent_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function class_authority_agent_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function class_authority_agent_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function class_authority_agent_batch_actions(&$args){
