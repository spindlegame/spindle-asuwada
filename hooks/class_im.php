<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_im' table. 
	...
	*/
	...
	function class_im_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function class_im_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function class_im_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['impression'], $data['description'], $data['category']
	...
	*/
	...
	function class_im_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_im_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['impression'], $data['description'], $data['category']
	...
	*/
	...
	function class_im_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_im_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_im_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function class_im_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function class_im_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function class_im_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function class_im_batch_actions(&$args) {
