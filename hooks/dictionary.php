<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'dictionary' table. 
	...
	*/
	...
	function dictionary_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function dictionary_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function dictionary_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function dictionary_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function dictionary_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['term'], $data['definition']
	...
	*/
	...
	function dictionary_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function dictionary_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function dictionary_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function dictionary_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function dictionary_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function dictionary_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function dictionary_batch_actions(&$args){
