<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_bibliography_genre' table. 
	...
	*/
	...
	function class_bibliography_genre_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function class_bibliography_genre_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function class_bibliography_genre_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function class_bibliography_genre_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_bibliography_genre_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['genre'], $data['description']
	...
	*/
	...
	function class_bibliography_genre_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_bibliography_genre_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function class_bibliography_genre_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function class_bibliography_genre_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function class_bibliography_genre_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function class_bibliography_genre_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function class_bibliography_genre_batch_actions(&$args){
