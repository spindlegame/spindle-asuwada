<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'ecounter_analyst' table. 
	...
	*/
	...
	function ecounter_analyst_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function ecounter_analyst_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function ecounter_analyst_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function ecounter_analyst_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function ecounter_analyst_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function ecounter_analyst_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function ecounter_analyst_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function ecounter_analyst_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function ecounter_analyst_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function ecounter_analyst_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function ecounter_analyst_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function ecounter_analyst_batch_actions(&$args) {
