<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'biblio_team' table. 
	...
	*/
	...
	function biblio_team_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_team_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function biblio_team_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function biblio_team_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_team_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_team_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_team_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_team_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_team_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_team_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function biblio_team_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_team_batch_actions(&$args) {
