<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'hist_chr_scenes' table. 
	...
	*/
	...
	function hist_chr_scenes_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function hist_chr_scenes_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function hist_chr_scenes_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['author_id'], $data['author_name'], $data['hist_story'], $data['character'], $data['agent_id'], $data['agent_name'], $data['bio_story'], $data['bio_storyline_no'], $data['bio_storyline_text'], $data['chr_element'], $data['scene'], $data['illustration'], $data['comment']
	...
	*/
	...
	function hist_chr_scenes_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_chr_scenes_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['author_id'], $data['author_name'], $data['hist_story'], $data['character'], $data['agent_id'], $data['agent_name'], $data['bio_story'], $data['bio_storyline_no'], $data['bio_storyline_text'], $data['chr_element'], $data['scene'], $data['illustration'], $data['comment']
	...
	*/
	...
	function hist_chr_scenes_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_chr_scenes_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_chr_scenes_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function hist_chr_scenes_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function hist_chr_scenes_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function hist_chr_scenes_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function hist_chr_scenes_batch_actions(&$args) {
