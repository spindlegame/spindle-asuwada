<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_dramatica_signpost' table. 
	...
	*/
	...
	function class_dramatica_signpost_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function class_dramatica_signpost_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function class_dramatica_signpost_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function class_dramatica_signpost_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dramatica_signpost_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dramatica_signpost_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dramatica_signpost_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dramatica_signpost_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function class_dramatica_signpost_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function class_dramatica_signpost_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function class_dramatica_signpost_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function class_dramatica_signpost_batch_actions(&$args) {
