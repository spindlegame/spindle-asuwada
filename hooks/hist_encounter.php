<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'hist_encounter' table. 
	...
	*/
	...
	function hist_encounter_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounter_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function hist_encounter_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['hist_story'], $data['agentA'], $data['agent_nameA'], $data['bio_story'], $data['hist_chrA'], $data['bio_chr_sceneA'], $data['bio_impressionA'], $data['bio_ntA'], $data['bio_counterfactualA'], $data['bio_defenseA'], $data['bio_sdgA'], $data['startdateA'], $data['enddateA'], $data['sceneA'], $data['agentB'], $data['agent_nameB'], $data['bio_storyB'], $data['hist_chrB'], $data['bio_chr_sceneB'], $data['bio_impressionB'], $data['bio_ntB'], $data['bio_counterfactualB'], $data['bio_defenseB'], $data['bio_sdgB'], $data['startdateB'], $data['enddateB'], $data['relation_description'], $data['type'], $data['conflicttype'], $data['sdg_intgr'], $data['story_scene'], $data['nd_color'], $data['nd_width'], $data['nd_style'], $data['nd_opacity'], $data['nd_visibility'], $data['lbl_lable'], $data['lbl_color'], $data['lbl_size'], $data['encounter_analyst']
	...
	*/
	...
	function hist_encounter_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounter_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['hist_story'], $data['agentA'], $data['agent_nameA'], $data['bio_story'], $data['hist_chrA'], $data['bio_chr_sceneA'], $data['bio_impressionA'], $data['bio_ntA'], $data['bio_counterfactualA'], $data['bio_defenseA'], $data['bio_sdgA'], $data['startdateA'], $data['enddateA'], $data['sceneA'], $data['agentB'], $data['agent_nameB'], $data['bio_storyB'], $data['hist_chrB'], $data['bio_chr_sceneB'], $data['bio_impressionB'], $data['bio_ntB'], $data['bio_counterfactualB'], $data['bio_defenseB'], $data['bio_sdgB'], $data['startdateB'], $data['enddateB'], $data['relation_description'], $data['type'], $data['conflicttype'], $data['sdg_intgr'], $data['story_scene'], $data['nd_color'], $data['nd_width'], $data['nd_style'], $data['nd_opacity'], $data['nd_visibility'], $data['lbl_lable'], $data['lbl_color'], $data['lbl_size'], $data['encounter_analyst']
	...
	*/
	...
	function hist_encounter_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounter_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounter_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounter_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounter_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function hist_encounter_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounter_batch_actions(&$args) {
