<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'hist_story_chr' table. 
	...
	*/
	...
	function hist_story_chr_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function hist_story_chr_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function hist_story_chr_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['team'], $data['hist_lead_id'], $data['hist_lead_name'], $data['hist_story'], $data['agent_id'], $data['agent_name'], $data['bio_story'], $data['story_character'], $data['story_archetype'], $data['role'], $data['comment']
	...
	*/
	...
	function hist_story_chr_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['team'], $data['hist_lead_id'], $data['hist_lead_memberid'], $data['hist_lead_name'], $data['hist_story'], $data['agent_id'], $data['agent_name'], $data['bio_story'], $data['story_character'], $data['story_archetype'], $data['role'], $data['comment']
	...
	*/
	...
	function hist_story_chr_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['team'], $data['hist_lead_id'], $data['hist_lead_name'], $data['hist_story'], $data['agent_id'], $data['agent_name'], $data['bio_story'], $data['story_character'], $data['story_archetype'], $data['role'], $data['comment']
	...
	*/
	...
	function hist_story_chr_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['team'], $data['hist_lead_id'], $data['hist_lead_memberid'], $data['hist_lead_name'], $data['hist_story'], $data['agent_id'], $data['agent_name'], $data['bio_story'], $data['story_character'], $data['story_archetype'], $data['role'], $data['comment']
	...
	*/
	...
	function hist_story_chr_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_story_chr_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function hist_story_chr_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function hist_story_chr_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function hist_story_chr_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function hist_story_chr_batch_actions(&$args) {
