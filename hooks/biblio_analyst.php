<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'biblio_analyst' table. 
	...
	*/
	...
	function biblio_analyst_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_analyst_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function biblio_analyst_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['team'], $data['author_id'], $data['last_name'], $data['first_name'], $data['other_name']
	...
	*/
	...
	function biblio_analyst_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['team'], $data['author_id'], $data['author_memberid'], $data['last_name'], $data['first_name'], $data['other_name']
	...
	*/
	...
	function biblio_analyst_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['team'], $data['author_id'], $data['last_name'], $data['first_name'], $data['other_name']
	...
	*/
	...
	function biblio_analyst_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['team'], $data['author_id'], $data['author_memberid'], $data['last_name'], $data['first_name'], $data['other_name']
	...
	*/
	...
	function biblio_analyst_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_analyst_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_analyst_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_analyst_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function biblio_analyst_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_analyst_batch_actions(&$args) {
