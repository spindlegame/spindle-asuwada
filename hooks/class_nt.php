<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_nt' table. 
	...
	*/
	...
	function class_nt_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function class_nt_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function class_nt_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['noetictension'], $data['description']
	...
	*/
	...
	function class_nt_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_nt_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['noetictension'], $data['description']
	...
	*/
	...
	function class_nt_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_nt_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_nt_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function class_nt_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function class_nt_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function class_nt_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function class_nt_batch_actions(&$args) {
