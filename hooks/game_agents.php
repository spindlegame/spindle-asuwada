<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'game_agents' table. 
	...
	*/
	...
	function game_agents_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function game_agents_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function game_agents_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function game_agents_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function game_agents_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function game_agents_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function game_agents_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function game_agents_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function game_agents_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function game_agents_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function game_agents_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function game_agents_batch_actions(&$args){
