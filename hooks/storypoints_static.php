<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'storypoints_static' table. 
	...
	*/
	...
	function storypoints_static_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function storypoints_static_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function storypoints_static_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['story'], $data['throughline'], $data['throughline_domain'], $data['concern'], $data['issue'], $data['problem'], $data['solution'], $data['symptom'], $data['response'], $data['catalyst'], $data['inhibitor'], $data['benchmark']
	...
	*/
	...
	function storypoints_static_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function storypoints_static_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['story'], $data['throughline'], $data['throughline_domain'], $data['concern'], $data['issue'], $data['problem'], $data['solution'], $data['symptom'], $data['response'], $data['catalyst'], $data['inhibitor'], $data['benchmark']
	...
	*/
	...
	function storypoints_static_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function storypoints_static_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function storypoints_static_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function storypoints_static_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function storypoints_static_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function storypoints_static_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function storypoints_static_batch_actions(&$args){
