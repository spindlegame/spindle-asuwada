<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'bio_storyweaving_scenes' table. 
	...
	*/
	...
	function bio_storyweaving_scenes_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function bio_storyweaving_scenes_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function bio_storyweaving_scenes_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function bio_storyweaving_scenes_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function bio_storyweaving_scenes_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function bio_storyweaving_scenes_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function bio_storyweaving_scenes_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function bio_storyweaving_scenes_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function bio_storyweaving_scenes_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function bio_storyweaving_scenes_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function bio_storyweaving_scenes_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function bio_storyweaving_scenes_batch_actions(&$args){
