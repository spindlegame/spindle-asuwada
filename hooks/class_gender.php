<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_gender' table. 
	...
	*/
	...
	function class_gender_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function class_gender_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function class_gender_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function class_gender_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_gender_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function class_gender_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_gender_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function class_gender_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function class_gender_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function class_gender_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function class_gender_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function class_gender_batch_actions(&$args){
