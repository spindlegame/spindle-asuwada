<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_bibliography_type' table. 
	...
	*/
	...
	function class_bibliography_type_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function class_bibliography_type_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function class_bibliography_type_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function class_bibliography_type_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_bibliography_type_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_bibliography_type_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_bibliography_type_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_bibliography_type_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function class_bibliography_type_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function class_bibliography_type_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function class_bibliography_type_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function class_bibliography_type_batch_actions(&$args) {
