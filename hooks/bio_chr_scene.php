<?php
	...
	*/
	 ...
	 *     $data['biography'], $data['author_id'], $data['author_name'], $data['bibliography'], $data['transcript'], $data['token_sequence'], $data['token'], $data['invivo_code'], $data['startdate'], $data['enddate'], $data['person'], $data['place'], $data['herme_code'], $data['impression'], $data['noetictension'], $data['pc'], $data['counterfactual'], $data['defense'], $data['sdg'], $data['chr_element'], $data['comment'], $data['illustration'], $data['scene']
