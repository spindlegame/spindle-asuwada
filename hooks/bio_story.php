<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'bio_story' table. 
	...
	*/
	...
	function bio_story_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function bio_story_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function bio_story_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['bio_team'], $data['author_id'], $data['author_name'], $data['type'], $data['agent_id'], $data['agent_name'], $data['story_title'], $data['approach'], $data['tags'], $data['collaboration_status']
	...
	*/
	...
	function bio_story_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_story_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['bio_team'], $data['author_id'], $data['author_name'], $data['type'], $data['agent_id'], $data['agent_name'], $data['story_title'], $data['approach'], $data['tags'], $data['collaboration_status']
	...
	*/
	...
	function bio_story_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_story_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_story_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function bio_story_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function bio_story_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function bio_story_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function bio_story_batch_actions(&$args) {
