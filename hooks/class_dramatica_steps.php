<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_dramatica_steps' table. 
	...
	*/
	...
	function class_dramatica_steps_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function class_dramatica_steps_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function class_dramatica_steps_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function class_dramatica_steps_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dramatica_steps_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['step'], $data['type'], $data['act']
	...
	*/
	...
	function class_dramatica_steps_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dramatica_steps_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dramatica_steps_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function class_dramatica_steps_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function class_dramatica_steps_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function class_dramatica_steps_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function class_dramatica_steps_batch_actions(&$args) {
