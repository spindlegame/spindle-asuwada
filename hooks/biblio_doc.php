<?php
	...
	*/
	 ...
	 *     $data['img'], $data['author_name'], $data['author_id'], $data['type'], $data['genre'], $data['created'], $data['published'], $data['title'], $data['subtitle'], $data['publisher'], $data['location'], $data['citation'], $data['description'], $data['source'], $data['medium'], $data['language'], $data['format'], $data['subject'], $data['rights'], $data['rights_holder'], $data['data_evaluation'], $data['world_cat_no'], $data['authority_record'], $data['authority_organization'], $data['pdf_book'], $data['ext_source'], $data['tags'], $data['team'], $data['biblio_lead']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['img'], $data['author_name'], $data['author_id'], $data['type'], $data['genre'], $data['created'], $data['published'], $data['title'], $data['subtitle'], $data['publisher'], $data['location'], $data['citation'], $data['description'], $data['source'], $data['medium'], $data['language'], $data['format'], $data['subject'], $data['rights'], $data['rights_holder'], $data['data_evaluation'], $data['world_cat_no'], $data['authority_record'], $data['authority_organization'], $data['pdf_book'], $data['ext_source'], $data['tags'], $data['team'], $data['biblio_lead']
