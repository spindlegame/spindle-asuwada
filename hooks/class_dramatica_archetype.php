<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_dramatica_archetype' table. 
	...
	*/
	...
	function class_dramatica_archetype_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function class_dramatica_archetype_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function class_dramatica_archetype_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['archetype'], $data['description']
	...
	*/
	...
	function class_dramatica_archetype_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_dramatica_archetype_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['archetype'], $data['description']
	...
	*/
	...
	function class_dramatica_archetype_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_dramatica_archetype_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function class_dramatica_archetype_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function class_dramatica_archetype_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function class_dramatica_archetype_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function class_dramatica_archetype_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function class_dramatica_archetype_batch_actions(&$args){
