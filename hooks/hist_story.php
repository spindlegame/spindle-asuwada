<?php
	...
	*/
	 ...
	 *     $data['com_name'], $data['project_leader'], $data['subject'], $data['story'], $data['approach'], $data['tags'], $data['collaboration_status']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['com_name'], $data['project_leader'], $data['subject'], $data['story'], $data['approach'], $data['tags'], $data['collaboration_status']
