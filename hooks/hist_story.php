<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'hist_story' table. 
	...
	*/
	...
	function hist_story_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function hist_story_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function hist_story_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['team'], $data['hist_lead_id'], $data['hist_lead_name'], $data['community_id'], $data['story_title'], $data['genre'], $data['approach'], $data['description'], $data['tags'], $data['collaboration_status'], $data['language']
	...
	*/
	...
	function hist_story_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_story_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['team'], $data['hist_lead_id'], $data['hist_lead_name'], $data['community_id'], $data['story_title'], $data['genre'], $data['approach'], $data['description'], $data['tags'], $data['collaboration_status'], $data['language']
	...
	*/
	...
	function hist_story_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_story_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_story_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function hist_story_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function hist_story_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function hist_story_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function hist_story_batch_actions(&$args) {
