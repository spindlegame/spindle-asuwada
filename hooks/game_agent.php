<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'game_agent' table. 
	...
	*/
	...
	function game_agent_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function game_agent_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function game_agent_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['memberID'], $data['img'], $data['groupID'], $data['selection_class'], $data['agenttype1'], $data['agenttype2'], $data['gender'], $data['last_name'], $data['first_name'], $data['other_name'], $data['birthday'], $data['birth_location'], $data['birth_location_map'], $data['deathday'], $data['death_location'], $data['workplace'], $data['knows'], $data['shortbio'], $data['img_gallery'], $data['data_evaluation']
	...
	*/
	...
	function game_agent_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['user_id'], $data['memberID'], $data['img'], $data['groupID'], $data['selection_class'], $data['agenttype1'], $data['agenttype2'], $data['gender'], $data['last_name'], $data['first_name'], $data['other_name'], $data['birthday'], $data['birth_location'], $data['birth_location_map'], $data['deathday'], $data['death_location'], $data['workplace'], $data['knows'], $data['shortbio'], $data['img_gallery'], $data['data_evaluation']
	...
	*/
	...
	function game_agent_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['memberID'], $data['img'], $data['groupID'], $data['selection_class'], $data['agenttype1'], $data['agenttype2'], $data['gender'], $data['last_name'], $data['first_name'], $data['other_name'], $data['birthday'], $data['birth_location'], $data['birth_location_map'], $data['deathday'], $data['death_location'], $data['workplace'], $data['knows'], $data['shortbio'], $data['img_gallery'], $data['data_evaluation']
	...
	*/
	...
	function game_agent_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['user_id'], $data['memberID'], $data['img'], $data['groupID'], $data['selection_class'], $data['agenttype1'], $data['agenttype2'], $data['gender'], $data['last_name'], $data['first_name'], $data['other_name'], $data['birthday'], $data['birth_location'], $data['birth_location_map'], $data['deathday'], $data['death_location'], $data['workplace'], $data['knows'], $data['shortbio'], $data['img_gallery'], $data['data_evaluation']
	...
	*/
	...
	function game_agent_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function game_agent_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function game_agent_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function game_agent_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function game_agent_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function game_agent_batch_actions(&$args) {
