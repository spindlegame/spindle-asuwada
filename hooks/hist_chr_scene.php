<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'hist_chr_scene' table. 
	...
	*/
	...
	function hist_chr_scene_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function hist_chr_scene_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function hist_chr_scene_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['team'], $data['author_id'], $data['author_name'], $data['hist_story'], $data['agent_id'], $data['agent_name'], $data['bio_story'], $data['hist_chr'], $data['bio_storyline_no'], $data['bio_storyline_text'], $data['chr_element'], $data['bio_chr_scene'], $data['invivo_code'], $data['startdate'], $data['enddate'], $data['person'], $data['place'], $data['herme_code'], $data['impression'], $data['noetictension'], $data['pc'], $data['counterfactual'], $data['defense'], $data['comment'], $data['illustration'], $data['scene']
	...
	*/
	...
	function hist_chr_scene_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_chr_scene_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['team'], $data['author_id'], $data['author_name'], $data['hist_story'], $data['agent_id'], $data['agent_name'], $data['bio_story'], $data['hist_chr'], $data['bio_storyline_no'], $data['bio_storyline_text'], $data['chr_element'], $data['bio_chr_scene'], $data['invivo_code'], $data['startdate'], $data['enddate'], $data['person'], $data['place'], $data['herme_code'], $data['impression'], $data['noetictension'], $data['pc'], $data['counterfactual'], $data['defense'], $data['comment'], $data['illustration'], $data['scene']
	...
	*/
	...
	function hist_chr_scene_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_chr_scene_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_chr_scene_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function hist_chr_scene_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function hist_chr_scene_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function hist_chr_scene_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function hist_chr_scene_batch_actions(&$args) {
