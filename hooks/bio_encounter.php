<?php
	...
	*/
	 ...
	 *     $data['authorA'], $data['author_nameA'], $data['bibliographyA'], $data['transcriptA'], $data['tokenA'], $data['sceneA'], $data['authorB'], $data['authornameB'], $data['bibliographyB'], $data['transcriptB'], $data['tokenB'], $data['sceneB'], $data['relation_description'], $data['type'], $data['conflicttype'], $data['story_scene'], $data['nd_color'], $data['nd_width'], $data['nd_style'], $data['nd_opacity'], $data['nd_visibility'], $data['lbl_lable'], $data['lbl_color'], $data['lbl_size']
