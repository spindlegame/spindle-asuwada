<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'bio_encounter' table. 
	...
	*/
	...
	function bio_encounter_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function bio_encounter_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function bio_encounter_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['authorA'], $data['author_nameA'], $data['bibliographyA'], $data['transcriptA'], $data['tokenA'], $data['bio_impressionA'], $data['bio_ntA'], $data['bio_counterfactualA'], $data['bio_defenseA'], $data['bio_sdgA'], $data['startdateA'], $data['enddateA'], $data['sceneA'], $data['authorB'], $data['author_nameB'], $data['bibliographyB'], $data['transcriptB'], $data['tokenB'], $data['sceneB'], $data['bio_impressionB'], $data['bio_ntB'], $data['bio_counterfactualB'], $data['bio_defenseB'], $data['bio_sdgB'], $data['startdateB'], $data['enddateB'], $data['relation_description'], $data['type'], $data['conflicttype'], $data['story_scene'], $data['nd_color'], $data['nd_width'], $data['nd_style'], $data['nd_opacity'], $data['nd_visibility'], $data['lbl_lable'], $data['lbl_color'], $data['lbl_size'], $data['encounter_analyst']
	...
	*/
	...
	function bio_encounter_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_encounter_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_encounter_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_encounter_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_encounter_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function bio_encounter_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function bio_encounter_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function bio_encounter_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function bio_encounter_batch_actions(&$args) {
