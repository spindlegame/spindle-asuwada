<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'character_illustration' table. 
	...
	*/
	...
	function character_illustration_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function character_illustration_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function character_illustration_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['author'], $data['bibliography'], $data['transcript'], $data['token_sequence'], $data['token'], $data['code'], $data['illustration'], $data['comment'], $data['character_element'], $data['character_elem_value'], $data['archetype']
	...
	*/
	...
	function character_illustration_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function character_illustration_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['author'], $data['bibliography'], $data['transcript'], $data['token_sequence'], $data['token'], $data['code'], $data['illustration'], $data['comment'], $data['character_element'], $data['character_elem_value'], $data['archetype']
	...
	*/
	...
	function character_illustration_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function character_illustration_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function character_illustration_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function character_illustration_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function character_illustration_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function character_illustration_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function character_illustration_batch_actions(&$args){
