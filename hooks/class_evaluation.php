<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_evaluation' table. 
	...
	*/
	...
	function class_evaluation_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function class_evaluation_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function class_evaluation_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['evaluation_type'], $data['description']
	...
	*/
	...
	function class_evaluation_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_evaluation_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['evaluation_type'], $data['description']
	...
	*/
	...
	function class_evaluation_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_evaluation_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_evaluation_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function class_evaluation_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function class_evaluation_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function class_evaluation_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function class_evaluation_batch_actions(&$args) {
