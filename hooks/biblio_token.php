<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'biblio_token' table. 
	...
	*/
	...
	function biblio_token_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function biblio_token_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function biblio_token_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['author'], $data['bibliography'], $data['transcript'], $data['token_sequence'], $data['token'], $data['page'], $data['line'], $data['code']
	...
	*/
	...
	function biblio_token_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function biblio_token_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['author'], $data['bibliography'], $data['transcript'], $data['token_sequence'], $data['token'], $data['page'], $data['line'], $data['code']
	...
	*/
	...
	function biblio_token_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function biblio_token_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function biblio_token_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function biblio_token_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function biblio_token_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function biblio_token_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function biblio_token_batch_actions(&$args){
