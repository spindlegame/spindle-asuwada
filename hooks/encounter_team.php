<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'encounter_team' table. 
	...
	*/
	...
	function encounter_team_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function encounter_team_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function encounter_team_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function encounter_team_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function encounter_team_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['team'], $data['description']
	...
	*/
	...
	function encounter_team_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function encounter_team_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function encounter_team_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function encounter_team_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function encounter_team_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function encounter_team_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function encounter_team_batch_actions(&$args) {
