<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_dynamicstorypoints3' table. 
	...
	*/
	...
	function class_dynamicstorypoints3_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function class_dynamicstorypoints3_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function class_dynamicstorypoints3_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function class_dynamicstorypoints3_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dynamicstorypoints3_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dynamicstorypoints3_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dynamicstorypoints3_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dynamicstorypoints3_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function class_dynamicstorypoints3_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function class_dynamicstorypoints3_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function class_dynamicstorypoints3_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function class_dynamicstorypoints3_batch_actions(&$args) {
