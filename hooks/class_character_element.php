<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_character_element' table. 
	...
	*/
	...
	function class_character_element_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function class_character_element_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function class_character_element_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function class_character_element_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_character_element_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['element'], $data['value']
	...
	*/
	...
	function class_character_element_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_character_element_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_character_element_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function class_character_element_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function class_character_element_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function class_character_element_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function class_character_element_batch_actions(&$args) {
