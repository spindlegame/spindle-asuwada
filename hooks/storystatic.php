<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'storystatic' table. 
	...
	*/
	...
	function storystatic_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function storystatic_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function storystatic_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function storystatic_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function storystatic_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function storystatic_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function storystatic_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function storystatic_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function storystatic_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function storystatic_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function storystatic_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function storystatic_batch_actions(&$args){
