<?php
	...
	*/
	 ...
	 *     $data['author_id'], $data['author_name'], $data['bibliography'], $data['transcript'], $data['token_sequence'], $data['token'], $data['hermeneutic'], $data['impression'], $data['noetictension'], $data['quadrilemma'], $data['pc'], $data['freecode']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['author_id'], $data['author_name'], $data['bibliography'], $data['transcript'], $data['token_sequence'], $data['token'], $data['hermeneutic'], $data['impression'], $data['noetictension'], $data['quadrilemma'], $data['pc'], $data['freecode']
