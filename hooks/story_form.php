<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'story_form' table. 
	...
	*/
	...
	function story_form_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function story_form_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function story_form_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function story_form_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function story_form_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function story_form_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function story_form_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function story_form_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function story_form_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function story_form_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function story_form_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function story_form_batch_actions(&$args){
