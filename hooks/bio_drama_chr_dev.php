<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'bio_drama_chr_dev' table. 
	...
	*/
	...
	function bio_drama_chr_dev_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function bio_drama_chr_dev_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function bio_drama_chr_dev_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function bio_drama_chr_dev_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function bio_drama_chr_dev_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['agent_id'], $data['agent_name'], $data['cw_name'], $data['img'], $data['dp_resolve'], $data['mc_resolve'], $data['illust_resolve'], $data['mc_growth'], $data['illust_growth'], $data['mc_approach'], $data['illust_approach'], $data['mc_ps_style'], $data['illust_ps_style'], $data['cw_age'], $data['cw_gender'], $data['cw_communication_style'], $data['cw_background'], $data['cw_appearance'], $data['cw_relationships'], $data['cw_ambition'], $data['cw_defects'], $data['cw_thoughts'], $data['cw_relatedness'], $data['cw_restrictions'], $data['locations'], $data['persons'], $data['events'], $data['noetictension'], $data['illust_nt'], $data['impression'], $data['illust_im'], $data['mcs_problem'], $data['illust_mcs_problem'], $data['mcs_solution'], $data['illust_mcs_solution'], $data['mcs_symptom'], $data['illust_mcs_symptom'], $data['mcs_response'], $data['illust_mcs_response']
	...
	*/
	...
	function bio_drama_chr_dev_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function bio_drama_chr_dev_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function bio_drama_chr_dev_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function bio_drama_chr_dev_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function bio_drama_chr_dev_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function bio_drama_chr_dev_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function bio_drama_chr_dev_batch_actions(&$args){
