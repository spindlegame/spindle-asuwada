<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_dictionary5' table. 
	...
	*/
	...
	function class_dictionary5_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function class_dictionary5_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function class_dictionary5_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['class1'], $data['class2'], $data['class3'], $data['class4'], $data['category']
	...
	*/
	...
	function class_dictionary5_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_dictionary5_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['class1'], $data['class2'], $data['class3'], $data['class4'], $data['category']
	...
	*/
	...
	function class_dictionary5_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_dictionary5_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function class_dictionary5_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function class_dictionary5_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function class_dictionary5_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function class_dictionary5_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function class_dictionary5_batch_actions(&$args){
