<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'chr_dev' table. 
	...
	*/
	...
	function chr_dev_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function chr_dev_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function chr_dev_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function chr_dev_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function chr_dev_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function chr_dev_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function chr_dev_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function chr_dev_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function chr_dev_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function chr_dev_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function chr_dev_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function chr_dev_batch_actions(&$args){
