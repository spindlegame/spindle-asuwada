<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'character_development' table. 
	...
	*/
	...
	function character_development_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function character_development_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function character_development_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function character_development_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function character_development_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function character_development_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function character_development_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function character_development_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function character_development_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function character_development_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function character_development_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function character_development_batch_actions(&$args){
