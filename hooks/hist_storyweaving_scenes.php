<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'hist_storyweaving_scenes' table. 
	...
	*/
	...
	function hist_storyweaving_scenes_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function hist_storyweaving_scenes_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function hist_storyweaving_scenes_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['story'], $data['step'], $data['throughline'], $data['domain'], $data['concern'], $data['issue'], $data['theme'], $data['sequence']
	...
	*/
	...
	function hist_storyweaving_scenes_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_storyweaving_scenes_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['story'], $data['step'], $data['throughline'], $data['domain'], $data['concern'], $data['issue'], $data['theme'], $data['sequence']
	...
	*/
	...
	function hist_storyweaving_scenes_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_storyweaving_scenes_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_storyweaving_scenes_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function hist_storyweaving_scenes_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function hist_storyweaving_scenes_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function hist_storyweaving_scenes_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function hist_storyweaving_scenes_batch_actions(&$args) {
