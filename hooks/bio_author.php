<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'bio_author' table. 
	...
	*/
	...
	function bio_author_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function bio_author_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function bio_author_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function bio_author_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function bio_author_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function bio_author_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function bio_author_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function bio_author_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function bio_author_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function bio_author_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function bio_author_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function bio_author_batch_actions(&$args){
