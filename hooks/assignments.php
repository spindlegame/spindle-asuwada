<?php
	...
	*/
	 ...
	 *     $data['ProjectId'], $data['ProjectDuration'], $data['RessourceId'], $data['Commitment'], $data['author_id'], $data['author_name'], $data['biblio_doc'], $data['biblio_trascript'], $data['biblio_token'], $data['invivio_code'], $data['StartDate'], $data['EndDate']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['Id'], $data['ProjectId'], $data['ProjectDuration'], $data['RessourceId'], $data['Commitment'], $data['author_id'], $data['author_name'], $data['biblio_doc'], $data['biblio_trascript'], $data['biblio_token'], $data['invivio_code'], $data['StartDate'], $data['EndDate']
