<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'bio_chr' table. 
	...
	*/
	...
	function bio_chr_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function bio_chr_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function bio_chr_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['img'], $data['author_id'], $data['author_name'], $data['agent_id'], $data['agent_name'], $data['bio_story'], $data['bio_character'], $data['bio_archetype'], $data['character_name'], $data['role'], $data['comment']
	...
	*/
	...
	function bio_chr_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_chr_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['img'], $data['author_id'], $data['author_name'], $data['agent_id'], $data['agent_name'], $data['bio_story'], $data['bio_character'], $data['bio_archetype'], $data['character_name'], $data['role'], $data['comment']
	...
	*/
	...
	function bio_chr_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_chr_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_chr_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function bio_chr_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function bio_chr_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function bio_chr_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function bio_chr_batch_actions(&$args) {
