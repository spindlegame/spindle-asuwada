<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'hist_team_members' table. 
	...
	*/
	...
	function hist_team_members_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function hist_team_members_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function hist_team_members_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['team'], $data['agent_id'], $data['last_name'], $data['first_name']
	...
	*/
	...
	function hist_team_members_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['team'], $data['agent_id'], $data['author_memberid'], $data['last_name'], $data['first_name']
	...
	*/
	...
	function hist_team_members_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['team'], $data['agent_id'], $data['last_name'], $data['first_name']
	...
	*/
	...
	function hist_team_members_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['team'], $data['agent_id'], $data['author_memberid'], $data['last_name'], $data['first_name']
	...
	*/
	...
	function hist_team_members_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_team_members_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function hist_team_members_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function hist_team_members_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function hist_team_members_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function hist_team_members_batch_actions(&$args) {
