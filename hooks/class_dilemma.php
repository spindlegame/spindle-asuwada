<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_dilemma' table. 
	...
	*/
	...
	function class_dilemma_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function class_dilemma_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function class_dilemma_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function class_dilemma_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dilemma_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dilemma_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dilemma_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dilemma_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function class_dilemma_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function class_dilemma_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function class_dilemma_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function class_dilemma_batch_actions(&$args) {
