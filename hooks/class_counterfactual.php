<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_counterfactual' table. 
	...
	*/
	...
	function class_counterfactual_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function class_counterfactual_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function class_counterfactual_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['counterfactual'], $data['description'], $data['example']
	...
	*/
	...
	function class_counterfactual_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_counterfactual_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['counterfactual'], $data['description'], $data['example']
	...
	*/
	...
	function class_counterfactual_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_counterfactual_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_counterfactual_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function class_counterfactual_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function class_counterfactual_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function class_counterfactual_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function class_counterfactual_batch_actions(&$args) {
