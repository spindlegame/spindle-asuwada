<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_rights' table. 
	...
	*/
	...
	function class_rights_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function class_rights_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function class_rights_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['right'], $data['description'], $data['certification']
	...
	*/
	...
	function class_rights_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_rights_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['right'], $data['description'], $data['certification']
	...
	*/
	...
	function class_rights_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_rights_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_rights_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function class_rights_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function class_rights_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function class_rights_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function class_rights_batch_actions(&$args) {
