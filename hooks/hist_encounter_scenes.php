<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'hist_encounter_scenes' table. 
	...
	*/
	...
	function hist_encounter_scenes_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounter_scenes_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function hist_encounter_scenes_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function hist_encounter_scenes_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounter_scenes_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounter_scenes_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounter_scenes_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounter_scenes_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounter_scenes_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounter_scenes_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function hist_encounter_scenes_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounter_scenes_batch_actions(&$args) {
