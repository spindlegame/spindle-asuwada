<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_dictionary3' table. 
	...
	*/
	...
	function class_dictionary3_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function class_dictionary3_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function class_dictionary3_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['class1'], $data['class2'], $data['category']
	...
	*/
	...
	function class_dictionary3_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dictionary3_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['class1'], $data['class2'], $data['category']
	...
	*/
	...
	function class_dictionary3_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dictionary3_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dictionary3_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function class_dictionary3_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function class_dictionary3_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function class_dictionary3_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function class_dictionary3_batch_actions(&$args) {
