<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_dynamicstorypoints' table. 
	...
	*/
	...
	function class_dynamicstorypoints_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function class_dynamicstorypoints_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function class_dynamicstorypoints_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['term'], $data['value'], $data['description'], $data['cat1'], $data['cat2'], $data['cat3']
	...
	*/
	...
	function class_dynamicstorypoints_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_dynamicstorypoints_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['term'], $data['value'], $data['description'], $data['cat1'], $data['cat2'], $data['cat3']
	...
	*/
	...
	function class_dynamicstorypoints_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_dynamicstorypoints_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function class_dynamicstorypoints_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function class_dynamicstorypoints_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function class_dynamicstorypoints_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function class_dynamicstorypoints_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function class_dynamicstorypoints_batch_actions(&$args){
