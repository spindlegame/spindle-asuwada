<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'bio_code_demo' table. 
	...
	*/
	...
	function bio_code_demo_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function bio_code_demo_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function bio_code_demo_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function bio_code_demo_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function bio_code_demo_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function bio_code_demo_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function bio_code_demo_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function bio_code_demo_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function bio_code_demo_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function bio_code_demo_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function bio_code_demo_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function bio_code_demo_batch_actions(&$args){
