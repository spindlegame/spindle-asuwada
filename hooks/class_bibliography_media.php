<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_bibliography_media' table. 
	...
	*/
	...
	function class_bibliography_media_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function class_bibliography_media_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function class_bibliography_media_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['type'], $data['definition'], $data['description']
	...
	*/
	...
	function class_bibliography_media_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_bibliography_media_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['type'], $data['definition'], $data['description']
	...
	*/
	...
	function class_bibliography_media_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_bibliography_media_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_bibliography_media_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function class_bibliography_media_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function class_bibliography_media_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function class_bibliography_media_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function class_bibliography_media_batch_actions(&$args) {
