<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_story_path' table. 
	...
	*/
	...
	function class_story_path_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function class_story_path_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function class_story_path_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function class_story_path_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_story_path_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function class_story_path_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_story_path_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function class_story_path_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function class_story_path_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function class_story_path_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function class_story_path_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function class_story_path_batch_actions(&$args){
