<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_goals' table. 
	...
	*/
	...
	function class_goals_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function class_goals_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function class_goals_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['goal'], $data['class'], $data['description'], $data['hierarchy']
	...
	*/
	...
	function class_goals_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_goals_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['goal'], $data['class'], $data['description'], $data['hierarchy']
	...
	*/
	...
	function class_goals_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_goals_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_goals_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function class_goals_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function class_goals_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function class_goals_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function class_goals_batch_actions(&$args) {
