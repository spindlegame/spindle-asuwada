<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'biblio_transcript' table. 
	...
	*/
	...
	function biblio_transcript_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_transcript_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function biblio_transcript_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['author'], $data['author_memberID'], $data['bibliography_id'], $data['bibliography_title'], $data['trascriber_memberID'], $data['transcript_title'], $data['transcript'], $data['credits'], $data['ip_rights']
	...
	*/
	...
	function biblio_transcript_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_transcript_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['author'], $data['author_memberID'], $data['bibliography_id'], $data['bibliography_title'], $data['trascriber_memberID'], $data['transcript_title'], $data['transcript'], $data['credits'], $data['ip_rights']
	...
	*/
	...
	function biblio_transcript_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_transcript_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_transcript_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_transcript_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_transcript_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function biblio_transcript_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_transcript_batch_actions(&$args) {
