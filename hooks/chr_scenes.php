<?php
	...
	*/
	 ...
	 *     $data['author'], $data['bibliography'], $data['transcript'], $data['token_sequence'], $data['token'], $data['invivo_code'], $data['startdate'], $data['enddate'], $data['person'], $data['place'], $data['herme_code'], $data['impression'], $data['noetictension'], $data['pc'], $data['comment'], $data['scene']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['author'], $data['bibliography'], $data['transcript'], $data['token_sequence'], $data['token'], $data['invivo_code'], $data['startdate'], $data['enddate'], $data['person'], $data['place'], $data['herme_code'], $data['impression'], $data['noetictension'], $data['pc'], $data['comment'], $data['scene']
