<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'chr_scenes' table. 
	...
	*/
	...
	function chr_scenes_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function chr_scenes_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function chr_scenes_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function chr_scenes_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function chr_scenes_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function chr_scenes_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function chr_scenes_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function chr_scenes_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function chr_scenes_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function chr_scenes_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function chr_scenes_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function chr_scenes_batch_actions(&$args){
