<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'storyweaving_scenes_1' table. 
	...
	*/
	...
	function storyweaving_scenes_1_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function storyweaving_scenes_1_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function storyweaving_scenes_1_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function storyweaving_scenes_1_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function storyweaving_scenes_1_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function storyweaving_scenes_1_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function storyweaving_scenes_1_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function storyweaving_scenes_1_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function storyweaving_scenes_1_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function storyweaving_scenes_1_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function storyweaving_scenes_1_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function storyweaving_scenes_1_batch_actions(&$args){
