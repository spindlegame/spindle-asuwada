<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'biblio_community' table. 
	...
	*/
	...
	function biblio_community_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function biblio_community_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function biblio_community_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['com_name'], $data['description']
	...
	*/
	...
	function biblio_community_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function biblio_community_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['com_name'], $data['description']
	...
	*/
	...
	function biblio_community_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function biblio_community_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function biblio_community_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function biblio_community_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function biblio_community_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function biblio_community_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function biblio_community_batch_actions(&$args){
