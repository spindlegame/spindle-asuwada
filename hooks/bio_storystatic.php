<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'bio_storystatic' table. 
	...
	*/
	...
	function bio_storystatic_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function bio_storystatic_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function bio_storystatic_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function bio_storystatic_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function bio_storystatic_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function bio_storystatic_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function bio_storystatic_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function bio_storystatic_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function bio_storystatic_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function bio_storystatic_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function bio_storystatic_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function bio_storystatic_batch_actions(&$args){
