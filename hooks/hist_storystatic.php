<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'hist_storystatic' table. 
	...
	*/
	...
	function hist_storystatic_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function hist_storystatic_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function hist_storystatic_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['story'], $data['throughline'], $data['story_character_mc'], $data['throughline_domain'], $data['concern'], $data['issue'], $data['problem'], $data['solution'], $data['symptom'], $data['response'], $data['catalyst'], $data['inhibitor'], $data['benchmark'], $data['signpost1'], $data['signpost2'], $data['signpost3'], $data['signpost4']
	...
	*/
	...
	function hist_storystatic_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_storystatic_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['story'], $data['throughline'], $data['story_character_mc'], $data['throughline_domain'], $data['concern'], $data['issue'], $data['problem'], $data['solution'], $data['symptom'], $data['response'], $data['catalyst'], $data['inhibitor'], $data['benchmark'], $data['signpost1'], $data['signpost2'], $data['signpost3'], $data['signpost4']
	...
	*/
	...
	function hist_storystatic_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_storystatic_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_storystatic_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function hist_storystatic_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function hist_storystatic_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function hist_storystatic_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function hist_storystatic_batch_actions(&$args) {
