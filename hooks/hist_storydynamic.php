<?php
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['story'], $data['storystatic_ost'], $data['story_chr_mc'], $data['mc_problem'], $data['mc_resolve'], $data['mc_growth'], $data['mc_approach'], $data['mc_ps_style'], $data['story_chr_ic'], $data['ic_resolve'], $data['dp_cat1'], $data['dp_cat2'], $data['dp_cat3_driver'], $data['os_driver'], $data['dp_cat3_limit'], $data['os_limit'], $data['dp_cat3_outcome'], $data['os_outcome'], $data['dp_cat3_judgement'], $data['os_judgement'], $data['os_goal_domain'], $data['os_goal_concern'], $data['os_consequence_domain'], $data['os_consequence_concern'], $data['os_cost_domain'], $data['os_cost_concern'], $data['os_dividend_domain'], $data['os_dividend_concern'], $data['os_requirements_domain'], $data['os_requirements_concern'], $data['os_prerequesites_domain'], $data['os_prerequesites_concern'], $data['os_preconditions_domain'], $data['os_preconditions_concern'], $data['os_forewarnings_domain'], $data['os_forewarnings_concern']
