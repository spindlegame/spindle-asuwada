<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'hist_authors' table. 
	...
	*/
	...
	function hist_authors_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function hist_authors_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function hist_authors_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function hist_authors_before_insert(&$data, $memberInfo, &$args) {
	 ...
	 * For this table, the array items are: 
	 *     $data['team'], $data['agent_id'], $data['agent_memberid'], $data['last_name'], $data['first_name']
	...
	*/
	...
	function hist_authors_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_authors_before_update(&$data, $memberInfo, &$args) {
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['team'], $data['agent_id'], $data['agent_memberid'], $data['last_name'], $data['first_name']
	...
	*/
	...
	function hist_authors_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_authors_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function hist_authors_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function hist_authors_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function hist_authors_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function hist_authors_batch_actions(&$args) {
