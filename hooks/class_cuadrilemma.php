<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_cuadrilemma' table. 
	...
	*/
	...
	function class_cuadrilemma_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function class_cuadrilemma_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function class_cuadrilemma_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['dilemma'], $data['orientation1'], $data['orientation2']
	...
	*/
	...
	function class_cuadrilemma_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_cuadrilemma_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['dilemma'], $data['orientation1'], $data['orientation2']
	...
	*/
	...
	function class_cuadrilemma_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_cuadrilemma_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_cuadrilemma_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function class_cuadrilemma_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function class_cuadrilemma_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function class_cuadrilemma_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function class_cuadrilemma_batch_actions(&$args) {
