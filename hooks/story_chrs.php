<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'story_chrs' table. 
	...
	*/
	...
	function story_chrs_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function story_chrs_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function story_chrs_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['agent_id'], $data['agent_name'], $data['character'], $data['role'], $data['story_character'], $data['story'], $data['story_archetype'], $data['comment']
	...
	*/
	...
	function story_chrs_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function story_chrs_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['agent_id'], $data['agent_name'], $data['character'], $data['role'], $data['story_character'], $data['story'], $data['story_archetype'], $data['comment']
	...
	*/
	...
	function story_chrs_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function story_chrs_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function story_chrs_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function story_chrs_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function story_chrs_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function story_chrs_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function story_chrs_batch_actions(&$args){
