<?php
	...
	*/
	 ...
	 *     $data['agent'], $data['agent_name'], $data['character'], $data['story_character'], $data['story'], $data['story_archetype'], $data['comment']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['agent'], $data['agent_name'], $data['character'], $data['story_character'], $data['story'], $data['story_archetype'], $data['comment']
