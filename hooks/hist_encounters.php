<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'hist_encounters' table. 
	...
	*/
	...
	function hist_encounters_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounters_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function hist_encounters_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['bio_chrA'], $data['bio_storyA'], $data['bio_storyline'], $data['bio_storytext'], $data['sceneA'], $data['bio_chrB'], $data['bio_storyB'], $data['bio_storylineB'], $data['bio_storytextB'], $data['type'], $data['conflicttype'], $data['story_scene'], $data['nd_color'], $data['nd_width'], $data['nd_style'], $data['nd_opacity'], $data['nd_visibility'], $data['lbl_lable'], $data['lbl_color'], $data['lbl_size']
	...
	*/
	...
	function hist_encounters_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounters_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['bio_chrA'], $data['bio_storyA'], $data['bio_storyline'], $data['bio_storytext'], $data['sceneA'], $data['bio_chrB'], $data['bio_storyB'], $data['bio_storylineB'], $data['bio_storytextB'], $data['type'], $data['conflicttype'], $data['story_scene'], $data['nd_color'], $data['nd_width'], $data['nd_style'], $data['nd_opacity'], $data['nd_visibility'], $data['lbl_lable'], $data['lbl_color'], $data['lbl_size']
	...
	*/
	...
	function hist_encounters_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounters_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounters_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounters_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounters_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function hist_encounters_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounters_batch_actions(&$args) {
