<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_agent_type2' table. 
	...
	*/
	...
	function class_agent_type2_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function class_agent_type2_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function class_agent_type2_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function class_agent_type2_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_agent_type2_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function class_agent_type2_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_agent_type2_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function class_agent_type2_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function class_agent_type2_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function class_agent_type2_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function class_agent_type2_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function class_agent_type2_batch_actions(&$args){
