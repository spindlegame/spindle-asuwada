<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_defense' table. 
	...
	*/
	...
	function class_defense_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function class_defense_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function class_defense_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function class_defense_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_defense_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['defense'], $data['description']
	...
	*/
	...
	function class_defense_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_defense_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_defense_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function class_defense_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function class_defense_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function class_defense_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function class_defense_batch_actions(&$args) {
