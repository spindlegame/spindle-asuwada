<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_story_acts' table. 
	...
	*/
	...
	function class_story_acts_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function class_story_acts_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function class_story_acts_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function class_story_acts_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_story_acts_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_story_acts_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_story_acts_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_story_acts_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function class_story_acts_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function class_story_acts_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function class_story_acts_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function class_story_acts_batch_actions(&$args) {
