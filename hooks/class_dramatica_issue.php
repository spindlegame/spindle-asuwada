<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_dramatica_issue' table. 
	...
	*/
	...
	function class_dramatica_issue_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function class_dramatica_issue_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function class_dramatica_issue_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['domain'], $data['concern'], $data['issue'], $data['description']
	...
	*/
	...
	function class_dramatica_issue_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_dramatica_issue_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['domain'], $data['concern'], $data['issue'], $data['description']
	...
	*/
	...
	function class_dramatica_issue_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_dramatica_issue_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function class_dramatica_issue_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function class_dramatica_issue_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function class_dramatica_issue_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function class_dramatica_issue_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function class_dramatica_issue_batch_actions(&$args){
