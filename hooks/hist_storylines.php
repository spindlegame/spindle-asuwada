<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'hist_storylines' table. 
	...
	*/
	...
	function hist_storylines_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function hist_storylines_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function hist_storylines_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['story'], $data['story_act'], $data['character'], $data['role'], $data['storyline_no'], $data['parenthetic'], $data['storyline_title'], $data['storyline'], $data['notes'], $data['storyweaving_scene_no'], $data['storyweaving_scene'], $data['storyweaving_sequence'], $data['storyweaving_theme'], $data['characterevent_scene'], $data['character_event']
	...
	*/
	...
	function hist_storylines_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_storylines_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['story'], $data['story_act'], $data['character'], $data['role'], $data['storyline_no'], $data['parenthetic'], $data['storyline_title'], $data['storyline'], $data['notes'], $data['storyweaving_scene_no'], $data['storyweaving_scene'], $data['storyweaving_sequence'], $data['storyweaving_theme'], $data['characterevent_scene'], $data['character_event']
	...
	*/
	...
	function hist_storylines_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_storylines_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_storylines_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function hist_storylines_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function hist_storylines_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function hist_storylines_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function hist_storylines_batch_actions(&$args) {
