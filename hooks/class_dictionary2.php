<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_dictionary2' table. 
	...
	*/
	...
	function class_dictionary2_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function class_dictionary2_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function class_dictionary2_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function class_dictionary2_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_dictionary2_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['class1'], $data['category']
	...
	*/
	...
	function class_dictionary2_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_dictionary2_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function class_dictionary2_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function class_dictionary2_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function class_dictionary2_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function class_dictionary2_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function class_dictionary2_batch_actions(&$args){
