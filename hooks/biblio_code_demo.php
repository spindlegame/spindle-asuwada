<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'biblio_code_demo' table. 
	...
	*/
	...
	function biblio_code_demo_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_code_demo_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function biblio_code_demo_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['author'], $data['bibliography'], $data['transcript'], $data['token_id'], $data['token'], $data['sex'], $data['race'], $data['age']
	...
	*/
	...
	function biblio_code_demo_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_code_demo_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['author'], $data['bibliography'], $data['transcript'], $data['token_id'], $data['token'], $data['sex'], $data['race'], $data['age']
	...
	*/
	...
	function biblio_code_demo_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_code_demo_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_code_demo_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_code_demo_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_code_demo_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function biblio_code_demo_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function biblio_code_demo_batch_actions(&$args) {
