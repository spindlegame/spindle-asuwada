<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_agent_selection' table. 
	...
	*/
	...
	function class_agent_selection_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function class_agent_selection_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function class_agent_selection_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['selection_phase'], $data['description']
	...
	*/
	...
	function class_agent_selection_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_agent_selection_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['selection_phase'], $data['description']
	...
	*/
	...
	function class_agent_selection_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_agent_selection_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function class_agent_selection_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function class_agent_selection_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function class_agent_selection_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function class_agent_selection_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function class_agent_selection_batch_actions(&$args){
