<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'bio_storylines' table. 
	...
	*/
	...
	function bio_storylines_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function bio_storylines_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function bio_storylines_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function bio_storylines_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function bio_storylines_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function bio_storylines_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function bio_storylines_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function bio_storylines_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function bio_storylines_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function bio_storylines_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function bio_storylines_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function bio_storylines_batch_actions(&$args){
