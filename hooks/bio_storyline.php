<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'bio_storyline' table. 
	...
	*/
	...
	function bio_storyline_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function bio_storyline_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function bio_storyline_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['biography'], $data['author_id'], $data['author_name'], $data['bibliography'], $data['transcript'], $data['token_sequence'], $data['token'], $data['story_act'], $data['sequence'], $data['character'], $data['role'], $data['storyline_no'], $data['parenthetic'], $data['storyline_title'], $data['storyline'], $data['notes'], $data['storyweaving_scene_no'], $data['storyweaving_scene'], $data['storyweaving_sequence'], $data['storyweaving_theme'], $data['character_scene'], $data['character_event'], $data['startdate'], $data['enddate']
	...
	*/
	...
	function bio_storyline_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_storyline_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['biography'], $data['author_id'], $data['author_name'], $data['bibliography'], $data['transcript'], $data['token_sequence'], $data['token'], $data['story_act'], $data['sequence'], $data['character'], $data['role'], $data['storyline_no'], $data['parenthetic'], $data['storyline_title'], $data['storyline'], $data['notes'], $data['storyweaving_scene_no'], $data['storyweaving_scene'], $data['storyweaving_sequence'], $data['storyweaving_theme'], $data['character_scene'], $data['character_event'], $data['startdate'], $data['enddate']
	...
	*/
	...
	function bio_storyline_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_storyline_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_storyline_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function bio_storyline_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function bio_storyline_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function bio_storyline_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function bio_storyline_batch_actions(&$args) {
