<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'code_invivo' table. 
	...
	*/
	...
	function code_invivo_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function code_invivo_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function code_invivo_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function code_invivo_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function code_invivo_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function code_invivo_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function code_invivo_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function code_invivo_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function code_invivo_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function code_invivo_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function code_invivo_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function code_invivo_batch_actions(&$args){
