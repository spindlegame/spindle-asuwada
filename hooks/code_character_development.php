<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'code_character_development' table. 
	...
	*/
	...
	function code_character_development_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function code_character_development_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function code_character_development_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['agent'], $data['story'], $data['story_character'], $data['author'], $data['bibliography'], $data['transcript'], $data['token_sequence'], $data['token'], $data['code'], $data['character_element'], $data['character_elem_value'], $data['comment']
	...
	*/
	...
	function code_character_development_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function code_character_development_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['agent'], $data['story'], $data['story_character'], $data['author'], $data['bibliography'], $data['transcript'], $data['token_sequence'], $data['token'], $data['code'], $data['character_element'], $data['character_elem_value'], $data['comment']
	...
	*/
	...
	function code_character_development_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function code_character_development_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function code_character_development_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function code_character_development_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function code_character_development_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function code_character_development_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function code_character_development_batch_actions(&$args){
