<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_dramatica_concern' table. 
	...
	*/
	...
	function class_dramatica_concern_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function class_dramatica_concern_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function class_dramatica_concern_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['domain'], $data['concern'], $data['description']
	...
	*/
	...
	function class_dramatica_concern_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dramatica_concern_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['domain'], $data['concern'], $data['description']
	...
	*/
	...
	function class_dramatica_concern_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dramatica_concern_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dramatica_concern_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function class_dramatica_concern_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function class_dramatica_concern_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function class_dramatica_concern_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function class_dramatica_concern_batch_actions(&$args) {
