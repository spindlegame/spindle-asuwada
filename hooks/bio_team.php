<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'bio_team' table. 
	...
	*/
	...
	function bio_team_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function bio_team_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function bio_team_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function bio_team_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_team_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_team_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_team_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_team_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function bio_team_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function bio_team_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function bio_team_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function bio_team_batch_actions(&$args) {
