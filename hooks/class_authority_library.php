<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_authority_library' table. 
	...
	*/
	...
	function class_authority_library_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function class_authority_library_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function class_authority_library_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['abbreviation'], $data['authority_name']
	...
	*/
	...
	function class_authority_library_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_authority_library_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['abbreviation'], $data['authority_name']
	...
	*/
	...
	function class_authority_library_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_authority_library_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_authority_library_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function class_authority_library_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function class_authority_library_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function class_authority_library_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function class_authority_library_batch_actions(&$args) {
