<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_sdg' table. 
	...
	*/
	...
	function class_sdg_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function class_sdg_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function class_sdg_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['no'], $data['sdg_topic'], $data['description'], $data['rank'], $data['av_rank'], $data['mentions'], $data['icon']
	...
	*/
	...
	function class_sdg_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_sdg_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['no'], $data['sdg_topic'], $data['description'], $data['rank'], $data['av_rank'], $data['mentions'], $data['icon']
	...
	*/
	...
	function class_sdg_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_sdg_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_sdg_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function class_sdg_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function class_sdg_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function class_sdg_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function class_sdg_batch_actions(&$args) {
