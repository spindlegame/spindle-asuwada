<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_dynamicstorypoints1' table. 
	...
	*/
	...
	function class_dynamicstorypoints1_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function class_dynamicstorypoints1_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function class_dynamicstorypoints1_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function class_dynamicstorypoints1_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dynamicstorypoints1_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dynamicstorypoints1_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dynamicstorypoints1_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_dynamicstorypoints1_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function class_dynamicstorypoints1_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function class_dynamicstorypoints1_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function class_dynamicstorypoints1_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function class_dynamicstorypoints1_batch_actions(&$args) {
