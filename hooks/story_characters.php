<?php
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['story'], $data['role'], $data['character'], $data['memberID'], $data['agent_name'], $data['cw_name'], $data['img'], $data['MC_resolve'], $data['MC_growth'], $data['MC_approach'], $data['MC_PS_style'], $data['cw_age'], $data['cw_gender'], $data['cw_communication_style'], $data['cw_background'], $data['cw_appearance'], $data['cw_relationships'], $data['cw_ambition'], $data['cw_character_defects'], $data['cw_thoughts'], $data['cw_relatedness'], $data['cw_restrictions'], $data['locations'], $data['persons'], $data['events'], $data['noetictension'], $data['impression']
