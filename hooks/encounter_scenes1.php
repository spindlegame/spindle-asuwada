<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'encounter_scenes1' table. 
	...
	*/
	...
	function encounter_scenes1_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function encounter_scenes1_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function encounter_scenes1_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function encounter_scenes1_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function encounter_scenes1_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function encounter_scenes1_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function encounter_scenes1_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function encounter_scenes1_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function encounter_scenes1_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function encounter_scenes1_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function encounter_scenes1_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function encounter_scenes1_batch_actions(&$args){
