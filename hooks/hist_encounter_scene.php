<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'hist_encounter_scene' table. 
	...
	*/
	...
	function hist_encounter_scene_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounter_scene_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function hist_encounter_scene_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['scene'], $data['encounter_analyst']
	...
	*/
	...
	function hist_encounter_scene_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounter_scene_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['scene'], $data['encounter_analyst']
	...
	*/
	...
	function hist_encounter_scene_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounter_scene_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounter_scene_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounter_scene_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounter_scene_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function hist_encounter_scene_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function hist_encounter_scene_batch_actions(&$args) {
