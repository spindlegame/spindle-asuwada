<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'gallery_authors' table. 
	...
	*/
	...
	function gallery_authors_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function gallery_authors_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function gallery_authors_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['name'], $data['img'], $data['select']
	...
	*/
	...
	function gallery_authors_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function gallery_authors_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['name'], $data['img'], $data['select']
	...
	*/
	...
	function gallery_authors_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function gallery_authors_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function gallery_authors_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function gallery_authors_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function gallery_authors_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function gallery_authors_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function gallery_authors_batch_actions(&$args) {
