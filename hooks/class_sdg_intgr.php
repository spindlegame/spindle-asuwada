<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_sdg_intgr' table. 
	...
	*/
	...
	function class_sdg_intgr_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function class_sdg_intgr_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function class_sdg_intgr_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['integration'], $data['sdgA'], $data['sdgB'], $data['description']
	...
	*/
	...
	function class_sdg_intgr_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_sdg_intgr_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['integration'], $data['sdgA'], $data['sdgB'], $data['description']
	...
	*/
	...
	function class_sdg_intgr_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function class_sdg_intgr_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function class_sdg_intgr_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function class_sdg_intgr_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function class_sdg_intgr_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function class_sdg_intgr_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function class_sdg_intgr_batch_actions(&$args) {
