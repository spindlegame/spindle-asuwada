<?php
	...
	*/
	 ...
	 *     $data['game_agent_id'], $data['memberID'], $data['img'], $data['groupID'], $data['selection_class'], $data['agenttype1'], $data['agenttype2'], $data['gender'], $data['last_name'], $data['first_name'], $data['other_name'], $data['birthday'], $data['birth_location'], $data['birth_location_map'], $data['deathday'], $data['death_location'], $data['workplace'], $data['knows'], $data['shortbio'], $data['data_evaluation'], $data['authority_record'], $data['authority_organization']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['game_agent_id'], $data['id'], $data['memberID'], $data['img'], $data['groupID'], $data['selection_class'], $data['agenttype1'], $data['agenttype2'], $data['gender'], $data['last_name'], $data['first_name'], $data['other_name'], $data['birthday'], $data['birth_location'], $data['birth_location_map'], $data['deathday'], $data['death_location'], $data['workplace'], $data['knows'], $data['shortbio'], $data['data_evaluation'], $data['authority_record'], $data['authority_organization']
