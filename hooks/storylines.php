<?php
	...
	*/
	 ...
	 *     $data['story'], $data['story_act'], $data['storyweaving_scene_no'], $data['storyweaving_scene'], $data['storyweaving_sequence'], $data['storyweaving_theme'], $data['role'], $data['character'], $data['characterevent_scene'], $data['character_event'], $data['storyline_no'], $data['storyline']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['story'], $data['story_act'], $data['storyweaving_scene_no'], $data['storyweaving_scene'], $data['storyweaving_sequence'], $data['storyweaving_theme'], $data['role'], $data['character'], $data['characterevent_scene'], $data['character_event'], $data['storyline_no'], $data['storyline']
