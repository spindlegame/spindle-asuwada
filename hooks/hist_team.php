<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'hist_team' table. 
	...
	*/
	...
	function hist_team_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function hist_team_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function hist_team_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function hist_team_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_team_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_team_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_team_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_team_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function hist_team_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function hist_team_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function hist_team_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function hist_team_batch_actions(&$args) {
