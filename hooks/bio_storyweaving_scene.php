<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'bio_storyweaving_scene' table. 
	...
	*/
	...
	function bio_storyweaving_scene_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function bio_storyweaving_scene_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function bio_storyweaving_scene_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function bio_storyweaving_scene_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_storyweaving_scene_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_storyweaving_scene_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_storyweaving_scene_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_storyweaving_scene_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function bio_storyweaving_scene_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function bio_storyweaving_scene_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function bio_storyweaving_scene_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function bio_storyweaving_scene_batch_actions(&$args) {
