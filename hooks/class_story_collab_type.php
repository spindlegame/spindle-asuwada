<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_story_collab_type' table. 
	...
	*/
	...
	function class_story_collab_type_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function class_story_collab_type_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function class_story_collab_type_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['collab_type'], $data['description']
	...
	*/
	...
	function class_story_collab_type_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_story_collab_type_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['collab_type'], $data['description']
	...
	*/
	...
	function class_story_collab_type_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_story_collab_type_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function class_story_collab_type_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function class_story_collab_type_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function class_story_collab_type_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function class_story_collab_type_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function class_story_collab_type_batch_actions(&$args){
