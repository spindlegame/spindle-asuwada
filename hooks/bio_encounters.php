<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'bio_encounters' table. 
	...
	*/
	...
	function bio_encounters_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function bio_encounters_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function bio_encounters_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function bio_encounters_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function bio_encounters_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function bio_encounters_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function bio_encounters_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function bio_encounters_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function bio_encounters_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function bio_encounters_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function bio_encounters_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function bio_encounters_batch_actions(&$args){
