<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'chr_illustr' table. 
	...
	*/
	...
	function chr_illustr_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function chr_illustr_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function chr_illustr_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function chr_illustr_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function chr_illustr_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function chr_illustr_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function chr_illustr_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function chr_illustr_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function chr_illustr_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function chr_illustr_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function chr_illustr_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function chr_illustr_batch_actions(&$args){
