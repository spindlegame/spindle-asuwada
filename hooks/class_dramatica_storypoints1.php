<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'class_dramatica_storypoints1' table. 
	...
	*/
	...
	function class_dramatica_storypoints1_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function class_dramatica_storypoints1_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function class_dramatica_storypoints1_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function class_dramatica_storypoints1_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_dramatica_storypoints1_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['term'], $data['description']
	...
	*/
	...
	function class_dramatica_storypoints1_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function class_dramatica_storypoints1_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function class_dramatica_storypoints1_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function class_dramatica_storypoints1_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function class_dramatica_storypoints1_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function class_dramatica_storypoints1_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function class_dramatica_storypoints1_batch_actions(&$args){
