<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'bio_code_herme' table. 
	...
	*/
	...
	function bio_code_herme_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function bio_code_herme_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function bio_code_herme_footer($contentType, $memberInfo, &$args) {
		$footer='';
	 ...
	 *     $data['biography'], $data['agent_id'], $data['agent_name'], $data['author_id'], $data['author_name'], $data['bibliography'], $data['transcript'], $data['token_sequence'], $data['token'], $data['hermeneutic'], $data['impression'], $data['noetictension'], $data['quadrilemma'], $data['pc'], $data['bio_sdg'], $data['bio_defense'], $data['counterfactual'], $data['freecode']
	...
	*/
	...
	function bio_code_herme_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_code_herme_after_insert($data, $memberInfo, &$args) {
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['biography'], $data['agent_id'], $data['agent_name'], $data['author_id'], $data['author_name'], $data['bibliography'], $data['transcript'], $data['token_sequence'], $data['token'], $data['hermeneutic'], $data['impression'], $data['noetictension'], $data['quadrilemma'], $data['pc'], $data['bio_sdg'], $data['bio_defense'], $data['counterfactual'], $data['freecode']
	...
	*/
	...
	function bio_code_herme_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_code_herme_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function bio_code_herme_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function bio_code_herme_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function bio_code_herme_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function bio_code_herme_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function bio_code_herme_batch_actions(&$args) {
