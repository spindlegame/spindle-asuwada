<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'hist_community' table. 
	...
	*/
	...
	function hist_community_init(&$options, $memberInfo, &$args) {
	...
	*/
	...
	function hist_community_header($contentType, $memberInfo, &$args) {
		$header='';
	...
	*/
	...
	function hist_community_footer($contentType, $memberInfo, &$args) {
		$footer='';
	...
	*/
	...
	function hist_community_before_insert(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_community_after_insert($data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_community_before_update(&$data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_community_after_update($data, $memberInfo, &$args) {
	...
	*/
	...
	function hist_community_before_delete($selectedID, &$skipChecks, $memberInfo, &$args) {
	...
	*/
	...
	function hist_community_after_delete($selectedID, $memberInfo, &$args) {
	...
	*/
	...
	function hist_community_dv($selectedID, $memberInfo, &$html, &$args) {
	...
	*/
	...
	function hist_community_csv($query, $memberInfo, &$args) {
	...
	*/
	...
	function hist_community_batch_actions(&$args) {
