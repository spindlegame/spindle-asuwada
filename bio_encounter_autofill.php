...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	$table_perms = getTablePermissions('bio_encounter');
	...
	switch($mfk) {
		...
		case 'authorA':
			if(!$id) {
				?>
				$j('#author_nameA<?php echo $rnd1; ?>').html('&nbsp;');
				$j('#author_nameB<?php echo $rnd1; ?>').html('&nbsp;');
				<?php
				break;
			}
			...
			?>
			$j('#author_nameA<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(array("\r", "\n"), '', nl2br($row['last_name'].', '.$row['first_name']))); ?>&nbsp;');
			$j('#author_nameB<?php echo $rnd1; ?>').html('<?php echo addslashes(str_replace(array("\r", "\n"), '', nl2br($row['last_name'].', '.$row['first_name']))); ?>&nbsp;');
			<?php
			break;
