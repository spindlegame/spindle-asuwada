...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	@include_once("{$currDir}/hooks/class_authority_library.php");
	include_once("{$currDir}/class_authority_library_dml.php");
	...
	$x->RedirectAfterInsert = 'class_authority_library_view.php';
	$x->TableTitle = 'Text authority code';
	$x->TableIcon = 'resources/table_icons/barcode.png';
	$x->PrimaryKey = '`class_authority_library`.`id`';

	$x->ColWidth = [150, 150, 150, ];
	$x->ColCaption = ['Id', 'Abbreviation', 'Authority_name', ];
	$x->ColFieldName = ['id', 'abbreviation', 'authority_name', ];
	$x->ColNumber  = [1, 2, 3, ];
	...
	$x->TemplateDV = 'templates/class_authority_library_templateDV.html';
	$x->TemplateDVP = 'templates/class_authority_library_templateDVP.html';
