<?php
	...
	$transformFunctions = [
		'game_agent' => function($data, $options = []) {
			...
			if(isset($data['authority_organization'])) $data['authority_organization'] = pkGivenLookupText($data['authority_organization'], 'game_agent', 'authority_organization');
		...
		'biblio_analyst' => function($data, $options = []) {
			...
			if(isset($data['author_memberid'])) $data['author_memberid'] = thisOr($data['author_id'], pkGivenLookupText($data['author_memberid'], 'biblio_analyst', 'author_memberid'));
			...
			if(isset($data['other_name'])) $data['other_name'] = thisOr($data['author_id'], pkGivenLookupText($data['other_name'], 'biblio_analyst', 'other_name'));
		...
		'bio_author' => function($data, $options = []) {
			...
			if(isset($data['other_name'])) $data['other_name'] = thisOr($data['author_id'], pkGivenLookupText($data['other_name'], 'bio_author', 'other_name'));
		...
		'bio_encounter' => function($data, $options = []) {
			...
			if(isset($data['author_nameA'])) $data['author_nameA'] = pkGivenLookupText($data['author_nameA'], 'bio_encounter', 'author_nameA');
			...
			if(isset($data['authornameB'])) $data['authornameB'] = pkGivenLookupText($data['authornameB'], 'bio_encounter', 'authornameB');
		...
		'hist_story' => function($data, $options = []) {
			...
			if(isset($data['hist_lead_id'])) $data['hist_lead_id'] = pkGivenLookupText($data['hist_lead_id'], 'hist_story', 'hist_lead_id');
			...
			if(isset($data['hist_lead_name'])) $data['hist_lead_name'] = thisOr($data['hist_lead_id'], pkGivenLookupText($data['hist_lead_name'], 'hist_story', 'hist_lead_name'));

			return $data;
		},
		'hist_chr' => function($data, $options = []) {
			if(isset($data['team'])) $data['team'] = pkGivenLookupText($data['team'], 'hist_chr', 'team');
			if(isset($data['hist_lead_id'])) $data['hist_lead_id'] = pkGivenLookupText($data['hist_lead_id'], 'hist_chr', 'hist_lead_id');
			...
			if(isset($data['hist_lead_memberid'])) $data['hist_lead_memberid'] = thisOr($data['hist_lead_id'], pkGivenLookupText($data['hist_lead_memberid'], 'hist_chr', 'hist_lead_memberid'));
			if(isset($data['hist_lead_name'])) $data['hist_lead_name'] = thisOr($data['hist_lead_id'], pkGivenLookupText($data['hist_lead_name'], 'hist_chr', 'hist_lead_name'));
		...
		'hist_chr_scene' => function($data, $options = []) {
			...
			if(isset($data['character'])) $data['character'] = pkGivenLookupText($data['character'], 'hist_chr_scene', 'character');
		...
		'hist_encounter' => function($data, $options = []) {
			if(isset($data['bio_chrA'])) $data['bio_chrA'] = pkGivenLookupText($data['bio_chrA'], 'hist_encounter', 'bio_chrA');
			if(isset($data['bio_storyA'])) $data['bio_storyA'] = pkGivenLookupText($data['bio_storyA'], 'hist_encounter', 'bio_storyA');
			if(isset($data['bio_storyline'])) $data['bio_storyline'] = pkGivenLookupText($data['bio_storyline'], 'hist_encounter', 'bio_storyline');
			if(isset($data['bio_storytext'])) $data['bio_storytext'] = pkGivenLookupText($data['bio_storytext'], 'hist_encounter', 'bio_storytext');
			if(isset($data['sceneA'])) $data['sceneA'] = pkGivenLookupText($data['sceneA'], 'hist_encounter', 'sceneA');
			if(isset($data['bio_chrB'])) $data['bio_chrB'] = pkGivenLookupText($data['bio_chrB'], 'hist_encounter', 'bio_chrB');
			if(isset($data['bio_storyB'])) $data['bio_storyB'] = pkGivenLookupText($data['bio_storyB'], 'hist_encounter', 'bio_storyB');
			if(isset($data['bio_storylineB'])) $data['bio_storylineB'] = pkGivenLookupText($data['bio_storylineB'], 'hist_encounter', 'bio_storylineB');
			if(isset($data['bio_storytextB'])) $data['bio_storytextB'] = pkGivenLookupText($data['bio_storytextB'], 'hist_encounter', 'bio_storytextB');
