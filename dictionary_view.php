...
// Download AppGini for free from https://bigprof.com/appgini/download/
	...
	@include_once("{$currDir}/hooks/dictionary.php");
	include_once("{$currDir}/dictionary_dml.php");
	...
	$x->ColCaption = ['Id', 'Term', 'Definition', ];
	$x->ColFieldName = ['id', 'term', 'definition', ];
	$x->ColNumber  = [1, 2, 3, ];

	// template paths below are based on the app main directory
	$x->Template = 'templates/dictionary_templateTV.html';
	$x->SelectedTemplate = 'templates/dictionary_templateTVS.html';
	$x->TemplateDV = 'templates/dictionary_templateDV.html';
	$x->TemplateDVP = 'templates/dictionary_templateDVP.html';
