...
function bio_story_form($selected_id = '', $AllowUpdate = 1, $AllowInsert = 1, $AllowDelete = 1, $ShowCancel = 0, $TemplateDV = '', $TemplateDVP = '') {
	...
	$lookup_fields = array('bio_team' => array('bio_team', 'Bio team'), 'author_id' => array('bio_author', 'Author ID'), 'type' => array('class_bibliography_type', 'Type'), 'agent_id' => array('game_agent', 'Subject'), 'collaboration_status' => array('class_story_collab_type', 'Collaboration status'), );
